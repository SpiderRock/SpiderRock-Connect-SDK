...
namespace SpiderRock
{
	namespace SpiderStream
	{
		...
		public:
			...
			void RegisterObserver(std::shared_ptr<CreateEventObserver<LiveImpliedQuoteNG>> observer);
			...
			void RegisterObserver(std::shared_ptr<CreateEventObserver<OddLotBookQuote>> observer);
			...
			void RegisterObserver(std::shared_ptr<ChangeEventObserver<LiveImpliedQuoteNG>> observer);
			...
			void RegisterObserver(std::shared_ptr<ChangeEventObserver<OddLotBookQuote>> observer);
			...
			void RegisterObserver(std::shared_ptr<UpdateEventObserver<LiveImpliedQuoteNG>> observer);
			...
			void RegisterObserver(std::shared_ptr<UpdateEventObserver<OddLotBookQuote>> observer);
