...
public class StockBookQuoteHandler
{
    ...
    public long numLockMiss = 0;
    public long numUpdateErrors = 0;
    ...
    private ConcurrentDictionary<string, FencepostValues> fencepostValues = new();

    public StockBookQuoteHandler()
    {
    ...
    public void OnChange(object sender, ChangedEventArgs<StockBookQuote> args)
    {
        ...
        try
        {
            ...
            var ts = args.Changed.SrcTimestamp / 100; // ns to ticks
        ...
        {
            numUpdateErrors++;
            SRTrace.Process.TraceError(ex, "failed in OnUpdate");
        }
    ...
    public class TimeBox
    {
        ...
        public void Update(StockBookQuote tsObj)
        {
            ...
            {
                SRTrace.Process.TraceError(e, "TimeBoxError");
            }
            finally
            {
                if (lockTaken)
        ...
        public void WriteTimeBox()
        {
            ...
            {
                SRTrace.Process.TraceWarning($"TIME.BOX.ERROR ticker={ticker}, srcTimeBox={srcTimeBox:N0}, hasMixedID={hasMixedID}, numLockMiss={numLockMiss:N0}");
            }
