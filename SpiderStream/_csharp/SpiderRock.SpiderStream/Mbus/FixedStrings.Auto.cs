...
[StructLayout(LayoutKind.Sequential, Pack = 1, CharSet = CharSet.Ansi)]
internal unsafe struct ExDestString : IEquatable<ExDestString>, IComparable<ExDestString>, IEquatable<string>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(ExDestString other)
    {
        fixed (ExDestString* pfself = &this)
        {
            /* -------------- compare as ints ------------ */
            var pIntSelf = (int*) pfself;
            var pIntOther = (int*) &other;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(ExDestString other)
    {
        unchecked
        {
            fixed (byte* pfchars = chars)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator string(ExDestString value)
    {
        return value.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ExDestString(string value)
    {
        var r = new ExDestString();
        if (string.IsNullOrEmpty(value)) return r;
        r.Value = value;
        return r;
    }
...
[StructLayout(LayoutKind.Sequential, Pack = 1, CharSet = CharSet.Ansi)]
internal unsafe struct FixedString30Layout : IEquatable<FixedString30Layout>, IComparable<FixedString30Layout>, IEquatable<string>
{
    public fixed byte chars[30];
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(FixedString30Layout other)
    {
        fixed (FixedString30Layout* pfself = &this)
        {
            /* -------------- compare as ints ------------ */
            var pIntSelf = (int*) pfself;
            var pIntOther = (int*) &other;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(FixedString30Layout other)
    {
        unchecked
        {
            fixed (byte* pfchars = chars)
        ...
        set
        {
            unchecked
            {
                ...
                fixed (char* valuePtr = value)
                {
                    ...
                    if (value.Length >= 30)
                    {
                        for (int i = 0; i < 30; i++) { *(pchars++) = (byte) *(pstr++); }
                    }
                    else
                    {
                        while (*pstr != 0) { *(pchars++) = (byte) *(pstr++); }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator string(FixedString30Layout value)
    {
        return value.Value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator FixedString30Layout(string value)
    {
        var r = new FixedString30Layout();
        if (string.IsNullOrEmpty(value)) return r;
        r.Value = value;
        return r;
    }
