...
public enum AdjConvention : byte { None=0,Original=1,OSI=2,SpcOnly=3,OSIAlt=4 };		
 public enum AssetType : byte { None=0,EQT=1,IDX=2,BND=3,CUR=4,COM=5,FUT=6,SYN=7,WAR=8,FLX=9,MUT=10,SPD=11,MM=12,MF=13,COIN=14,TOKEN=15,ANY=16,RATE=17 };		
 ...
 public enum AuctionType : byte { None=0,Exposure=1,Improvement=2,Facilitation=3,Solicitation=4,Opening=5,Closing=6,RFQ=7,Block=8,Flash=9,BlockDAC=10,BlockPOC=11,BlockPCV=12 };		
 ...
 public enum CalcModelType : byte { None=0,LogNormal=1,Normal=2 };		
 public enum CalcSource : byte { None=0,Tick=1,Loop=2 };		
 public enum CallPut : byte { Call=0,Put=1,Pair=2 };		
 public enum ClsMarkState : byte { None=0,Preview=1,Final=2 };		
 public enum ContractUnit : byte { None=0,AUD=1,BBL=2,BDFT=3,BRL=4,BU=5,CAD=6,CHF=7,CTRCT=8,CUR=36,CWT=9,CZK=10,EUR=11,GAL=12,GBP=13,HUF=14,ILS=15,IPNT=16,JPY=17,KRW=18,LBS=19,MMBTU=20,MWH=21,MXN=35,MYR=22,NOK=23,NZD=24,PLN=25,RMB=26,RUR=27,SEK=28,TON=29,TRY=31,TRYOZ=32,USD=33,ZAR=34,INR=37,MTONS=38 };		
 ...
 public enum DataType : byte { None=0,OpraAscii=1,OpraFast=2,Cqs=3,Cts=4,Uqdf=5,Utdf=6,ISEBin=7,CBOESpread=8,CFE=9,CBOEIdx=10,CME=11,OpraBin=12,RussellTick=13,NasdaqImbal=14,ICE=15,CMEBin=16,NyseArca=17,OTC=18,UTP=19,CTAB=20,NasdaqMFDS=21,IseCombo=22,PhlxOrders=23,C2Auctions=24,EdgxAuctions=25,MiaxAuctions=26,MiaxCToM=27,BxAuctions=28,BxTop=29,TDDS=30,MIAXProduct=31,C1OptOpen=32,C1Auctions=33,C1Orders=34,AmexComplex=35,ArcaComplex=36,EmldAuctions=37,PillarEquityBBO=38,CBOEEqt=39 };		
 ...
 public enum MarkSource : byte { None=0,NbboMid=1,SRVol=2,LoBound=3,HiBound=4,Other=5 };		
 public enum MarketFeedOperationalState : byte { None=0,Startup=1,Up=2,Flapping=3,Down=4 };		
 public enum MarketFeedSequenceState : byte { None=0,Startup=1,Flowing=2,Gapping=3 };		
 ...
 public enum OptExch : byte { None=0,AMEX=1,BOX=2,CBOE=3,ISE=4,NYSE=5,PHLX=6,NSDQ=7,BATS=8,C2=9,NQBX=10,MIAX=11,GMNI=12,CME=13,CBOT=14,NYMEX=15,COMEX=16,ICE=17,EDGO=18,MCRY=19,MPRL=20,SDRK=21,DQTE=22,EMLD=23,CFE=24,MEMX=25,SPHR=26,EUREX=27,CEDX=28,NXAM=29,NXBR=30,NXLS=31,NXML=32,NXOS=33,NXP=34,ICEFEC=35,SRC=36,ICEFEF=37 };		
 ...
 public enum PriceFormat : byte { None=0,N0=1,N1=2,N2=3,N3=4,N4=5,N5=6,N6=7,N7=8,F4=9,F8=10,Q8=11,F16=12,F32=13,H32=14,Q32=15,F64=16,H64=17,FullPenny=18,PartPenny=19,PartNickle=20,V1=21,V2=22,V3=23,V4=24,V5=25,V6=26,V7=27,V8=28,V9=29,V10=30,V11=31,V12=32,V13=33,V14=34,V15=35,V16=36,A0=37,A1=38,A2=39,A3=40,A4=41,A5=42,A6=43,A7=44,E32=45,EU2A=46,EU2B=47,EU2C=48,EU2D=49,EU2E=50,EU2F=51,EU3A=52,EU3B=53,EU3C=54,EU3D=55,EU3E=56,EU3F=57,EU3G=58,EU3H=59,EU3I=60,EU3J=61,EU4A=62,EU4B=63,EU4C=64,EU5A=65,EU5B=66,NMS_Penny=67,NMS_Nickle=68,NMS_HalfPenny=69,EQT=70,EU2G=71,EU4D=72,EU5C=73,EU5D=74,EU7A=75,EU10A=76,EU12A=77,EU14A=78,EU15A=79,EU16A=80,EU17A=81,EU18A=82,EU19A=83,EU19B=84,EU19C=85,V17=86,V18=87 };		
 public enum PriceQuoteType : byte { None=0,Price=1,Vol=2 };		
 public enum PricingFramework : byte { None=0,Spot=1,Forward=2,Future=3,Physical=4 };		
 ...
 public enum PrimaryExchange : byte { None=0,NYSE=1,NYSEArca=2,NYSEMkt=3,NASDAQ=4,NASDAQBOS=5,BATS=6,PHLX=7,IEXG=8,CSE=9,NSE=10,FINRA=11,PORTAL=12,OTC=13,CME=14,CBOT=15,NYMEX=16,COMEX=17,ICE=18,EUREX=19,XETRA=20,CDEX=21,BXE=22,CXE=23,DXE=24,LSE=25,NXAM=26,NXBR=27,NXLS=28,NXML=29,NXOS=30,NXP=31,XJSE=32,BERA=33,FRAA=34,HAMA=35,XWBO=36,DUSA=37,XSWX=38,XWAR=39,FNSE=40,XGAT=41,XSTO=42,XTAE=43,XCYS=44,XPRA=45,HANA=46,BOTC=47,NXDUB=48,XATH=49,XMAD=50,XCSE=51,FNDK=52,XTAL=53,FNEE=54,XHEL=55,NMO=56,TRQX=57,XICE=58,FNIS=59,XLIT=60,FNLT=61,XRIS=62,FNLV=63,XSAT=64,MUNA=65,XETA=66,XLU=67,XBD=68,ICEFEC=69,ICEFEF=70 };		
 ...
 public enum PrtType : byte { None=0,CANC=1,OSEQ=2,CNCL=3,LATE=4,CNCO=5,OPEN=6,CNOL=7,OPNL=8,AUTO=9,REOP=10,ISOI=11,SLAN=12,SLAI=13,SLCN=14,SCLI=15,SLFT=16,MLET=17,MLAT=18,MLCT=19,MLFT=20,MESL=21,TLAT=22,MASL=23,MFSL=24,TLET=25,TLCT=26,TLFT=27,TESL=28,TASL=29,TFSL=30,CBMO=31,MCTP=32,EXHT=33,NREG=34 };		
 ...
 public enum TickerSrc : byte { None=0,SR=1,NMS=2,CME=3,ICE=4,CFE=5,CBOT=6,NYMEX=7,COMEX=8,RUT=9,CIDX=10,ARCA=11,NYSE=12,OTC=13,NSDQ=14,MFQS=15,MIAX=16,DJI=17,CUSIP=18,ISIN=19,BXE=20,SCE=21,ANY=22,CXE=23,DXE=24,NXAM=25,NXBR=26,NXLS=27,NXML=28,NXOS=29,NXP=30,EUREX=31,CEDX=32,ICEFEC=33,ICEFEF=34,CEQT=35 };		
 public enum TimeInForce : byte { None=0,Day=1,IOC=2,GTD=3,ExtDay=4,Week=5,ExtWeek=6 };		
 public enum TimeMetric : byte { None=0,D252=1,D365=2,SRV6=3 };		
