...
public enum AdjConvention : byte { None=0,Original=1,OSI=2,SpcOnly=3,OSIAlt=4 };		
 ...
 public enum PrimaryExchange : byte { None=0,NYSE=1,NYSEArca=2,NYSEMkt=3,NASDAQ=4,NASDAQBOS=5,BATS=6,PHLX=7,IEXG=8,CSE=9,NSE=10,FINRA=11,PORTAL=12,OTC=13,CME=14,CBOT=15,NYMEX=16,COMEX=17,ICE=18,EUREX=19,XETRA=20,CDEX=21,BXE=22,CXE=23,DXE=24,LSE=25,NXAM=26,NXBR=27,NXLS=28,NXML=29,NXOS=30,NXP=31 };		
