...
public enum AdjConvention : byte { None=0,Original=1,OSI=2,SpcOnly=3,OSIAlt=4 };		
 ...
 public enum SpreadClass : byte { None=0,Stk=1,Fut=2,Call=3,Put=4,Synth=5,RevCon=6,Box=7,JRoll=8,Roll=9,Straddle=10,Strangle=11,CSpread=12,PSpread=13,VStrip=14,VSpread=15,HStrip=16,HSpread=17,BFly=18,RiskRev=19,Mixed=20,VarSwap=21 };		
 public enum StkExch : byte { None=0,AMEX=1,NQBX=2,NSX=3,FNRA=4,ISE=5,EDGA=6,EDGX=7,CHX=8,NYSE=9,ARCA=10,NSDQ=11,CBSX=12,PSX=13,BTSY=14,BATS=15,CBIDX=16,IEX=17,OTC=18,MPRL=19,LTSE=20,MEMX=21,MXIDX=22,DJIDX=23,BXE=24,CXE=25,DXE=26,XETRA=27,NXAM=28,NXBR=29,NXLS=30,NXML=31,NXOS=32,NXP=33 };		
 ...
 public enum TickerSrc : byte { None=0,SR=1,NMS=2,CME=3,ICE=4,CFE=5,CBOT=6,NYMEX=7,COMEX=8,RUT=9,CIDX=10,ARCA=11,NYSE=12,OTC=13,NSDQ=14,MFQS=15,MIAX=16,DJI=17,CUSIP=18,ISIN=19,BXE=20,EUX=21,ANY=22,CXE=23,DXE=24,NXAM=25,NXBR=26,NXLS=27,NXML=28,NXOS=29,NXP=30,EUREX=31,CEDX=32,ICEFE=33 };		
