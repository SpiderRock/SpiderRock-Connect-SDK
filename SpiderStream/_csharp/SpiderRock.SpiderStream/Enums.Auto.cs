...
public enum AdjConvention : byte { None=0,Original=1,OSI=2,SpcOnly=3,OSIAlt=4 };		
 ...
 public enum TickerSrc : byte { None=0,SR=1,NMS=2,CME=3,ICE=4,CFE=5,CBOT=6,NYMEX=7,COMEX=8,RUT=9,CIDX=10,ARCA=11,NYSE=12,OTC=13,NSDQ=14,MFQS=15,MIAX=16,DJI=17,CUSIP=18,ISIN=19,BXE=20,SCE=21,ANY=22,CXE=23,DXE=24,NXAM=25,NXBR=26,NXLS=27,NXML=28,NXOS=29,NXP=30,EUREX=31,CEDX=32,ICEFEC=33,ICEFEF=34 };		
