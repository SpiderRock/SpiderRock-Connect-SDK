...
namespace api {
    ...
    class SpdrExecutionAllocationStatus_PKey {
        public:
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrExecutionAllocationStatus_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrExecutionAllocationStatus_PKey::set()"); }  // specializations for valid types are listed below
        ...
        SpdrExecutionAllocationStatus_PKey() {}

        virtual ~SpdrExecutionAllocationStatus_PKey() {
        }
    ...
    class SpdrExecutionAllocationStatus {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::SpdrExecutionAllocationStatus_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrExecutionAllocationStatus::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const SpdrExecutionAllocationStatus & value) {
            set(value.m__meta);
            set(value.m_pkey);
            set(value.m_sec_key);
        ...
        SpdrExecutionAllocationStatus() {
            m__meta.set_message_type("SpdrExecutionAllocationStatus");
        }
        ...
        void Clear() {
             *this = SpdrExecutionAllocationStatus{};
        }
    ...
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::_meta>() const { return SpdrExecutionAllocationStatus::_meta{ m__meta}; }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::pkey>() const { return SpdrExecutionAllocationStatus::pkey{ m_pkey}; }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::sec_key>() const { return SpdrExecutionAllocationStatus::sec_key{ m_sec_key}; }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::sec_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SpdrKeyType>( m_sec_type)); }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::alloc_status>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AllocStatus>( m_alloc_status)); }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::alloc_detail>() const { return m_alloc_detail; }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::modified_by>() const { return m_modified_by; }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::modified_in>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_modified_in)); }
    template<> inline const auto SpdrExecutionAllocationStatus::get<SpdrExecutionAllocationStatus::timestamp>() const { return m_timestamp; }
    template<> inline const auto SpdrExecutionAllocationStatus_PKey::get<SpdrExecutionAllocationStatus_PKey::alloc_number>() const { return m_alloc_number; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const SpdrExecutionAllocationStatus_PKey& m) {
        o << "\"alloc_number\":" << m.get<SpdrExecutionAllocationStatus_PKey::alloc_number>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const SpdrExecutionAllocationStatus& m) {
        o << "\"_meta\":{" << m.get<SpdrExecutionAllocationStatus::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<SpdrExecutionAllocationStatus::pkey>() << "}";
        o << ",\"sec_key\":{" << m.get<SpdrExecutionAllocationStatus::sec_key>() << "}";
        o << ",\"sec_type\":" << (int64_t)m.get<SpdrExecutionAllocationStatus::sec_type>();
        o << ",\"alloc_status\":" << (int64_t)m.get<SpdrExecutionAllocationStatus::alloc_status>();
        o << ",\"alloc_detail\":\"" << m.get<SpdrExecutionAllocationStatus::alloc_detail>() << "\"";
        o << ",\"modified_by\":\"" << m.get<SpdrExecutionAllocationStatus::modified_by>() << "\"";
        o << ",\"modified_in\":" << (int64_t)m.get<SpdrExecutionAllocationStatus::modified_in>();
        {
            std::time_t tt = m.get<SpdrExecutionAllocationStatus::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
