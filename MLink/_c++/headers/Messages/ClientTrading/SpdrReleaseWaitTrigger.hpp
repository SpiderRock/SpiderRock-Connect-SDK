...
namespace api {
    ...
    class SpdrReleaseWaitTrigger_PKey {
        public:
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrReleaseWaitTrigger_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrReleaseWaitTrigger_PKey::set()"); }  // specializations for valid types are listed below
        ...
        SpdrReleaseWaitTrigger_PKey() {}

        virtual ~SpdrReleaseWaitTrigger_PKey() {
        }
    ...
    class SpdrReleaseWaitTrigger {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::SpdrReleaseWaitTrigger_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrReleaseWaitTrigger::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const SpdrReleaseWaitTrigger & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        SpdrReleaseWaitTrigger() {
            m__meta.set_message_type("SpdrReleaseWaitTrigger");
        }
    ...
    template<> inline const auto SpdrReleaseWaitTrigger::get<SpdrReleaseWaitTrigger::_meta>() const { return SpdrReleaseWaitTrigger::_meta{ m__meta}; }
    template<> inline const auto SpdrReleaseWaitTrigger::get<SpdrReleaseWaitTrigger::pkey>() const { return SpdrReleaseWaitTrigger::pkey{ m_pkey}; }
    template<> inline const auto SpdrReleaseWaitTrigger::get<SpdrReleaseWaitTrigger::modified_by>() const { return m_modified_by; }
    template<> inline const auto SpdrReleaseWaitTrigger::get<SpdrReleaseWaitTrigger::modified_in>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_modified_in)); }
    template<> inline const auto SpdrReleaseWaitTrigger::get<SpdrReleaseWaitTrigger::timestamp>() const { return m_timestamp; }
    template<> inline const auto SpdrReleaseWaitTrigger_PKey::get<SpdrReleaseWaitTrigger_PKey::accnt>() const { return m_accnt; }
    template<> inline const auto SpdrReleaseWaitTrigger_PKey::get<SpdrReleaseWaitTrigger_PKey::trigger_group_id>() const { return m_trigger_group_id; }
    template<> inline const auto SpdrReleaseWaitTrigger_PKey::get<SpdrReleaseWaitTrigger_PKey::client_firm>() const { return m_client_firm; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const SpdrReleaseWaitTrigger_PKey& m) {
        o << "\"accnt\":\"" << m.get<SpdrReleaseWaitTrigger_PKey::accnt>() << "\"";
        o << ",\"trigger_group_id\":" << m.get<SpdrReleaseWaitTrigger_PKey::trigger_group_id>();
        o << ",\"client_firm\":\"" << m.get<SpdrReleaseWaitTrigger_PKey::client_firm>() << "\"";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const SpdrReleaseWaitTrigger& m) {
        o << "\"_meta\":{" << m.get<SpdrReleaseWaitTrigger::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<SpdrReleaseWaitTrigger::pkey>() << "}";
        o << ",\"modified_by\":\"" << m.get<SpdrReleaseWaitTrigger::modified_by>() << "\"";
        o << ",\"modified_in\":" << (int64_t)m.get<SpdrReleaseWaitTrigger::modified_in>();
        {
            std::time_t tt = m.get<SpdrReleaseWaitTrigger::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
