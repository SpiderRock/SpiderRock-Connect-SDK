...
namespace api {
    ...
    class SpdrParentCancel_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrParentCancel_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrParentCancel_PKey::set()"); }  // specializations for valid types are listed below
        ...
        SpdrParentCancel_PKey() {}

        virtual ~SpdrParentCancel_PKey() {
        }
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeParentNumber()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(11,m_parent_number);
            }
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludeParentNumber()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,11,m_parent_number);
            }
            if ( IncludeClientFirm()) {
        ...
        const void Decode(const  uint8_t*& pos, const  uint8_t* max) {
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    ...
                    case 11: {m_parent_number = SRProtobufCPP::FieldCodec::DecodeLong(pos,max);
                        break;
                    }
    ...
    class SpdrParentCancel {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::SpdrParentCancel_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrParentCancel::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const SpdrParentCancel & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        SpdrParentCancel() {
            m__meta.set_message_type("SpdrParentCancel");
        }
    ...
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::_meta>() const { return SpdrParentCancel::_meta{ m__meta}; }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::pkey>() const { return SpdrParentCancel::pkey{ m_pkey}; }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::sys_environment>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_sys_environment)); }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::run_status>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::RunStatus>( m_run_status)); }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::cxl_reason>() const { return m_cxl_reason; }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::alt_cancel_id>() const { return m_alt_cancel_id; }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::engine_name>() const { return m_engine_name; }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::modified_by>() const { return m_modified_by; }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::modified_in>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_modified_in)); }
    template<> inline const auto SpdrParentCancel::get<SpdrParentCancel::timestamp>() const { return m_timestamp; }
    template<> inline const auto SpdrParentCancel_PKey::get<SpdrParentCancel_PKey::accnt>() const { return m_accnt; }
    template<> inline const auto SpdrParentCancel_PKey::get<SpdrParentCancel_PKey::parent_number>() const { return m_parent_number; }
    template<> inline const auto SpdrParentCancel_PKey::get<SpdrParentCancel_PKey::client_firm>() const { return m_client_firm; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const SpdrParentCancel_PKey& m) {
        o << "\"accnt\":\"" << m.get<SpdrParentCancel_PKey::accnt>() << "\"";
        o << ",\"parent_number\":" << m.get<SpdrParentCancel_PKey::parent_number>();
        o << ",\"client_firm\":\"" << m.get<SpdrParentCancel_PKey::client_firm>() << "\"";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const SpdrParentCancel& m) {
        o << "\"_meta\":{" << m.get<SpdrParentCancel::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<SpdrParentCancel::pkey>() << "}";
        o << ",\"sys_environment\":" << (int64_t)m.get<SpdrParentCancel::sys_environment>();
        o << ",\"run_status\":" << (int64_t)m.get<SpdrParentCancel::run_status>();
        o << ",\"cxl_reason\":\"" << m.get<SpdrParentCancel::cxl_reason>() << "\"";
        o << ",\"alt_cancel_id\":\"" << m.get<SpdrParentCancel::alt_cancel_id>() << "\"";
        o << ",\"engine_name\":\"" << m.get<SpdrParentCancel::engine_name>() << "\"";
        o << ",\"modified_by\":\"" << m.get<SpdrParentCancel::modified_by>() << "\"";
        o << ",\"modified_in\":" << (int64_t)m.get<SpdrParentCancel::modified_in>();
        {
            std::time_t tt = m.get<SpdrParentCancel::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
