...
namespace api {
    ...
    class SpdrSecKeyCancel_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrSecKeyCancel_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrSecKeyCancel_PKey::set()"); }  // specializations for valid types are listed below
        ...
        SpdrSecKeyCancel_PKey() {}

        virtual ~SpdrSecKeyCancel_PKey() {
        }
    ...
    class SpdrSecKeyCancel {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::SpdrSecKeyCancel_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to SpdrSecKeyCancel::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const SpdrSecKeyCancel & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        SpdrSecKeyCancel() {
            m__meta.set_message_type("SpdrSecKeyCancel");
        }
    ...
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::_meta>() const { return SpdrSecKeyCancel::_meta{ m__meta}; }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::pkey>() const { return SpdrSecKeyCancel::pkey{ m_pkey}; }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::sys_environment>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_sys_environment)); }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::run_status>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::RunStatus>( m_run_status)); }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::cxl_reason>() const { return m_cxl_reason; }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::alt_cancel_id>() const { return m_alt_cancel_id; }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::engine_name>() const { return m_engine_name; }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::modified_by>() const { return m_modified_by; }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::modified_in>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_modified_in)); }
    template<> inline const auto SpdrSecKeyCancel::get<SpdrSecKeyCancel::timestamp>() const { return m_timestamp; }
    template<> inline const auto SpdrSecKeyCancel_PKey::get<SpdrSecKeyCancel_PKey::accnt>() const { return m_accnt; }
    template<> inline const auto SpdrSecKeyCancel_PKey::get<SpdrSecKeyCancel_PKey::sec_key>() const { return SpdrSecKeyCancel_PKey::sec_key{m_sec_key}; }
    template<> inline const auto SpdrSecKeyCancel_PKey::get<SpdrSecKeyCancel_PKey::sec_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SpdrKeyType>(m_sec_type));}
    template<> inline const auto SpdrSecKeyCancel_PKey::get<SpdrSecKeyCancel_PKey::client_firm>() const { return m_client_firm; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const SpdrSecKeyCancel_PKey& m) {
        o << "\"accnt\":\"" << m.get<SpdrSecKeyCancel_PKey::accnt>() << "\"";
        o << ",\"sec_key\":{" << m.get<SpdrSecKeyCancel_PKey::sec_key>() << "}";
        o << ",\"sec_type\":" << (int64_t)m.get<SpdrSecKeyCancel_PKey::sec_type>();
        o << ",\"client_firm\":\"" << m.get<SpdrSecKeyCancel_PKey::client_firm>() << "\"";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const SpdrSecKeyCancel& m) {
        o << "\"_meta\":{" << m.get<SpdrSecKeyCancel::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<SpdrSecKeyCancel::pkey>() << "}";
        o << ",\"sys_environment\":" << (int64_t)m.get<SpdrSecKeyCancel::sys_environment>();
        o << ",\"run_status\":" << (int64_t)m.get<SpdrSecKeyCancel::run_status>();
        o << ",\"cxl_reason\":\"" << m.get<SpdrSecKeyCancel::cxl_reason>() << "\"";
        o << ",\"alt_cancel_id\":\"" << m.get<SpdrSecKeyCancel::alt_cancel_id>() << "\"";
        o << ",\"engine_name\":\"" << m.get<SpdrSecKeyCancel::engine_name>() << "\"";
        o << ",\"modified_by\":\"" << m.get<SpdrSecKeyCancel::modified_by>() << "\"";
        o << ",\"modified_in\":" << (int64_t)m.get<SpdrSecKeyCancel::modified_in>();
        {
            std::time_t tt = m.get<SpdrSecKeyCancel::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
