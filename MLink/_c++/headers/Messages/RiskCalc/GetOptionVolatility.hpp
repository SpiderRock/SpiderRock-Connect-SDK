...
namespace api {
    ...
    class GetOptionVolatility_DiscreteDividend {
        public:
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to GetOptionVolatility_DiscreteDividend::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to GetOptionVolatility_DiscreteDividend::set()"); }  // specializations for valid types are listed below
        ...
        GetOptionVolatility_DiscreteDividend() {}

        virtual ~GetOptionVolatility_DiscreteDividend() {
        }
    ...
    class GetOptionVolatility {
        ...
        using discrete_dividend = spiderrock::protobuf::api::GetOptionVolatility_DiscreteDividend;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to GetOptionVolatility::get()"); return T{}; }  // specializations for valid types are listed below the class definition

        template <typename T, size_t S = sizeof(T)>
        const auto get(int i) const { static_assert(sizeof(T) == -1, "Unexpected type in call to GetOptionVolatility::get(int)"); return T{};}  // specializations for valid types are listed below the class definition

        template <typename T, size_t S = sizeof(T)>
        int count() const { static_assert(sizeof(T) == -1, "Unexpected type in call to GetOptionVolatility::count()"); return 0;}  // specializations for valid types are listed below the class definition
        ...
        GetOptionVolatility() {
            m__meta.set_message_type("GetOptionVolatility");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeOkey()) {
                ...
                totalSize += SRProtobufCPP::FieldCodec::OptionKeyFieldSize(197, optionKeyLayout_okey);
            }
            if ( IncludePrice()) {
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludeOkey()) {
                SRProtobufCPP::OptionKeyLayout optionKeyLayout_okey{};
                m_okey.setCodecOptionKey(optionKeyLayout_okey);
                dest = SRProtobufCPP::FieldCodec::EncodeOptionKey(dest, 197, optionKeyLayout_okey);
            }
            if ( IncludePrice()) {
    ...
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::sdiv>() const { return m_sdiv; }
    ...
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::inc_greeks>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_inc_greeks)); }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::vol>() const { return m_vol; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::eff_strike>() const { return m_eff_strike; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::dividend_amount>() const { return m_dividend_amount; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::delta>() const { return m_delta; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::gamma>() const { return m_gamma; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::theta>() const { return m_theta; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::vega>() const { return m_vega; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::volga>() const { return m_volga; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::vanna>() const { return m_vanna; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::de_decay>() const { return m_de_decay; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::rho>() const { return m_rho; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::phi>() const { return m_phi; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::error>() const { return m_error; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::pricer_model>() const { return m_pricer_model; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::timestamp>() const { return m_timestamp; }
    template<> inline const auto GetOptionVolatility::get<GetOptionVolatility::discrete_dividend>(int i) const { return GetOptionVolatility::discrete_dividend{ get_discrete_dividend(i)}; }
    template<> inline int GetOptionVolatility::count<GetOptionVolatility::discrete_dividend>() const { return static_cast<int>( m_discrete_dividend.size()); }
    template<> inline const auto GetOptionVolatility_DiscreteDividend::get<GetOptionVolatility_DiscreteDividend::date>() const { return m_date; }
    template<> inline const auto GetOptionVolatility_DiscreteDividend::get<GetOptionVolatility_DiscreteDividend::amount>() const { return m_amount; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const GetOptionVolatility_DiscreteDividend& m) {
        {
            std::time_t tt = m.get<GetOptionVolatility_DiscreteDividend::date>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
            o << "\"date\":\"" << std::put_time(&tm1, "%a %b %e %T %Y") << "\"";
        }
        o << ",\"amount\":" << m.get<GetOptionVolatility_DiscreteDividend::amount>();
        return o;
    }
    ...
    inline std::ostream& operator<<(std::ostream &o, const GetOptionVolatility& m) {
        ...
        o << ",\"sdiv\":" << m.get<GetOptionVolatility::sdiv>();
        ...
        o << ",\"inc_greeks\":" << (int64_t)m.get<GetOptionVolatility::inc_greeks>();
        o << ",\"vol\":" << m.get<GetOptionVolatility::vol>();
        o << ",\"eff_strike\":" << m.get<GetOptionVolatility::eff_strike>();
        o << ",\"dividend_amount\":" << m.get<GetOptionVolatility::dividend_amount>();
        o << ",\"delta\":" << m.get<GetOptionVolatility::delta>();
        o << ",\"gamma\":" << m.get<GetOptionVolatility::gamma>();
        o << ",\"theta\":" << m.get<GetOptionVolatility::theta>();
        o << ",\"vega\":" << m.get<GetOptionVolatility::vega>();
        o << ",\"volga\":" << m.get<GetOptionVolatility::volga>();
        o << ",\"vanna\":" << m.get<GetOptionVolatility::vanna>();
        o << ",\"de_decay\":" << m.get<GetOptionVolatility::de_decay>();
        o << ",\"rho\":" << m.get<GetOptionVolatility::rho>();
        o << ",\"phi\":" << m.get<GetOptionVolatility::phi>();
        o << ",\"error\":\"" << m.get<GetOptionVolatility::error>() << "\"";
        o << ",\"pricer_model\":\"" << m.get<GetOptionVolatility::pricer_model>() << "\"";
        {
            std::time_t tt = m.get<GetOptionVolatility::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
        ...
        {
            const char *delim = "{";
            for (int i=0; i<m.count<GetOptionVolatility::discrete_dividend>(); ++i) {
                o << delim << m.get<GetOptionVolatility::discrete_dividend>(i) << '}';
                delim = ",{";
            }
        }
        o << "]";
