...
namespace api {
    ...
    class StockEarningsCalendar_PKey {
        public:
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to StockEarningsCalendar_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to StockEarningsCalendar_PKey::set()"); }  // specializations for valid types are listed below
        ...
        StockEarningsCalendar_PKey() {}

        virtual ~StockEarningsCalendar_PKey() {
        }
    ...
    class StockEarningsCalendar_Event {
        public:
        //using statements for all types used in this class
        ...
        //templatized getters and setters
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to StockEarningsCalendar_Event::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to StockEarningsCalendar_Event::set()"); }  // specializations for valid types are listed below
        ...
        StockEarningsCalendar_Event() {}

        virtual ~StockEarningsCalendar_Event() {
        }
        //templatized set functions that can take multiple arguments simultaneously
        template <typename Arg>
        void set_params(Arg && arg) {
    ...
    class StockEarningsCalendar {
        ...
        using pkey = spiderrock::protobuf::api::StockEarningsCalendar_PKey;
        using e_move_hist = spiderrock::protobuf::api::e_move_hist;
        using timestamp = spiderrock::protobuf::api::timestamp;
        using event = spiderrock::protobuf::api::StockEarningsCalendar_Event;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to StockEarningsCalendar::get()"); return T{}; }  // specializations for valid types are listed below the class definition

        template <typename T, size_t S = sizeof(T)>
        const auto get(int i) const { static_assert(sizeof(T) == -1, "Unexpected type in call to StockEarningsCalendar::get(int)"); return T{};}  // specializations for valid types are listed below the class definition

        template <typename T, size_t S = sizeof(T)>
        int count() const { static_assert(sizeof(T) == -1, "Unexpected type in call to StockEarningsCalendar::count()"); return 0;}  // specializations for valid types are listed below the class definition
        ...
        void set(const StockEarningsCalendar & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        StockEarningsCalendar() {
            m__meta.set_message_type("StockEarningsCalendar");
        }
    ...
    template<> inline const auto StockEarningsCalendar::get<StockEarningsCalendar::_meta>() const { return StockEarningsCalendar::_meta{ m__meta}; }
    template<> inline const auto StockEarningsCalendar::get<StockEarningsCalendar::pkey>() const { return StockEarningsCalendar::pkey{ m_pkey}; }
    template<> inline const auto StockEarningsCalendar::get<StockEarningsCalendar::e_move_hist>() const { return m_e_move_hist; }
    template<> inline const auto StockEarningsCalendar::get<StockEarningsCalendar::timestamp>() const { return m_timestamp; }
    template<> inline const auto StockEarningsCalendar::get<StockEarningsCalendar::event>(int i) const { return StockEarningsCalendar::event{ get_event(i)}; }
    template<> inline int StockEarningsCalendar::count<StockEarningsCalendar::event>() const { return static_cast<int>( m_event.size()); }
    template<> inline const auto StockEarningsCalendar_PKey::get<StockEarningsCalendar_PKey::ticker>() const { return StockEarningsCalendar_PKey::ticker{m_ticker}; }
    template<> inline const auto StockEarningsCalendar_PKey::get<StockEarningsCalendar_PKey::source>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::EventSource>(m_source));}
    
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::event_date>() const { return StockEarningsCalendar_Event::event_date{m_event_date}; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::event_time>() const { return m_event_time; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::earn_status>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::EarnStatus>(m_earn_status));}
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::guidance_issued>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::GuidanceIssued>(m_guidance_issued));}
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::earn_fiscal_qtr>() const { return StockEarningsCalendar_Event::earn_fiscal_qtr{m_earn_fiscal_qtr}; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::earn_change>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::earnChange>(m_earn_change));}
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::earn_pct_move>() const { return m_earn_pct_move; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::prv_close>() const { return m_prv_close; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::open>() const { return m_open; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::high>() const { return m_high; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::low>() const { return m_low; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::close>() const { return m_close; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::move_date>() const { return StockEarningsCalendar_Event::move_date{m_move_date}; }
    template<> inline const auto StockEarningsCalendar_Event::get<StockEarningsCalendar_Event::h_emove>() const { return m_h_emove; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const StockEarningsCalendar_PKey& m) {
        o << "\"ticker\":{" << m.get<StockEarningsCalendar_PKey::ticker>() << "}";
        o << ",\"source\":" << (int64_t)m.get<StockEarningsCalendar_PKey::source>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const StockEarningsCalendar_Event& m) {
        o << "\"event_date\":{" << m.get<StockEarningsCalendar_Event::event_date>() << "}";
        o << ",\"event_time\":\"" << m.get<StockEarningsCalendar_Event::event_time>() << "\"";
        o << ",\"earn_status\":" << (int64_t)m.get<StockEarningsCalendar_Event::earn_status>();
        o << ",\"guidance_issued\":" << (int64_t)m.get<StockEarningsCalendar_Event::guidance_issued>();
        o << ",\"earn_fiscal_qtr\":{" << m.get<StockEarningsCalendar_Event::earn_fiscal_qtr>() << "}";
        o << ",\"earn_change\":" << (int64_t)m.get<StockEarningsCalendar_Event::earn_change>();
        o << ",\"earn_pct_move\":" << m.get<StockEarningsCalendar_Event::earn_pct_move>();
        o << ",\"prv_close\":" << m.get<StockEarningsCalendar_Event::prv_close>();
        o << ",\"open\":" << m.get<StockEarningsCalendar_Event::open>();
        o << ",\"high\":" << m.get<StockEarningsCalendar_Event::high>();
        o << ",\"low\":" << m.get<StockEarningsCalendar_Event::low>();
        o << ",\"close\":" << m.get<StockEarningsCalendar_Event::close>();
        o << ",\"move_date\":{" << m.get<StockEarningsCalendar_Event::move_date>() << "}";
        o << ",\"h_emove\":" << m.get<StockEarningsCalendar_Event::h_emove>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const StockEarningsCalendar& m) {
        o << "\"_meta\":{" << m.get<StockEarningsCalendar::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<StockEarningsCalendar::pkey>() << "}";
        o << ",\"e_move_hist\":" << m.get<StockEarningsCalendar::e_move_hist>();
        {
            std::time_t tt = m.get<StockEarningsCalendar::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
        ...
        {
            const char *delim = "{";
            for (int i=0; i<m.count<StockEarningsCalendar::event>(); ++i) {
                o << delim << m.get<StockEarningsCalendar::event>(i) << '}';
                delim = ",{";
            }
        }
        o << "]";
