...
namespace api {
    ...
    class SpreadExchDefinition_Legs {
        ...
        size_t ByteSizeLong() const {
            ...
            totalSize += SRProtobufCPP::FieldCodec::OptionKeyFieldSize(101,optionKeyLayout_leg_sec_key);
            ...
            totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(106,m_ref_delta);
            totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(107,m_ref_prc);
            return totalSize;
        }
        ...
        uint8_t* Encode(uint8_t*& dest, uint8_t* max) const {
            SRProtobufCPP::OptionKeyLayout optionKeyLayout_leg_sec_key;
            m_leg_sec_key.setCodecOptionKey(optionKeyLayout_leg_sec_key);
            dest = SRProtobufCPP::FieldCodec::EncodeOptionKey(dest, 101, optionKeyLayout_leg_sec_key);
            ...
            dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,106,m_ref_delta);
            dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,107,m_ref_prc);
            return dest;
        }
        ...
        const void Decode(const  uint8_t*& pos, const  uint8_t* max) {
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    ...
                    case 106: {m_ref_delta = SRProtobufCPP::FieldCodec::DecodeFloat(pos,max);
                        break;
                    }
                    case 107: {m_ref_prc = SRProtobufCPP::FieldCodec::DecodeDouble(pos,max);
                        break;
                    }
                }
            }
