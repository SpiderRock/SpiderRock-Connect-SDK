...
namespace api {
    ...
    class FutureMinuteBar_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureMinuteBar_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureMinuteBar_PKey::set()"); }  // specializations for valid types are listed below
        ...
        FutureMinuteBar_PKey() {}

        virtual ~FutureMinuteBar_PKey() {
        }
    ...
    class FutureMinuteBar {
        ...
        using pkey = spiderrock::protobuf::api::FutureMinuteBar_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureMinuteBar::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const FutureMinuteBar & value) {
            set(value.m__meta);
            set(value.m_pkey);
            set(value.m_date);
            set(value.m_time);
        ...
        FutureMinuteBar() {
            m__meta.set_message_type("FutureMinuteBar");
        }
    ...
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::_meta>() const { return FutureMinuteBar::_meta{ m__meta}; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::pkey>() const { return FutureMinuteBar::pkey{ m_pkey}; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::date>() const { return m_date; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::time>() const { return m_time; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::prt_open>() const { return m_prt_open; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::prt_high>() const { return m_prt_high; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::prt_low>() const { return m_prt_low; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::prt_last>() const { return m_prt_last; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::prt_vwap>() const { return m_prt_vwap; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::prt_volume>() const { return m_prt_volume; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::prt_count>() const { return m_prt_count; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::qte_hi_bid>() const { return m_qte_hi_bid; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::qte_lo_ask>() const { return m_qte_lo_ask; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::qte_twap>() const { return m_qte_twap; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::qte_count>() const { return m_qte_count; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::bid>() const { return m_bid; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::ask>() const { return m_ask; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::bid_sz>() const { return m_bid_sz; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::ask_sz>() const { return m_ask_sz; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::width>() const { return m_width; }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::is_eob>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_is_eob)); }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::is_eoh>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_is_eoh)); }
    template<> inline const auto FutureMinuteBar::get<FutureMinuteBar::timestamp>() const { return m_timestamp; }
    template<> inline const auto FutureMinuteBar_PKey::get<FutureMinuteBar_PKey::fkey>() const { return FutureMinuteBar_PKey::fkey{m_fkey}; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const FutureMinuteBar_PKey& m) {
        o << "\"fkey\":{" << m.get<FutureMinuteBar_PKey::fkey>() << "}";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const FutureMinuteBar& m) {
        o << "\"_meta\":{" << m.get<FutureMinuteBar::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<FutureMinuteBar::pkey>() << "}";
        o << ",\"date\":\"" << m.get<FutureMinuteBar::date>() << "\"";
        o << ",\"time\":\"" << m.get<FutureMinuteBar::time>() << "\"";
        o << ",\"prt_open\":" << m.get<FutureMinuteBar::prt_open>();
        o << ",\"prt_high\":" << m.get<FutureMinuteBar::prt_high>();
        o << ",\"prt_low\":" << m.get<FutureMinuteBar::prt_low>();
        o << ",\"prt_last\":" << m.get<FutureMinuteBar::prt_last>();
        o << ",\"prt_vwap\":" << m.get<FutureMinuteBar::prt_vwap>();
        o << ",\"prt_volume\":" << m.get<FutureMinuteBar::prt_volume>();
        o << ",\"prt_count\":" << m.get<FutureMinuteBar::prt_count>();
        o << ",\"qte_hi_bid\":" << m.get<FutureMinuteBar::qte_hi_bid>();
        o << ",\"qte_lo_ask\":" << m.get<FutureMinuteBar::qte_lo_ask>();
        o << ",\"qte_twap\":" << m.get<FutureMinuteBar::qte_twap>();
        o << ",\"qte_count\":" << m.get<FutureMinuteBar::qte_count>();
        o << ",\"bid\":" << m.get<FutureMinuteBar::bid>();
        o << ",\"ask\":" << m.get<FutureMinuteBar::ask>();
        o << ",\"bid_sz\":" << m.get<FutureMinuteBar::bid_sz>();
        o << ",\"ask_sz\":" << m.get<FutureMinuteBar::ask_sz>();
        o << ",\"width\":" << m.get<FutureMinuteBar::width>();
        o << ",\"is_eob\":" << (int64_t)m.get<FutureMinuteBar::is_eob>();
        o << ",\"is_eoh\":" << (int64_t)m.get<FutureMinuteBar::is_eoh>();
        {
            std::time_t tt = m.get<FutureMinuteBar::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
