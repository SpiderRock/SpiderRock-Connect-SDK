...
namespace api {
    ...
    class StockPrintProbability_PKey {
        public:
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to StockPrintProbability_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to StockPrintProbability_PKey::set()"); }  // specializations for valid types are listed below
        ...
        StockPrintProbability_PKey() {}

        virtual ~StockPrintProbability_PKey() {
        }
    ...
    class StockPrintProbability {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::StockPrintProbability_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to StockPrintProbability::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const StockPrintProbability & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        StockPrintProbability() {
            m__meta.set_message_type("StockPrintProbability");
        }
    ...
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::_meta>() const { return StockPrintProbability::_meta{ m__meta}; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::pkey>() const { return StockPrintProbability::pkey{ m_pkey}; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::prt_price>() const { return m_prt_price; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::prt_size>() const { return m_prt_size; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::prt_prob>() const { return m_prt_prob; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::prt_side>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BuySell>( m_prt_side)); }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::bid_price>() const { return m_bid_price; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::ask_price>() const { return m_ask_price; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::bid_size>() const { return m_bid_size; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::ask_size>() const { return m_ask_size; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::avg_blink1m>() const { return m_avg_blink1m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::mae_blink1m>() const { return m_mae_blink1m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::avg_slink1m>() const { return m_avg_slink1m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::mae_slink1m>() const { return m_mae_slink1m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::avg_blink10m>() const { return m_avg_blink10m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::mae_blink10m>() const { return m_mae_blink10m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::avg_slink10m>() const { return m_avg_slink10m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::mae_slink10m>() const { return m_mae_slink10m; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::b_counter>() const { return m_b_counter; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::s_counter>() const { return m_s_counter; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::prt_timestamp>() const { return m_prt_timestamp; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::net_timestamp>() const { return m_net_timestamp; }
    template<> inline const auto StockPrintProbability::get<StockPrintProbability::sms_timestamp>() const { return m_sms_timestamp; }
    template<> inline const auto StockPrintProbability_PKey::get<StockPrintProbability_PKey::ticker>() const { return StockPrintProbability_PKey::ticker{m_ticker}; }
    template<> inline const auto StockPrintProbability_PKey::get<StockPrintProbability_PKey::state_model>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::StateModel>(m_state_model));}
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const StockPrintProbability_PKey& m) {
        o << "\"ticker\":{" << m.get<StockPrintProbability_PKey::ticker>() << "}";
        o << ",\"state_model\":" << (int64_t)m.get<StockPrintProbability_PKey::state_model>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const StockPrintProbability& m) {
        o << "\"_meta\":{" << m.get<StockPrintProbability::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<StockPrintProbability::pkey>() << "}";
        o << ",\"prt_price\":" << m.get<StockPrintProbability::prt_price>();
        o << ",\"prt_size\":" << m.get<StockPrintProbability::prt_size>();
        o << ",\"prt_prob\":" << m.get<StockPrintProbability::prt_prob>();
        o << ",\"prt_side\":" << (int64_t)m.get<StockPrintProbability::prt_side>();
        o << ",\"bid_price\":" << m.get<StockPrintProbability::bid_price>();
        o << ",\"ask_price\":" << m.get<StockPrintProbability::ask_price>();
        o << ",\"bid_size\":" << m.get<StockPrintProbability::bid_size>();
        o << ",\"ask_size\":" << m.get<StockPrintProbability::ask_size>();
        o << ",\"avg_blink1m\":" << m.get<StockPrintProbability::avg_blink1m>();
        o << ",\"mae_blink1m\":" << m.get<StockPrintProbability::mae_blink1m>();
        o << ",\"avg_slink1m\":" << m.get<StockPrintProbability::avg_slink1m>();
        o << ",\"mae_slink1m\":" << m.get<StockPrintProbability::mae_slink1m>();
        o << ",\"avg_blink10m\":" << m.get<StockPrintProbability::avg_blink10m>();
        o << ",\"mae_blink10m\":" << m.get<StockPrintProbability::mae_blink10m>();
        o << ",\"avg_slink10m\":" << m.get<StockPrintProbability::avg_slink10m>();
        o << ",\"mae_slink10m\":" << m.get<StockPrintProbability::mae_slink10m>();
        o << ",\"b_counter\":" << m.get<StockPrintProbability::b_counter>();
        o << ",\"s_counter\":" << m.get<StockPrintProbability::s_counter>();
        o << ",\"prt_timestamp\":" << m.get<StockPrintProbability::prt_timestamp>();
        o << ",\"net_timestamp\":" << m.get<StockPrintProbability::net_timestamp>();
        o << ",\"sms_timestamp\":" << m.get<StockPrintProbability::sms_timestamp>();
        return o;
    }
