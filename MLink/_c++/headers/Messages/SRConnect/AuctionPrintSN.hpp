...
namespace api {
    ...
    template<> inline const auto AuctionPrintSN::get<AuctionPrintSN::is_flex>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_is_flex)); }
    ...
    inline std::ostream& operator<<(std::ostream &o, const AuctionPrintSN& m) {
        ...
        o << ",\"is_flex\":" << (int64_t)m.get<AuctionPrintSN::is_flex>();
