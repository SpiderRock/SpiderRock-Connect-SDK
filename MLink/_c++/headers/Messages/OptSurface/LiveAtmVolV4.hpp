...
namespace api {
    ...
    class LiveAtmVolV4_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to LiveAtmVolV4_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to LiveAtmVolV4_PKey::set()"); }  // specializations for valid types are listed below
    ...
    class LiveAtmVolV4 {
        ...
        using pkey = spiderrock::protobuf::api::LiveAtmVolV4_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to LiveAtmVolV4::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const LiveAtmVolV4 & value) {
            set(value.m__meta);
            set(value.m_pkey);
            set(value.m_ticker);
            set(value.m_u_prc);
        ...
        LiveAtmVolV4() {
            m__meta.set_message_type("LiveAtmVolV4");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeSpotUprc()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(163,m_spot_uprc);
            }
            if ( IncludeVWidth()) {
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludeSpotUprc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,163,m_spot_uprc);
            }
            if ( IncludeVWidth()) {
        ...
        const void Decode(const uint8_t*& pos, const uint8_t* max) {
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    ...
                    case 163: {
                        if (tagType == SRProtobufCPP::DoubleCodec::TagType) {
                            m_spot_uprc = SRProtobufCPP::FieldCodec::DecodeDouble(pos,max);
                        }
                        break;
                    }
                    case 166: {
    ...
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::_meta>() const { return LiveAtmVolV4::_meta{ m__meta}; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::pkey>() const { return LiveAtmVolV4::pkey{ m_pkey}; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::ticker>() const { return LiveAtmVolV4::ticker{ m_ticker}; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::u_prc>() const { return m_u_prc; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::years>() const { return m_years; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::rate>() const { return m_rate; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::ddiv>() const { return m_ddiv; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::ddiv_pv>() const { return m_ddiv_pv; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::ddiv_source>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::DDivSource>( m_ddiv_source)); }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::atm_vol>() const { return m_atm_vol; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::atm_ema>() const { return m_atm_ema; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::u_prc_ratio>() const { return m_u_prc_ratio; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::u_prc_ratio_ema>() const { return m_u_prc_ratio_ema; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::sdiv>() const { return m_sdiv; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::sdiv_ema>() const { return m_sdiv_ema; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::min_cpadj_val>() const { return m_min_cpadj_val; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::max_cpadj_val>() const { return m_max_cpadj_val; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::cp_adj_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::CPAdjType>( m_cp_adj_type)); }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::price_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::CalcPriceType>( m_price_type)); }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::u_prc_driver_key>() const { return LiveAtmVolV4::u_prc_driver_key{ m_u_prc_driver_key}; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::u_prc_driver_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SpdrKeyType>( m_u_prc_driver_type)); }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::u_prc_driver>() const { return m_u_prc_driver; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::axis_fuprc>() const { return m_axis_fuprc; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::spot_uprc>() const { return m_spot_uprc; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::v_width>() const { return m_v_width; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::num_atm_strikes>() const { return m_num_atm_strikes; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::tradeable_status>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::TradeableStatus>( m_tradeable_status)); }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::surface_result>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SurfaceAdjResult>( m_surface_result)); }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::net_timestamp>() const { return m_net_timestamp; }
    template<> inline const auto LiveAtmVolV4::get<LiveAtmVolV4::timestamp>() const { return m_timestamp; }
    template<> inline const auto LiveAtmVolV4_PKey::get<LiveAtmVolV4_PKey::ekey>() const { return LiveAtmVolV4_PKey::ekey{m_ekey}; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const LiveAtmVolV4_PKey& m) {
        o << "\"ekey\":{" << m.get<LiveAtmVolV4_PKey::ekey>() << "}";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const LiveAtmVolV4& m) {
        o << "\"_meta\":{" << m.get<LiveAtmVolV4::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<LiveAtmVolV4::pkey>() << "}";
        o << ",\"ticker\":{" << m.get<LiveAtmVolV4::ticker>() << "}";
        o << ",\"u_prc\":" << m.get<LiveAtmVolV4::u_prc>();
        o << ",\"years\":" << m.get<LiveAtmVolV4::years>();
        o << ",\"rate\":" << m.get<LiveAtmVolV4::rate>();
        o << ",\"ddiv\":" << m.get<LiveAtmVolV4::ddiv>();
        o << ",\"ddiv_pv\":" << m.get<LiveAtmVolV4::ddiv_pv>();
        o << ",\"ddiv_source\":" << (int64_t)m.get<LiveAtmVolV4::ddiv_source>();
        o << ",\"atm_vol\":" << m.get<LiveAtmVolV4::atm_vol>();
        o << ",\"atm_ema\":" << m.get<LiveAtmVolV4::atm_ema>();
        o << ",\"u_prc_ratio\":" << m.get<LiveAtmVolV4::u_prc_ratio>();
        o << ",\"u_prc_ratio_ema\":" << m.get<LiveAtmVolV4::u_prc_ratio_ema>();
        o << ",\"sdiv\":" << m.get<LiveAtmVolV4::sdiv>();
        o << ",\"sdiv_ema\":" << m.get<LiveAtmVolV4::sdiv_ema>();
        o << ",\"min_cpadj_val\":" << m.get<LiveAtmVolV4::min_cpadj_val>();
        o << ",\"max_cpadj_val\":" << m.get<LiveAtmVolV4::max_cpadj_val>();
        o << ",\"cp_adj_type\":" << (int64_t)m.get<LiveAtmVolV4::cp_adj_type>();
        o << ",\"price_type\":" << (int64_t)m.get<LiveAtmVolV4::price_type>();
        o << ",\"u_prc_driver_key\":{" << m.get<LiveAtmVolV4::u_prc_driver_key>() << "}";
        o << ",\"u_prc_driver_type\":" << (int64_t)m.get<LiveAtmVolV4::u_prc_driver_type>();
        o << ",\"u_prc_driver\":" << m.get<LiveAtmVolV4::u_prc_driver>();
        o << ",\"axis_fuprc\":" << m.get<LiveAtmVolV4::axis_fuprc>();
        o << ",\"spot_uprc\":" << m.get<LiveAtmVolV4::spot_uprc>();
        o << ",\"v_width\":" << m.get<LiveAtmVolV4::v_width>();
        o << ",\"num_atm_strikes\":" << m.get<LiveAtmVolV4::num_atm_strikes>();
        o << ",\"tradeable_status\":" << (int64_t)m.get<LiveAtmVolV4::tradeable_status>();
        o << ",\"surface_result\":" << (int64_t)m.get<LiveAtmVolV4::surface_result>();
        o << ",\"net_timestamp\":" << m.get<LiveAtmVolV4::net_timestamp>();
        {
            std::time_t tt = m.get<LiveAtmVolV4::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
