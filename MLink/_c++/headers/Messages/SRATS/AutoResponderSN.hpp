...
namespace api {
    ...
    class AutoResponderSN_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to AutoResponderSN_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to AutoResponderSN_PKey::set()"); }  // specializations for valid types are listed below
        ...
        AutoResponderSN_PKey() {}

        virtual ~AutoResponderSN_PKey() {
        }
    ...
    class AutoResponderSN {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::AutoResponderSN_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to AutoResponderSN::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const AutoResponderSN & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        AutoResponderSN() {
            m__meta.set_message_type("AutoResponderSN");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(105,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::RefUPrcType>(m_ref_uprc_type)));
            if ( IncludeTransactFee()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(106,m_transact_fee);
            }
            if ( IncludeStockRate()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(107,m_stock_rate);
            }
            if ( IncludeMoneyRate()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(108,m_money_rate);
            }
            if ( IncludeDdivPv()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(109,m_ddiv_pv);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(110,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::DivControl>(m_div_control)));
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,105,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::RefUPrcType>(m_ref_uprc_type)));
            if ( IncludeTransactFee()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,106,m_transact_fee);
            }
            if ( IncludeStockRate()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,107,m_stock_rate);
            }
            if ( IncludeMoneyRate()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,108,m_money_rate);
            }
            if ( IncludeDdivPv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,109,m_ddiv_pv);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,110,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::DivControl>(m_div_control)));
    ...
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::_meta>() const { return AutoResponderSN::_meta{ m__meta}; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::pkey>() const { return AutoResponderSN::pkey{ m_pkey}; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::user_name>() const { return m_user_name; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::ticker>() const { return AutoResponderSN::ticker{ m_ticker}; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::is_disabled>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_is_disabled)); }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::expiry_qty_avail>() const { return m_expiry_qty_avail; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::ticker_qty_avail>() const { return m_ticker_qty_avail; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::ref_uprc_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::RefUPrcType>( m_ref_uprc_type)); }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::transact_fee>() const { return m_transact_fee; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::stock_rate>() const { return m_stock_rate; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::money_rate>() const { return m_money_rate; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::ddiv_pv>() const { return m_ddiv_pv; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::div_control>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::DivControl>( m_div_control)); }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::inc_fees_in_resp>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_inc_fees_in_resp)); }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::round_rule>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::RoundRule>( m_round_rule)); }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::risk_group_id>() const { return m_risk_group_id; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::modified_by>() const { return m_modified_by; }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::modified_in>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_modified_in)); }
    template<> inline const auto AutoResponderSN::get<AutoResponderSN::timestamp>() const { return m_timestamp; }
    template<> inline const auto AutoResponderSN_PKey::get<AutoResponderSN_PKey::accnt>() const { return m_accnt; }
    template<> inline const auto AutoResponderSN_PKey::get<AutoResponderSN_PKey::client_firm>() const { return m_client_firm; }
    template<> inline const auto AutoResponderSN_PKey::get<AutoResponderSN_PKey::root>() const { return AutoResponderSN_PKey::root{m_root}; }
    template<> inline const auto AutoResponderSN_PKey::get<AutoResponderSN_PKey::expiry>() const { return AutoResponderSN_PKey::expiry{m_expiry}; }
    template<> inline const auto AutoResponderSN_PKey::get<AutoResponderSN_PKey::resp_side>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BuySell>(m_resp_side));}
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const AutoResponderSN_PKey& m) {
        o << "\"accnt\":\"" << m.get<AutoResponderSN_PKey::accnt>() << "\"";
        o << ",\"client_firm\":\"" << m.get<AutoResponderSN_PKey::client_firm>() << "\"";
        o << ",\"root\":{" << m.get<AutoResponderSN_PKey::root>() << "}";
        o << ",\"expiry\":{" << m.get<AutoResponderSN_PKey::expiry>() << "}";
        o << ",\"resp_side\":" << (int64_t)m.get<AutoResponderSN_PKey::resp_side>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const AutoResponderSN& m) {
        o << "\"_meta\":{" << m.get<AutoResponderSN::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<AutoResponderSN::pkey>() << "}";
        o << ",\"user_name\":\"" << m.get<AutoResponderSN::user_name>() << "\"";
        o << ",\"ticker\":{" << m.get<AutoResponderSN::ticker>() << "}";
        o << ",\"is_disabled\":" << (int64_t)m.get<AutoResponderSN::is_disabled>();
        o << ",\"expiry_qty_avail\":" << m.get<AutoResponderSN::expiry_qty_avail>();
        o << ",\"ticker_qty_avail\":" << m.get<AutoResponderSN::ticker_qty_avail>();
        o << ",\"ref_uprc_type\":" << (int64_t)m.get<AutoResponderSN::ref_uprc_type>();
        o << ",\"transact_fee\":" << m.get<AutoResponderSN::transact_fee>();
        o << ",\"stock_rate\":" << m.get<AutoResponderSN::stock_rate>();
        o << ",\"money_rate\":" << m.get<AutoResponderSN::money_rate>();
        o << ",\"ddiv_pv\":" << m.get<AutoResponderSN::ddiv_pv>();
        o << ",\"div_control\":" << (int64_t)m.get<AutoResponderSN::div_control>();
        o << ",\"inc_fees_in_resp\":" << (int64_t)m.get<AutoResponderSN::inc_fees_in_resp>();
        o << ",\"round_rule\":" << (int64_t)m.get<AutoResponderSN::round_rule>();
        o << ",\"risk_group_id\":" << m.get<AutoResponderSN::risk_group_id>();
        o << ",\"modified_by\":\"" << m.get<AutoResponderSN::modified_by>() << "\"";
        o << ",\"modified_in\":" << (int64_t)m.get<AutoResponderSN::modified_in>();
        {
            std::time_t tt = m.get<AutoResponderSN::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
