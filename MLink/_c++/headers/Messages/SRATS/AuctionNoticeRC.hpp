...
namespace api {
    ...
    class AuctionNoticeRC_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to AuctionNoticeRC_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to AuctionNoticeRC_PKey::set()"); }  // specializations for valid types are listed below
        ...
        AuctionNoticeRC_PKey() {}

        virtual ~AuctionNoticeRC_PKey() {
        }
    ...
    class AuctionNoticeRC_DirectedCounterParty {
        public:
        //using statements for all types used in this class
        ...
        //templatized getters and setters
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to AuctionNoticeRC_DirectedCounterParty::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to AuctionNoticeRC_DirectedCounterParty::set()"); }  // specializations for valid types are listed below
        ...
        AuctionNoticeRC_DirectedCounterParty() {}

        virtual ~AuctionNoticeRC_DirectedCounterParty() {
        }
        //templatized set functions that can take multiple arguments simultaneously
        template <typename Arg>
        void set_params(Arg && arg) {
        ...
        size_t ByteSizeLong() const {
            size_t totalSize = 0;
            totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(144,m_client_firm);
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(145,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::InclExclDisclose>(m_incl_excl)));
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(146,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_is_comm_paying)));
            return totalSize;
        }

        uint8_t* Encode(uint8_t*& dest, uint8_t* max) const {
            dest = SRProtobufCPP::FieldCodec::EncodeString(dest,144,static_cast<string>(m_client_firm));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,145,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::InclExclDisclose>(m_incl_excl)));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,146,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_is_comm_paying)));
            return dest;
        }
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    default:
                        ...
                        SRProtobufCPP::Skipper::Skip(pos, tagType, max);
                        break;
                    case 144: {m_client_firm = SRProtobufCPP::FieldCodec::DecodeString(pos,max);
                        break;
                    }
                    case 145: {m_incl_excl = static_cast<spiderrock::protobuf::api::InclExclDisclose>(SRProtobufCPP::FieldCodec::DecodeEnum(pos,max));
                        break;
                    }
                    case 146: {m_is_comm_paying = static_cast<spiderrock::protobuf::api::YesNo>(SRProtobufCPP::FieldCodec::DecodeEnum(pos,max));
                        break;
                    }
                }
            }
    ...
    class AuctionNoticeRC {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::AuctionNoticeRC_PKey;
        ...
        using directed_counter_party = spiderrock::protobuf::api::AuctionNoticeRC_DirectedCounterParty;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to AuctionNoticeRC::get()"); return T{}; }  // specializations for valid types are listed below the class definition

        template <typename T, size_t S = sizeof(T)>
        const auto get(int i) const { static_assert(sizeof(T) == -1, "Unexpected type in call to AuctionNoticeRC::get(int)"); return T{};}  // specializations for valid types are listed below the class definition

        template <typename T, size_t S = sizeof(T)>
        int count() const { static_assert(sizeof(T) == -1, "Unexpected type in call to AuctionNoticeRC::count()"); return 0;}  // specializations for valid types are listed below the class definition
        ...
        void set(const AuctionNoticeRC & value) {
            set(value.m__meta);
            set(value.m_pkey);
            set(value.m_ticker);
        ...
        AuctionNoticeRC() {
            m__meta.set_message_type("AuctionNoticeRC");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(102,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AuctionType>(m_auction_type)));
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(103,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AuctionEvent>(m_auction_event)));
            if ( IncludeSrcAuctionId()) {
                totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(104,m_src_auction_id);
            }
            if ( IncludeSrcAuctionType()) {
                totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(105,m_src_auction_type);
            }
            ...
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(108,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_contains_flex)));
            if ( IncludeShortCode()) {
                totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(147,m_short_code);
            }
            if ( IncludeIndustry()) {
                totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(110,m_industry);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(111,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SymbolType>(m_symbol_type)));
            if ( IncludeUAvgDailyVlm()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(112,m_u_avg_daily_vlm);
            }
            if ( IncludeRoot()) {
                SRProtobufCPP::TickerKeyLayout tickerKeyLayout_root{};
                m_root.setCodecTickerKey(tickerKeyLayout_root);
                totalSize += SRProtobufCPP::FieldCodec::TickerKeyFieldSize(113, tickerKeyLayout_root);
            }
            if ( IncludeExpiry()) {
                totalSize += SRProtobufCPP::FieldCodec::DateKeyFieldSize(114, m_expiry.get_year(), m_expiry.get_month(), m_expiry.get_day());
            }
            if ( IncludeStrike()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(115,m_strike);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(116,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BuySell>(m_cust_side)));
            if ( IncludeCustQty()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(117,m_cust_qty);
            }
            if ( IncludeCustPrc()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(118,m_cust_prc);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(119,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_has_cust_prc)));
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(120,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::FirmType>(m_cust_firm_type)));
            if ( IncludeCustAgentMpid()) {
                totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(121,m_cust_agent_mpid);
            }
            if ( IncludeCustClientFirm()) {
                totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(122,m_cust_client_firm);
            }
            if ( IncludeCommEnhancement()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(123,m_comm_enhancement);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(124,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_cust_comm_paying)));
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(125,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::CustQtyCond>(m_cust_qty_cond)));
            if ( IncludeAuctionDuration()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(126,m_auction_duration);
            }
            if ( IncludePkgSurfPrc()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(148,m_pkg_surf_prc);
            }
            if ( IncludePkgBidPrc()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(149,m_pkg_bid_prc);
            }
            if ( IncludePkgAskPrc()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(150,m_pkg_ask_prc);
            }
            if ( IncludeUBid()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(127,m_u_bid);
            }
            if ( IncludeUAsk()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(128,m_u_ask);
            }
            if ( IncludeIDays()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(129,m_i_days);
            }
            if ( IncludeIYears()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(130,m_i_years);
            }
            if ( IncludeMoneyRate()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(131,m_money_rate);
            }
            if ( IncludeDdivPv()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(132,m_ddiv_pv);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(133,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_has_est_ddivs)));
            if ( IncludeSVol()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(134,m_s_vol);
            }
            if ( IncludeRcEexPrem()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(135,m_rc_eex_prem);
            }
            if ( IncludeStrikePv()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(136,m_strike_pv);
            }
            if ( IncludeEffStockLendPv()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(137,m_eff_stock_lend_pv);
            }
            if ( IncludeEffStockRate()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(138,m_eff_stock_rate);
            }
            if ( IncludeSrcTimestamp()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(139,m_src_timestamp);
            }
            if ( IncludeNetTimestamp()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(140,m_net_timestamp);
            }
            if ( IncludeTimestamp()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(141, m_timestamp);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(142,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::InclExclDisclose>(m_include_srnetwork)));
            if ( IncludeDirectedCounterParty()) {
                for (auto& item : m_directed_counter_party) {
					totalSize += SRProtobufCPP::TagCodec::Size(143, SRProtobufCPP::TagCodecEnums::TagType::LengthDelimited);
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,102,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AuctionType>(m_auction_type)));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,103,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AuctionEvent>(m_auction_event)));
            if ( IncludeSrcAuctionId()) {
                dest = SRProtobufCPP::FieldCodec::EncodeString(dest,104,static_cast<string>(m_src_auction_id));
            }
            if ( IncludeSrcAuctionType()) {
                dest = SRProtobufCPP::FieldCodec::EncodeString(dest,105,static_cast<string>(m_src_auction_type));
            }
            ...
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,108,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_contains_flex)));
            if ( IncludeShortCode()) {
                dest = SRProtobufCPP::FieldCodec::EncodeString(dest,147,static_cast<string>(m_short_code));
            }
            if ( IncludeIndustry()) {
                dest = SRProtobufCPP::FieldCodec::EncodeString(dest,110,static_cast<string>(m_industry));
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,111,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SymbolType>(m_symbol_type)));
            if ( IncludeUAvgDailyVlm()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,112,m_u_avg_daily_vlm);
            }
            if ( IncludeRoot()) {
                SRProtobufCPP::TickerKeyLayout tickerKeyLayout_root{};
                m_root.setCodecTickerKey(tickerKeyLayout_root);
                dest = SRProtobufCPP::FieldCodec::EncodeTickerKey(dest, 113, tickerKeyLayout_root);
            }
            if ( IncludeExpiry()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateKey(dest,114, m_expiry.get_year(), m_expiry.get_month(), m_expiry.get_day());
            }
            if ( IncludeStrike()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,115,m_strike);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,116,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BuySell>(m_cust_side)));
            if ( IncludeCustQty()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,117,m_cust_qty);
            }
            if ( IncludeCustPrc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,118,m_cust_prc);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,119,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_has_cust_prc)));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,120,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::FirmType>(m_cust_firm_type)));
            if ( IncludeCustAgentMpid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeString(dest,121,static_cast<string>(m_cust_agent_mpid));
            }
            if ( IncludeCustClientFirm()) {
                dest = SRProtobufCPP::FieldCodec::EncodeString(dest,122,static_cast<string>(m_cust_client_firm));
            }
            if ( IncludeCommEnhancement()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,123,m_comm_enhancement);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,124,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_cust_comm_paying)));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,125,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::CustQtyCond>(m_cust_qty_cond)));
            if ( IncludeAuctionDuration()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,126,m_auction_duration);
            }
            if ( IncludePkgSurfPrc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,148,m_pkg_surf_prc);
            }
            if ( IncludePkgBidPrc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,149,m_pkg_bid_prc);
            }
            if ( IncludePkgAskPrc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,150,m_pkg_ask_prc);
            }
            if ( IncludeUBid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,127,m_u_bid);
            }
            if ( IncludeUAsk()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,128,m_u_ask);
            }
            if ( IncludeIDays()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,129,m_i_days);
            }
            if ( IncludeIYears()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,130,m_i_years);
            }
            if ( IncludeMoneyRate()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,131,m_money_rate);
            }
            if ( IncludeDdivPv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,132,m_ddiv_pv);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,133,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_has_est_ddivs)));
            if ( IncludeSVol()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,134,m_s_vol);
            }
            if ( IncludeRcEexPrem()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,135,m_rc_eex_prem);
            }
            if ( IncludeStrikePv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,136,m_strike_pv);
            }
            if ( IncludeEffStockLendPv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,137,m_eff_stock_lend_pv);
            }
            if ( IncludeEffStockRate()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,138,m_eff_stock_rate);
            }
            if ( IncludeSrcTimestamp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,139,m_src_timestamp);
            }
            if ( IncludeNetTimestamp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,140,m_net_timestamp);
            }
            if ( IncludeTimestamp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 141, m_timestamp);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,142,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::InclExclDisclose>(m_include_srnetwork)));
            if ( IncludeDirectedCounterParty()) {
                for (auto& item : m_directed_counter_party) {
                    dest = SRProtobufCPP::TagCodec::Encode(dest, 143, SRProtobufCPP::TagCodecEnums::TagType::LengthDelimited);
    ...
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::_meta>() const { return AuctionNoticeRC::_meta{ m__meta}; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::pkey>() const { return AuctionNoticeRC::pkey{ m_pkey}; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::ticker>() const { return AuctionNoticeRC::ticker{ m_ticker}; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::trade_date>() const { return AuctionNoticeRC::trade_date{ m_trade_date}; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::auction_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AuctionType>( m_auction_type)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::auction_event>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AuctionEvent>( m_auction_event)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::src_auction_id>() const { return m_src_auction_id; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::src_auction_type>() const { return m_src_auction_type; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::auction_source>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::AuctionSource>( m_auction_source)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::is_test_auction>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_is_test_auction)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::contains_flex>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_contains_flex)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::short_code>() const { return m_short_code; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::industry>() const { return m_industry; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::symbol_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SymbolType>( m_symbol_type)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::u_avg_daily_vlm>() const { return m_u_avg_daily_vlm; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::root>() const { return AuctionNoticeRC::root{ m_root}; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::expiry>() const { return AuctionNoticeRC::expiry{ m_expiry}; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::strike>() const { return m_strike; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_side>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BuySell>( m_cust_side)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_qty>() const { return m_cust_qty; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_prc>() const { return m_cust_prc; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::has_cust_prc>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_has_cust_prc)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_firm_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::FirmType>( m_cust_firm_type)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_agent_mpid>() const { return m_cust_agent_mpid; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_client_firm>() const { return m_cust_client_firm; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::comm_enhancement>() const { return m_comm_enhancement; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_comm_paying>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_cust_comm_paying)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::cust_qty_cond>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::CustQtyCond>( m_cust_qty_cond)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::auction_duration>() const { return m_auction_duration; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::pkg_surf_prc>() const { return m_pkg_surf_prc; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::pkg_bid_prc>() const { return m_pkg_bid_prc; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::pkg_ask_prc>() const { return m_pkg_ask_prc; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::u_bid>() const { return m_u_bid; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::u_ask>() const { return m_u_ask; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::i_days>() const { return m_i_days; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::i_years>() const { return m_i_years; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::money_rate>() const { return m_money_rate; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::ddiv_pv>() const { return m_ddiv_pv; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::has_est_ddivs>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_has_est_ddivs)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::s_vol>() const { return m_s_vol; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::rc_eex_prem>() const { return m_rc_eex_prem; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::strike_pv>() const { return m_strike_pv; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::eff_stock_lend_pv>() const { return m_eff_stock_lend_pv; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::eff_stock_rate>() const { return m_eff_stock_rate; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::src_timestamp>() const { return m_src_timestamp; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::net_timestamp>() const { return m_net_timestamp; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::timestamp>() const { return m_timestamp; }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::include_srnetwork>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::InclExclDisclose>( m_include_srnetwork)); }
    template<> inline const auto AuctionNoticeRC::get<AuctionNoticeRC::directed_counter_party>(int i) const { return AuctionNoticeRC::directed_counter_party{ get_directed_counter_party(i)}; }
    template<> inline int AuctionNoticeRC::count<AuctionNoticeRC::directed_counter_party>() const { return static_cast<int>( m_directed_counter_party.size()); }
    template<> inline const auto AuctionNoticeRC_PKey::get<AuctionNoticeRC_PKey::notice_number>() const { return m_notice_number; }
    
    template<> inline const auto AuctionNoticeRC_DirectedCounterParty::get<AuctionNoticeRC_DirectedCounterParty::client_firm>() const { return m_client_firm; }
    template<> inline const auto AuctionNoticeRC_DirectedCounterParty::get<AuctionNoticeRC_DirectedCounterParty::incl_excl>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::InclExclDisclose>(m_incl_excl));}
    template<> inline const auto AuctionNoticeRC_DirectedCounterParty::get<AuctionNoticeRC_DirectedCounterParty::is_comm_paying>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_is_comm_paying));}
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const AuctionNoticeRC_PKey& m) {
        o << "\"notice_number\":" << m.get<AuctionNoticeRC_PKey::notice_number>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const AuctionNoticeRC_DirectedCounterParty& m) {
        o << "\"client_firm\":\"" << m.get<AuctionNoticeRC_DirectedCounterParty::client_firm>() << "\"";
        o << ",\"incl_excl\":" << (int64_t)m.get<AuctionNoticeRC_DirectedCounterParty::incl_excl>();
        o << ",\"is_comm_paying\":" << (int64_t)m.get<AuctionNoticeRC_DirectedCounterParty::is_comm_paying>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const AuctionNoticeRC& m) {
        o << "\"_meta\":{" << m.get<AuctionNoticeRC::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<AuctionNoticeRC::pkey>() << "}";
        o << ",\"ticker\":{" << m.get<AuctionNoticeRC::ticker>() << "}";
        o << ",\"trade_date\":{" << m.get<AuctionNoticeRC::trade_date>() << "}";
        o << ",\"auction_type\":" << (int64_t)m.get<AuctionNoticeRC::auction_type>();
        o << ",\"auction_event\":" << (int64_t)m.get<AuctionNoticeRC::auction_event>();
        o << ",\"src_auction_id\":\"" << m.get<AuctionNoticeRC::src_auction_id>() << "\"";
        o << ",\"src_auction_type\":\"" << m.get<AuctionNoticeRC::src_auction_type>() << "\"";
        o << ",\"auction_source\":" << (int64_t)m.get<AuctionNoticeRC::auction_source>();
        o << ",\"is_test_auction\":" << (int64_t)m.get<AuctionNoticeRC::is_test_auction>();
        o << ",\"contains_flex\":" << (int64_t)m.get<AuctionNoticeRC::contains_flex>();
        o << ",\"short_code\":\"" << m.get<AuctionNoticeRC::short_code>() << "\"";
        o << ",\"industry\":\"" << m.get<AuctionNoticeRC::industry>() << "\"";
        o << ",\"symbol_type\":" << (int64_t)m.get<AuctionNoticeRC::symbol_type>();
        o << ",\"u_avg_daily_vlm\":" << m.get<AuctionNoticeRC::u_avg_daily_vlm>();
        o << ",\"root\":{" << m.get<AuctionNoticeRC::root>() << "}";
        o << ",\"expiry\":{" << m.get<AuctionNoticeRC::expiry>() << "}";
        o << ",\"strike\":" << m.get<AuctionNoticeRC::strike>();
        o << ",\"cust_side\":" << (int64_t)m.get<AuctionNoticeRC::cust_side>();
        o << ",\"cust_qty\":" << m.get<AuctionNoticeRC::cust_qty>();
        o << ",\"cust_prc\":" << m.get<AuctionNoticeRC::cust_prc>();
        o << ",\"has_cust_prc\":" << (int64_t)m.get<AuctionNoticeRC::has_cust_prc>();
        o << ",\"cust_firm_type\":" << (int64_t)m.get<AuctionNoticeRC::cust_firm_type>();
        o << ",\"cust_agent_mpid\":\"" << m.get<AuctionNoticeRC::cust_agent_mpid>() << "\"";
        o << ",\"cust_client_firm\":\"" << m.get<AuctionNoticeRC::cust_client_firm>() << "\"";
        o << ",\"comm_enhancement\":" << m.get<AuctionNoticeRC::comm_enhancement>();
        o << ",\"cust_comm_paying\":" << (int64_t)m.get<AuctionNoticeRC::cust_comm_paying>();
        o << ",\"cust_qty_cond\":" << (int64_t)m.get<AuctionNoticeRC::cust_qty_cond>();
        o << ",\"auction_duration\":" << m.get<AuctionNoticeRC::auction_duration>();
        o << ",\"pkg_surf_prc\":" << m.get<AuctionNoticeRC::pkg_surf_prc>();
        o << ",\"pkg_bid_prc\":" << m.get<AuctionNoticeRC::pkg_bid_prc>();
        o << ",\"pkg_ask_prc\":" << m.get<AuctionNoticeRC::pkg_ask_prc>();
        o << ",\"u_bid\":" << m.get<AuctionNoticeRC::u_bid>();
        o << ",\"u_ask\":" << m.get<AuctionNoticeRC::u_ask>();
        o << ",\"i_days\":" << m.get<AuctionNoticeRC::i_days>();
        o << ",\"i_years\":" << m.get<AuctionNoticeRC::i_years>();
        o << ",\"money_rate\":" << m.get<AuctionNoticeRC::money_rate>();
        o << ",\"ddiv_pv\":" << m.get<AuctionNoticeRC::ddiv_pv>();
        o << ",\"has_est_ddivs\":" << (int64_t)m.get<AuctionNoticeRC::has_est_ddivs>();
        o << ",\"s_vol\":" << m.get<AuctionNoticeRC::s_vol>();
        o << ",\"rc_eex_prem\":" << m.get<AuctionNoticeRC::rc_eex_prem>();
        o << ",\"strike_pv\":" << m.get<AuctionNoticeRC::strike_pv>();
        o << ",\"eff_stock_lend_pv\":" << m.get<AuctionNoticeRC::eff_stock_lend_pv>();
        o << ",\"eff_stock_rate\":" << m.get<AuctionNoticeRC::eff_stock_rate>();
        o << ",\"src_timestamp\":" << m.get<AuctionNoticeRC::src_timestamp>();
        o << ",\"net_timestamp\":" << m.get<AuctionNoticeRC::net_timestamp>();
        {
            std::time_t tt = m.get<AuctionNoticeRC::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
            o << ",\"timestamp\":\"" << std::put_time(&tm1, "%a %b %e %T %Y") << "\"";
        }
        o << ",\"include_srnetwork\":" << (int64_t)m.get<AuctionNoticeRC::include_srnetwork>();
        o << ",\"directed_counter_party\":[";
        {
            const char *delim = "{";
            for (int i=0; i<m.count<AuctionNoticeRC::directed_counter_party>(); ++i) {
                o << delim << m.get<AuctionNoticeRC::directed_counter_party>(i) << '}';
                delim = ",{";
            }
        }
        o << "]";
