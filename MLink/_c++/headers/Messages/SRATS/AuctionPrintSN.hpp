...
namespace api {
    ...
    class AuctionPrintSN {
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludePrtPrice()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(131,m_prt_price);
            }
            if ( IncludePrtPrice2()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(132,m_prt_price2);
            }
            if ( IncludePrtSize()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(133,m_prt_size);
            }
            if ( IncludePrtSize2()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(134,m_prt_size2);
            }
            if ( IncludePrtTime()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(135, m_prt_time);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(136,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::PrtType>(m_prt_type)));
            if ( IncludePrtUbid()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(137,m_prt_ubid);
            }
            if ( IncludePrtUask()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(138,m_prt_uask);
            }
            if ( IncludePrtUprc()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(139,m_prt_uprc);
            }
            if ( IncludePrtSurfPrc()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(140,m_prt_surf_prc);
            }
            if ( IncludeUPrc1m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(141,m_u_prc1m);
            }
            if ( IncludeBidPrc1m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(142,m_bid_prc1m);
            }
            if ( IncludeAskPrc1m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(143,m_ask_prc1m);
            }
            if ( IncludeSurfPrc1m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(144,m_surf_prc1m);
            }
            if ( IncludeUPrc10m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(145,m_u_prc10m);
            }
            if ( IncludeBidPrc10m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(146,m_bid_prc10m);
            }
            if ( IncludeAskPrc10m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(147,m_ask_prc10m);
            }
            if ( IncludeSurfPrc10m()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(148,m_surf_prc10m);
            }
            if ( IncludeTimestamp()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(149, m_timestamp);
            }
            return totalSize;
        }
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludePrtPrice()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,131,m_prt_price);
            }
            if ( IncludePrtPrice2()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,132,m_prt_price2);
            }
            if ( IncludePrtSize()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,133,m_prt_size);
            }
            if ( IncludePrtSize2()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,134,m_prt_size2);
            }
            if ( IncludePrtTime()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 135, m_prt_time);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,136,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::PrtType>(m_prt_type)));
            if ( IncludePrtUbid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,137,m_prt_ubid);
            }
            if ( IncludePrtUask()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,138,m_prt_uask);
            }
            if ( IncludePrtUprc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,139,m_prt_uprc);
            }
            if ( IncludePrtSurfPrc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,140,m_prt_surf_prc);
            }
            if ( IncludeUPrc1m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,141,m_u_prc1m);
            }
            if ( IncludeBidPrc1m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,142,m_bid_prc1m);
            }
            if ( IncludeAskPrc1m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,143,m_ask_prc1m);
            }
            if ( IncludeSurfPrc1m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,144,m_surf_prc1m);
            }
            if ( IncludeUPrc10m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,145,m_u_prc10m);
            }
            if ( IncludeBidPrc10m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,146,m_bid_prc10m);
            }
            if ( IncludeAskPrc10m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,147,m_ask_prc10m);
            }
            if ( IncludeSurfPrc10m()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,148,m_surf_prc10m);
            }
            if ( IncludeTimestamp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 149, m_timestamp);
            }
        }
