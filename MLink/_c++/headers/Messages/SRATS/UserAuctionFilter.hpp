...
namespace api {
    ...
    #ifndef _min_uprc__float__GUARD__
    #define _min_uprc__float__GUARD__
    DECL_STRONG_TYPE(min_uprc__float, float);
    #endif//_min_uprc__float__GUARD__
    ...
    class UserAuctionFilter {
        ...
        using min_uprc = spiderrock::protobuf::api::min_uprc__float;
