...
namespace api {
    ...
    class ResponderMarkupSN {
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeNumNotices()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(131,m_num_notices);
            }
            if ( IncludeNumNoticeSr()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(132,m_num_notice_sr);
            }
            if ( IncludeNumNoticeAmex()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(133,m_num_notice_amex);
            }
            if ( IncludeNumNoticeBats()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(134,m_num_notice_bats);
            }
            if ( IncludeNumNoticeBox()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(135,m_num_notice_box);
            }
            if ( IncludeNumNoticeCboe()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(136,m_num_notice_cboe);
            }
            if ( IncludeNumNoticeC2()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(137,m_num_notice_c2);
            }
            if ( IncludeNumNoticeEdgo()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(138,m_num_notice_edgo);
            }
            if ( IncludeNumNoticeEmld()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(139,m_num_notice_emld);
            }
            if ( IncludeNumNoticeGmni()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(140,m_num_notice_gmni);
            }
            if ( IncludeNumNoticeIse()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(141,m_num_notice_ise);
            }
            if ( IncludeNumNoticeMcry()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(142,m_num_notice_mcry);
            }
            if ( IncludeNumNoticeMemx()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(143,m_num_notice_memx);
            }
            if ( IncludeNumNoticeMiax()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(144,m_num_notice_miax);
            }
            if ( IncludeNumNoticeMprl()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(145,m_num_notice_mprl);
            }
            if ( IncludeNumNoticeNyse()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(146,m_num_notice_nyse);
            }
            if ( IncludeNumNoticeNqbx()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(147,m_num_notice_nqbx);
            }
            if ( IncludeNumNoticeNsdq()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(148,m_num_notice_nsdq);
            }
            if ( IncludeNumNoticePhlx()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(149,m_num_notice_phlx);
            }
            if ( IncludeNumNoticeSphr()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(150,m_num_notice_sphr);
            }
            if ( IncludeNumDisabled()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(151,m_num_disabled);
            }
            if ( IncludeNumListedFlexMiss()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(152,m_num_listed_flex_miss);
            }
            if ( IncludeNumNoticePriceMiss()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(153,m_num_notice_price_miss);
            }
            if ( IncludeNumAggSizeLimit()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(154,m_num_agg_size_limit);
            }
            if ( IncludeNumRiskGroupLimit()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(155,m_num_risk_group_limit);
            }
            if ( IncludeNumResponses()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(156,m_num_responses);
            }
            if ( IncludeNumFullSize()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(157,m_num_full_size);
            }
            if ( IncludeNumAllocSize()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(158,m_num_alloc_size);
            }
            if ( IncludeNumPriceMiss()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(159,m_num_price_miss);
            }
            if ( IncludeNumTooLate()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(160,m_num_too_late);
            }
            if ( IncludeNumOtherMiss()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(161,m_num_other_miss);
            }
            if ( IncludeNumDidNotTrade()) {
                totalSize += SRProtobufCPP::FieldCodec::LongFieldSize(162,m_num_did_not_trade);
            }
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludeNumNotices()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,131,m_num_notices);
            }
            if ( IncludeNumNoticeSr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,132,m_num_notice_sr);
            }
            if ( IncludeNumNoticeAmex()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,133,m_num_notice_amex);
            }
            if ( IncludeNumNoticeBats()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,134,m_num_notice_bats);
            }
            if ( IncludeNumNoticeBox()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,135,m_num_notice_box);
            }
            if ( IncludeNumNoticeCboe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,136,m_num_notice_cboe);
            }
            if ( IncludeNumNoticeC2()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,137,m_num_notice_c2);
            }
            if ( IncludeNumNoticeEdgo()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,138,m_num_notice_edgo);
            }
            if ( IncludeNumNoticeEmld()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,139,m_num_notice_emld);
            }
            if ( IncludeNumNoticeGmni()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,140,m_num_notice_gmni);
            }
            if ( IncludeNumNoticeIse()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,141,m_num_notice_ise);
            }
            if ( IncludeNumNoticeMcry()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,142,m_num_notice_mcry);
            }
            if ( IncludeNumNoticeMemx()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,143,m_num_notice_memx);
            }
            if ( IncludeNumNoticeMiax()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,144,m_num_notice_miax);
            }
            if ( IncludeNumNoticeMprl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,145,m_num_notice_mprl);
            }
            if ( IncludeNumNoticeNyse()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,146,m_num_notice_nyse);
            }
            if ( IncludeNumNoticeNqbx()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,147,m_num_notice_nqbx);
            }
            if ( IncludeNumNoticeNsdq()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,148,m_num_notice_nsdq);
            }
            if ( IncludeNumNoticePhlx()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,149,m_num_notice_phlx);
            }
            if ( IncludeNumNoticeSphr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,150,m_num_notice_sphr);
            }
            if ( IncludeNumDisabled()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,151,m_num_disabled);
            }
            if ( IncludeNumListedFlexMiss()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,152,m_num_listed_flex_miss);
            }
            if ( IncludeNumNoticePriceMiss()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,153,m_num_notice_price_miss);
            }
            if ( IncludeNumAggSizeLimit()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,154,m_num_agg_size_limit);
            }
            if ( IncludeNumRiskGroupLimit()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,155,m_num_risk_group_limit);
            }
            if ( IncludeNumResponses()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,156,m_num_responses);
            }
            if ( IncludeNumFullSize()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,157,m_num_full_size);
            }
            if ( IncludeNumAllocSize()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,158,m_num_alloc_size);
            }
            if ( IncludeNumPriceMiss()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,159,m_num_price_miss);
            }
            if ( IncludeNumTooLate()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,160,m_num_too_late);
            }
            if ( IncludeNumOtherMiss()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,161,m_num_other_miss);
            }
            if ( IncludeNumDidNotTrade()) {
                dest = SRProtobufCPP::FieldCodec::EncodeLong(dest,162,m_num_did_not_trade);
            }
            if ( IncludeModifiedBy()) {
    ...
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notices>() const { return m_num_notices; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_sr>() const { return m_num_notice_sr; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_amex>() const { return m_num_notice_amex; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_bats>() const { return m_num_notice_bats; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_box>() const { return m_num_notice_box; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_cboe>() const { return m_num_notice_cboe; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_c2>() const { return m_num_notice_c2; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_edgo>() const { return m_num_notice_edgo; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_emld>() const { return m_num_notice_emld; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_gmni>() const { return m_num_notice_gmni; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_ise>() const { return m_num_notice_ise; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_mcry>() const { return m_num_notice_mcry; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_memx>() const { return m_num_notice_memx; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_miax>() const { return m_num_notice_miax; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_mprl>() const { return m_num_notice_mprl; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_nyse>() const { return m_num_notice_nyse; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_nqbx>() const { return m_num_notice_nqbx; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_nsdq>() const { return m_num_notice_nsdq; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_phlx>() const { return m_num_notice_phlx; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_sphr>() const { return m_num_notice_sphr; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_disabled>() const { return m_num_disabled; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_listed_flex_miss>() const { return m_num_listed_flex_miss; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_notice_price_miss>() const { return m_num_notice_price_miss; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_agg_size_limit>() const { return m_num_agg_size_limit; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_risk_group_limit>() const { return m_num_risk_group_limit; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_responses>() const { return m_num_responses; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_full_size>() const { return m_num_full_size; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_alloc_size>() const { return m_num_alloc_size; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_price_miss>() const { return m_num_price_miss; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_too_late>() const { return m_num_too_late; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_other_miss>() const { return m_num_other_miss; }
    template<> inline const auto ResponderMarkupSN::get<ResponderMarkupSN::num_did_not_trade>() const { return m_num_did_not_trade; }
    ...
    template<> inline const auto ResponderMarkupSN_PKey::get<ResponderMarkupSN_PKey::ekey>() const { return ResponderMarkupSN_PKey::ekey{m_ekey}; }
    ...
    inline std::ostream& operator<<(std::ostream &o, const ResponderMarkupSN_PKey& m) {
        ...
        o << ",\"ekey\":{" << m.get<ResponderMarkupSN_PKey::ekey>() << "}";
    ...
    inline std::ostream& operator<<(std::ostream &o, const ResponderMarkupSN& m) {
        ...
        o << ",\"num_notices\":" << m.get<ResponderMarkupSN::num_notices>();
        o << ",\"num_notice_sr\":" << m.get<ResponderMarkupSN::num_notice_sr>();
        o << ",\"num_notice_amex\":" << m.get<ResponderMarkupSN::num_notice_amex>();
        o << ",\"num_notice_bats\":" << m.get<ResponderMarkupSN::num_notice_bats>();
        o << ",\"num_notice_box\":" << m.get<ResponderMarkupSN::num_notice_box>();
        o << ",\"num_notice_cboe\":" << m.get<ResponderMarkupSN::num_notice_cboe>();
        o << ",\"num_notice_c2\":" << m.get<ResponderMarkupSN::num_notice_c2>();
        o << ",\"num_notice_edgo\":" << m.get<ResponderMarkupSN::num_notice_edgo>();
        o << ",\"num_notice_emld\":" << m.get<ResponderMarkupSN::num_notice_emld>();
        o << ",\"num_notice_gmni\":" << m.get<ResponderMarkupSN::num_notice_gmni>();
        o << ",\"num_notice_ise\":" << m.get<ResponderMarkupSN::num_notice_ise>();
        o << ",\"num_notice_mcry\":" << m.get<ResponderMarkupSN::num_notice_mcry>();
        o << ",\"num_notice_memx\":" << m.get<ResponderMarkupSN::num_notice_memx>();
        o << ",\"num_notice_miax\":" << m.get<ResponderMarkupSN::num_notice_miax>();
        o << ",\"num_notice_mprl\":" << m.get<ResponderMarkupSN::num_notice_mprl>();
        o << ",\"num_notice_nyse\":" << m.get<ResponderMarkupSN::num_notice_nyse>();
        o << ",\"num_notice_nqbx\":" << m.get<ResponderMarkupSN::num_notice_nqbx>();
        o << ",\"num_notice_nsdq\":" << m.get<ResponderMarkupSN::num_notice_nsdq>();
        o << ",\"num_notice_phlx\":" << m.get<ResponderMarkupSN::num_notice_phlx>();
        o << ",\"num_notice_sphr\":" << m.get<ResponderMarkupSN::num_notice_sphr>();
        o << ",\"num_disabled\":" << m.get<ResponderMarkupSN::num_disabled>();
        o << ",\"num_listed_flex_miss\":" << m.get<ResponderMarkupSN::num_listed_flex_miss>();
        o << ",\"num_notice_price_miss\":" << m.get<ResponderMarkupSN::num_notice_price_miss>();
        o << ",\"num_agg_size_limit\":" << m.get<ResponderMarkupSN::num_agg_size_limit>();
        o << ",\"num_risk_group_limit\":" << m.get<ResponderMarkupSN::num_risk_group_limit>();
        o << ",\"num_responses\":" << m.get<ResponderMarkupSN::num_responses>();
        o << ",\"num_full_size\":" << m.get<ResponderMarkupSN::num_full_size>();
        o << ",\"num_alloc_size\":" << m.get<ResponderMarkupSN::num_alloc_size>();
        o << ",\"num_price_miss\":" << m.get<ResponderMarkupSN::num_price_miss>();
        o << ",\"num_too_late\":" << m.get<ResponderMarkupSN::num_too_late>();
        o << ",\"num_other_miss\":" << m.get<ResponderMarkupSN::num_other_miss>();
        o << ",\"num_did_not_trade\":" << m.get<ResponderMarkupSN::num_did_not_trade>();
