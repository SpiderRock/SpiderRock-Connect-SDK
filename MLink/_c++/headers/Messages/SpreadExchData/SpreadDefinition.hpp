...
namespace api {
    ...
    DECL_STRONG_TYPE(srspread_id, int32);
    ...
    class SpreadDefinition_PKey {
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeSrspreadId()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(10,m_srspread_id);
            }
            return totalSize;
        }
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            if ( IncludeSrspreadId()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,10,m_srspread_id);
            }
        }
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    default:
                        ...
                        break;
                    case 10: {m_srspread_id = SRProtobufCPP::FieldCodec::DecodeInt(pos,max);
                        break;
                    }
                }
            }
