...
namespace api {
    ...
    template<> inline const auto OptionOpenMark::get<OptionOpenMark::opn_mark_state>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::OpnMarkState>( m_opn_mark_state)); }
    ...
    template<> inline const auto OptionOpenMark::get<OptionOpenMark::ddiv_pv>() const { return m_ddiv_pv; }
    ...
    inline std::ostream& operator<<(std::ostream &o, const OptionOpenMark& m) {
        ...
        o << ",\"opn_mark_state\":" << (int64_t)m.get<OptionOpenMark::opn_mark_state>();
        ...
        o << ",\"ddiv_pv\":" << m.get<OptionOpenMark::ddiv_pv>();
