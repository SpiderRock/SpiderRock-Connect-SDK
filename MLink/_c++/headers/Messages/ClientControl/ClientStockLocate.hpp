...
namespace api {
    ...
    class ClientStockLocate_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to ClientStockLocate_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to ClientStockLocate_PKey::set()"); }  // specializations for valid types are listed below
        ...
        ClientStockLocate_PKey() {}

        virtual ~ClientStockLocate_PKey() {
        }
    ...
    class ClientStockLocate {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::ClientStockLocate_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to ClientStockLocate::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const locate_source & value) {
            set_locate_source(value);
        }
        ...
        void set(const ClientStockLocate & value) {
            set(value.m__meta);
            set(value.m_pkey);
            set(value.m_locate_quan);
            set(value.m_is_locate_exempt);
            set(value.m_locate_source);
        ...
        ClientStockLocate() {
            m__meta.set_message_type("ClientStockLocate");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(101,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_is_locate_exempt)));
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(102,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::LocateSource>(m_locate_source)));
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,101,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>(m_is_locate_exempt)));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,102,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::LocateSource>(m_locate_source)));
            if ( IncludeModifiedBy()) {
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    ...
                    case 102: {if (tagType == SRProtobufCPP::EnumCodec::TagType) {
                            m_locate_source = static_cast<spiderrock::protobuf::api::LocateSource>(SRProtobufCPP::FieldCodec::DecodeEnum(pos,max));
                        }
                        break;
                    }
                    case 103: {
    ...
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::_meta>() const { return ClientStockLocate::_meta{ m__meta}; }
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::pkey>() const { return ClientStockLocate::pkey{ m_pkey}; }
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::locate_quan>() const { return m_locate_quan; }
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::is_locate_exempt>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_is_locate_exempt)); }
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::locate_source>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::LocateSource>( m_locate_source)); }
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::modified_by>() const { return m_modified_by; }
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::modified_in>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SysEnvironment>( m_modified_in)); }
    template<> inline const auto ClientStockLocate::get<ClientStockLocate::timestamp>() const { return m_timestamp; }
    template<> inline const auto ClientStockLocate_PKey::get<ClientStockLocate_PKey::ticker>() const { return ClientStockLocate_PKey::ticker{m_ticker}; }
    template<> inline const auto ClientStockLocate_PKey::get<ClientStockLocate_PKey::core_client_firm>() const { return m_core_client_firm; }
    template<> inline const auto ClientStockLocate_PKey::get<ClientStockLocate_PKey::locate_firm>() const { return m_locate_firm; }
    template<> inline const auto ClientStockLocate_PKey::get<ClientStockLocate_PKey::locate_pool>() const { return m_locate_pool; }
    template<> inline const auto ClientStockLocate_PKey::get<ClientStockLocate_PKey::trade_date>() const { return ClientStockLocate_PKey::trade_date{m_trade_date}; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const ClientStockLocate_PKey& m) {
        o << "\"ticker\":{" << m.get<ClientStockLocate_PKey::ticker>() << "}";
        o << ",\"core_client_firm\":\"" << m.get<ClientStockLocate_PKey::core_client_firm>() << "\"";
        o << ",\"locate_firm\":\"" << m.get<ClientStockLocate_PKey::locate_firm>() << "\"";
        o << ",\"locate_pool\":\"" << m.get<ClientStockLocate_PKey::locate_pool>() << "\"";
        o << ",\"trade_date\":{" << m.get<ClientStockLocate_PKey::trade_date>() << "}";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const ClientStockLocate& m) {
        o << "\"_meta\":{" << m.get<ClientStockLocate::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<ClientStockLocate::pkey>() << "}";
        o << ",\"locate_quan\":" << m.get<ClientStockLocate::locate_quan>();
        o << ",\"is_locate_exempt\":" << (int64_t)m.get<ClientStockLocate::is_locate_exempt>();
        o << ",\"locate_source\":" << (int64_t)m.get<ClientStockLocate::locate_source>();
        o << ",\"modified_by\":\"" << m.get<ClientStockLocate::modified_by>() << "\"";
        o << ",\"modified_in\":" << (int64_t)m.get<ClientStockLocate::modified_in>();
        {
            std::time_t tt = m.get<ClientStockLocate::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
