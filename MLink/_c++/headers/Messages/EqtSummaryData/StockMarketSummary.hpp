...
namespace api {
    ...
    template<> inline const auto StockMarketSummary::get<StockMarketSummary::prt_price>() const { return m_prt_price; }
    ...
    template<> inline const auto StockMarketSummary::get<StockMarketSummary::last_print>() const { return m_last_print; }
    ...
    inline std::ostream& operator<<(std::ostream &o, const StockMarketSummary& m) {
        ...
        o << ",\"prt_price\":" << m.get<StockMarketSummary::prt_price>();
        ...
        {
            std::time_t tt = m.get<StockMarketSummary::last_print>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
