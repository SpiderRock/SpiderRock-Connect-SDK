...
namespace api {
    ...
    class FutureRiskDetailV5_PKey {
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureRiskDetailV5_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureRiskDetailV5_PKey::set()"); }  // specializations for valid types are listed below
        ...
        FutureRiskDetailV5_PKey() {}

        virtual ~FutureRiskDetailV5_PKey() {
        }
    ...
    class FutureRiskDetailV5 {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::FutureRiskDetailV5_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureRiskDetailV5::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const FutureRiskDetailV5 & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        FutureRiskDetailV5() {
            m__meta.set_message_type("FutureRiskDetailV5");
        }
    ...
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::_meta>() const { return FutureRiskDetailV5::_meta{ m__meta}; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::pkey>() const { return FutureRiskDetailV5::pkey{ m_pkey}; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::period_end_time>() const { return m_period_end_time; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::view_group1>() const { return m_view_group1; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::view_group2>() const { return m_view_group2; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::view_group3>() const { return m_view_group3; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::fut_status>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::FutStatus>( m_fut_status)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::opt_status>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::OptStatus>( m_opt_status)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::risk_class>() const { return m_risk_class; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::theo_model>() const { return m_theo_model; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::theo_model2>() const { return m_theo_model2; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::hedge_delta_rule>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::HedgeDeltaRule>( m_hedge_delta_rule)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::hold_reason>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::HoldReason>( m_hold_reason)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::binary_days>() const { return m_binary_days; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::ctrl_update>() const { return m_ctrl_update; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::symbol_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::SymbolType>( m_symbol_type)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::name>() const { return m_name; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::beta>() const { return m_beta; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::beta_source>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BetaSource>( m_beta_source)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::fut_volume>() const { return m_fut_volume; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::opt_volume>() const { return m_opt_volume; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::margin_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::MarginType>( m_margin_type)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::is_yield_based>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::YesNo>( m_is_yield_based)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::short_term_vol>() const { return m_short_term_vol; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::point_value>() const { return m_point_value; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::point_currency>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::Currency>( m_point_currency)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::underliers_per_cn>() const { return m_underliers_per_cn; }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::underlier_type>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::UnderlierType>( m_underlier_type)); }
    template<> inline const auto FutureRiskDetailV5::get<FutureRiskDetailV5::timestamp>() const { return m_timestamp; }
    template<> inline const auto FutureRiskDetailV5_PKey::get<FutureRiskDetailV5_PKey::fkey>() const { return FutureRiskDetailV5_PKey::fkey{m_fkey}; }
    template<> inline const auto FutureRiskDetailV5_PKey::get<FutureRiskDetailV5_PKey::accnt>() const { return m_accnt; }
    template<> inline const auto FutureRiskDetailV5_PKey::get<FutureRiskDetailV5_PKey::trade_date>() const { return FutureRiskDetailV5_PKey::trade_date{m_trade_date}; }
    template<> inline const auto FutureRiskDetailV5_PKey::get<FutureRiskDetailV5_PKey::client_firm>() const { return m_client_firm; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const FutureRiskDetailV5_PKey& m) {
        o << "\"fkey\":{" << m.get<FutureRiskDetailV5_PKey::fkey>() << "}";
        o << ",\"accnt\":\"" << m.get<FutureRiskDetailV5_PKey::accnt>() << "\"";
        o << ",\"trade_date\":{" << m.get<FutureRiskDetailV5_PKey::trade_date>() << "}";
        o << ",\"client_firm\":\"" << m.get<FutureRiskDetailV5_PKey::client_firm>() << "\"";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const FutureRiskDetailV5& m) {
        o << "\"_meta\":{" << m.get<FutureRiskDetailV5::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<FutureRiskDetailV5::pkey>() << "}";
        {
            std::time_t tt = m.get<FutureRiskDetailV5::period_end_time>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
            o << ",\"period_end_time\":\"" << std::put_time(&tm1, "%a %b %e %T %Y") << "\"";
        }
        o << ",\"view_group1\":\"" << m.get<FutureRiskDetailV5::view_group1>() << "\"";
        o << ",\"view_group2\":\"" << m.get<FutureRiskDetailV5::view_group2>() << "\"";
        o << ",\"view_group3\":\"" << m.get<FutureRiskDetailV5::view_group3>() << "\"";
        o << ",\"fut_status\":" << (int64_t)m.get<FutureRiskDetailV5::fut_status>();
        o << ",\"opt_status\":" << (int64_t)m.get<FutureRiskDetailV5::opt_status>();
        o << ",\"risk_class\":\"" << m.get<FutureRiskDetailV5::risk_class>() << "\"";
        o << ",\"theo_model\":\"" << m.get<FutureRiskDetailV5::theo_model>() << "\"";
        o << ",\"theo_model2\":\"" << m.get<FutureRiskDetailV5::theo_model2>() << "\"";
        o << ",\"hedge_delta_rule\":" << (int64_t)m.get<FutureRiskDetailV5::hedge_delta_rule>();
        o << ",\"hold_reason\":" << (int64_t)m.get<FutureRiskDetailV5::hold_reason>();
        o << ",\"binary_days\":" << m.get<FutureRiskDetailV5::binary_days>();
        {
            std::time_t tt = m.get<FutureRiskDetailV5::ctrl_update>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
            o << ",\"ctrl_update\":\"" << std::put_time(&tm1, "%a %b %e %T %Y") << "\"";
        }
        o << ",\"symbol_type\":" << (int64_t)m.get<FutureRiskDetailV5::symbol_type>();
        o << ",\"name\":\"" << m.get<FutureRiskDetailV5::name>() << "\"";
        o << ",\"beta\":" << m.get<FutureRiskDetailV5::beta>();
        o << ",\"beta_source\":" << (int64_t)m.get<FutureRiskDetailV5::beta_source>();
        o << ",\"fut_volume\":" << m.get<FutureRiskDetailV5::fut_volume>();
        o << ",\"opt_volume\":" << m.get<FutureRiskDetailV5::opt_volume>();
        o << ",\"margin_type\":" << (int64_t)m.get<FutureRiskDetailV5::margin_type>();
        o << ",\"is_yield_based\":" << (int64_t)m.get<FutureRiskDetailV5::is_yield_based>();
        o << ",\"short_term_vol\":" << m.get<FutureRiskDetailV5::short_term_vol>();
        o << ",\"point_value\":" << m.get<FutureRiskDetailV5::point_value>();
        o << ",\"point_currency\":" << (int64_t)m.get<FutureRiskDetailV5::point_currency>();
        o << ",\"underliers_per_cn\":" << m.get<FutureRiskDetailV5::underliers_per_cn>();
        o << ",\"underlier_type\":" << (int64_t)m.get<FutureRiskDetailV5::underlier_type>();
        {
            std::time_t tt = m.get<FutureRiskDetailV5::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
