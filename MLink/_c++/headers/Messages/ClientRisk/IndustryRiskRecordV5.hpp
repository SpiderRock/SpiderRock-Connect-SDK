...
namespace api {
    ...
    #ifndef _st_pnl_mid__float__GUARD__
    #define _st_pnl_mid__float__GUARD__
    DECL_STRONG_TYPE(st_pnl_mid__float, float);
    #endif//_st_pnl_mid__float__GUARD__

    #ifndef _st_pnl_clr__float__GUARD__
    #define _st_pnl_clr__float__GUARD__
    DECL_STRONG_TYPE(st_pnl_clr__float, float);
    #endif//_st_pnl_clr__float__GUARD__
    ...
    #ifndef _code__string__GUARD__
    #define _code__string__GUARD__
    DECL_STRONG_TYPE(code__string, string);
    #endif//_code__string__GUARD__
    ...
    class IndustryRiskRecordV5_PKey {
        public:
        //using statements for all types used in this class
        using accnt = spiderrock::protobuf::api::accnt;
        using currency = spiderrock::protobuf::api::currency;
        using code = spiderrock::protobuf::api::code__string;
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to IndustryRiskRecordV5_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to IndustryRiskRecordV5_PKey::set()"); }  // specializations for valid types are listed below
        ...
        IndustryRiskRecordV5_PKey() {}

        virtual ~IndustryRiskRecordV5_PKey() {
        }
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeCode()) {
                totalSize += SRProtobufCPP::FieldCodec::StringFieldSize(12,m_code);
            }
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludeCode()) {
                dest = SRProtobufCPP::FieldCodec::EncodeString(dest,12,static_cast<string>(m_code));
            }
            if ( IncludeClientFirm()) {
        ...
        const void Decode(const  uint8_t*& pos, const  uint8_t* max) {
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    ...
                    case 12: {m_code = SRProtobufCPP::FieldCodec::DecodeString(pos,max);
                        break;
                    }
    ...
    class IndustryRiskRecordV5 {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::IndustryRiskRecordV5_PKey;
        ...
        using st_pnl_mid = spiderrock::protobuf::api::st_pnl_mid__float;
        using st_pnl_clr = spiderrock::protobuf::api::st_pnl_clr__float;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to IndustryRiskRecordV5::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const IndustryRiskRecordV5 & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        IndustryRiskRecordV5() {
            m__meta.set_message_type("IndustryRiskRecordV5");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeIvolLn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(136,m_ivol_ln);
            }
            if ( IncludeIvolSh()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(139,m_ivol_sh);
            }
            if ( IncludeWtVeDd()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(142,m_wt_ve_dd);
            }
            if ( IncludeWtVeDn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(145,m_wt_ve_dn);
            }
            if ( IncludeWtVeAt()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(148,m_wt_ve_at);
            }
            if ( IncludeWtVeUp()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(151,m_wt_ve_up);
            }
            if ( IncludeWtVeDu()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(154,m_wt_ve_du);
            }
            if ( IncludeWtVeM1()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(157,m_wt_ve_m1);
            }
            if ( IncludeWtVeM2()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(160,m_wt_ve_m2);
            }
            if ( IncludeWtVeM3()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(163,m_wt_ve_m3);
            }
            if ( IncludeWtVeM4()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(166,m_wt_ve_m4);
            }
            if ( IncludeWtVeM5()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(169,m_wt_ve_m5);
            }
            if ( IncludeDdelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(172,m_ddelta);
            }
            if ( IncludeNumSymbols()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(175,m_num_symbols);
            }
            if ( IncludeAbsCurSh()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(178,m_abs_cur_sh);
            }
            if ( IncludeAbsCurCn()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(181,m_abs_cur_cn);
            }
            if ( IncludePremOvPar()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(184,m_prem_ov_par);
            }
            if ( IncludeStPnlMid()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(187,m_st_pnl_mid);
            }
            if ( IncludeStPnlClr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(190,m_st_pnl_clr);
            }
            if ( IncludeOpPnlVol()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(193,m_op_pnl_vol);
            }
            if ( IncludeOpPnlMid()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(196,m_op_pnl_mid);
            }
            if ( IncludeOpPnlClr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(199,m_op_pnl_clr);
            }
            if ( IncludeOpDayVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(202,m_op_day_vega);
            }
            if ( IncludeOpDayWvega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(205,m_op_day_wvega);
            }
            if ( IncludeOpDayTvega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(208,m_op_day_tvega);
            }
            if ( IncludeOpDayWtVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(211,m_op_day_wt_vega);
            }
            if ( IncludeOpDayTheta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(214,m_op_day_theta);
            }
            if ( IncludeOpEdgeOpened()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(217,m_op_edge_opened);
            }
            if ( IncludeOpEdgeClosed()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(220,m_op_edge_closed);
            }
            if ( IncludePnlDn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(223,m_pnl_dn);
            }
            if ( IncludePnlDe()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(226,m_pnl_de);
            }
            if ( IncludePnlSl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(229,m_pnl_sl);
            }
            if ( IncludePnlGa()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(232,m_pnl_ga);
            }
            if ( IncludePnlTh()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(235,m_pnl_th);
            }
            if ( IncludePnlVe()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(238,m_pnl_ve);
            }
            if ( IncludePnlVo()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(241,m_pnl_vo);
            }
            if ( IncludePnlVa()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(244,m_pnl_va);
            }
            if ( IncludePnlDdiv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(247,m_pnl_ddiv);
            }
            if ( IncludePnlSdiv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(250,m_pnl_sdiv);
            }
            if ( IncludePnlRate()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(253,m_pnl_rate);
            }
            if ( IncludePnlErr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(256,m_pnl_err);
            }
            if ( IncludePnlTe()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(259,m_pnl_te);
            }
            if ( IncludePnlLn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(262,m_pnl_ln);
            }
            if ( IncludePnlSh()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(265,m_pnl_sh);
            }
            if ( IncludeTEdge()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(268,m_t_edge);
            }
            if ( IncludeTEdgeMult()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(271,m_t_edge_mult);
            }
            if ( IncludeTEdgePr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(274,m_t_edge_pr);
            }
            if ( IncludeTEdgeMultPr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(277,m_t_edge_mult_pr);
            }
            if ( IncludePosTedgePnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(280,m_pos_tedge_pnl);
            }
            if ( IncludeNegTedgePnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(283,m_neg_tedge_pnl);
            }
            if ( IncludeBadTedgePnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(286,m_bad_tedge_pnl);
            }
            if ( IncludeVaRsu90()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(289,m_va_rsu90);
            }
            if ( IncludeVaRsd90()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(292,m_va_rsd90);
            }
            if ( IncludeVaRsu50()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(295,m_va_rsu50);
            }
            if ( IncludeVaRsd50()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(298,m_va_rsd50);
            }
            if ( IncludeVaRsu15()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(301,m_va_rsu15);
            }
            if ( IncludeVaRsd15()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(304,m_va_rsd15);
            }
            if ( IncludeVaRsu10()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(307,m_va_rsu10);
            }
            if ( IncludeVaRsd10()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(310,m_va_rsd10);
            }
            if ( IncludeVaRsu05()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(313,m_va_rsu05);
            }
            if ( IncludeVaRsd05()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(316,m_va_rsd05);
            }
            if ( IncludeVaRsu1e()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(319,m_va_rsu1e);
            }
            if ( IncludeVaRsd1e()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(322,m_va_rsd1e);
            }
            if ( IncludeVaRsu2e()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(325,m_va_rsu2e);
            }
            if ( IncludeVaRsd2e()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(328,m_va_rsd2e);
            }
            if ( IncludeVaRearn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(331,m_va_rearn);
            }
            if ( IncludeVaRcash()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(334,m_va_rcash);
            }
            if ( IncludeHcCnt()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(337,m_hc_cnt);
            }
            if ( IncludeHaircut25()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(340,m_haircut25);
            }
            if ( IncludeHaircut37()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(343,m_haircut37);
            }
            if ( IncludeLastActivity()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(346, m_last_activity);
            }
            if ( IncludeTimestamp()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(349, m_timestamp);
            }
            return totalSize;
        }
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludeIvolLn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,136,m_ivol_ln);
            }
            if ( IncludeIvolSh()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,139,m_ivol_sh);
            }
            if ( IncludeWtVeDd()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,142,m_wt_ve_dd);
            }
            if ( IncludeWtVeDn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,145,m_wt_ve_dn);
            }
            if ( IncludeWtVeAt()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,148,m_wt_ve_at);
            }
            if ( IncludeWtVeUp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,151,m_wt_ve_up);
            }
            if ( IncludeWtVeDu()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,154,m_wt_ve_du);
            }
            if ( IncludeWtVeM1()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,157,m_wt_ve_m1);
            }
            if ( IncludeWtVeM2()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,160,m_wt_ve_m2);
            }
            if ( IncludeWtVeM3()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,163,m_wt_ve_m3);
            }
            if ( IncludeWtVeM4()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,166,m_wt_ve_m4);
            }
            if ( IncludeWtVeM5()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,169,m_wt_ve_m5);
            }
            if ( IncludeDdelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,172,m_ddelta);
            }
            if ( IncludeNumSymbols()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,175,m_num_symbols);
            }
            if ( IncludeAbsCurSh()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,178,m_abs_cur_sh);
            }
            if ( IncludeAbsCurCn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,181,m_abs_cur_cn);
            }
            if ( IncludePremOvPar()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,184,m_prem_ov_par);
            }
            if ( IncludeStPnlMid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,187,m_st_pnl_mid);
            }
            if ( IncludeStPnlClr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,190,m_st_pnl_clr);
            }
            if ( IncludeOpPnlVol()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,193,m_op_pnl_vol);
            }
            if ( IncludeOpPnlMid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,196,m_op_pnl_mid);
            }
            if ( IncludeOpPnlClr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,199,m_op_pnl_clr);
            }
            if ( IncludeOpDayVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,202,m_op_day_vega);
            }
            if ( IncludeOpDayWvega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,205,m_op_day_wvega);
            }
            if ( IncludeOpDayTvega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,208,m_op_day_tvega);
            }
            if ( IncludeOpDayWtVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,211,m_op_day_wt_vega);
            }
            if ( IncludeOpDayTheta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,214,m_op_day_theta);
            }
            if ( IncludeOpEdgeOpened()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,217,m_op_edge_opened);
            }
            if ( IncludeOpEdgeClosed()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,220,m_op_edge_closed);
            }
            if ( IncludePnlDn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,223,m_pnl_dn);
            }
            if ( IncludePnlDe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,226,m_pnl_de);
            }
            if ( IncludePnlSl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,229,m_pnl_sl);
            }
            if ( IncludePnlGa()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,232,m_pnl_ga);
            }
            if ( IncludePnlTh()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,235,m_pnl_th);
            }
            if ( IncludePnlVe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,238,m_pnl_ve);
            }
            if ( IncludePnlVo()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,241,m_pnl_vo);
            }
            if ( IncludePnlVa()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,244,m_pnl_va);
            }
            if ( IncludePnlDdiv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,247,m_pnl_ddiv);
            }
            if ( IncludePnlSdiv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,250,m_pnl_sdiv);
            }
            if ( IncludePnlRate()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,253,m_pnl_rate);
            }
            if ( IncludePnlErr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,256,m_pnl_err);
            }
            if ( IncludePnlTe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,259,m_pnl_te);
            }
            if ( IncludePnlLn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,262,m_pnl_ln);
            }
            if ( IncludePnlSh()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,265,m_pnl_sh);
            }
            if ( IncludeTEdge()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,268,m_t_edge);
            }
            if ( IncludeTEdgeMult()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,271,m_t_edge_mult);
            }
            if ( IncludeTEdgePr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,274,m_t_edge_pr);
            }
            if ( IncludeTEdgeMultPr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,277,m_t_edge_mult_pr);
            }
            if ( IncludePosTedgePnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,280,m_pos_tedge_pnl);
            }
            if ( IncludeNegTedgePnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,283,m_neg_tedge_pnl);
            }
            if ( IncludeBadTedgePnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,286,m_bad_tedge_pnl);
            }
            if ( IncludeVaRsu90()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,289,m_va_rsu90);
            }
            if ( IncludeVaRsd90()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,292,m_va_rsd90);
            }
            if ( IncludeVaRsu50()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,295,m_va_rsu50);
            }
            if ( IncludeVaRsd50()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,298,m_va_rsd50);
            }
            if ( IncludeVaRsu15()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,301,m_va_rsu15);
            }
            if ( IncludeVaRsd15()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,304,m_va_rsd15);
            }
            if ( IncludeVaRsu10()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,307,m_va_rsu10);
            }
            if ( IncludeVaRsd10()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,310,m_va_rsd10);
            }
            if ( IncludeVaRsu05()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,313,m_va_rsu05);
            }
            if ( IncludeVaRsd05()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,316,m_va_rsd05);
            }
            if ( IncludeVaRsu1e()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,319,m_va_rsu1e);
            }
            if ( IncludeVaRsd1e()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,322,m_va_rsd1e);
            }
            if ( IncludeVaRsu2e()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,325,m_va_rsu2e);
            }
            if ( IncludeVaRsd2e()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,328,m_va_rsd2e);
            }
            if ( IncludeVaRearn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,331,m_va_rearn);
            }
            if ( IncludeVaRcash()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,334,m_va_rcash);
            }
            if ( IncludeHcCnt()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,337,m_hc_cnt);
            }
            if ( IncludeHaircut25()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,340,m_haircut25);
            }
            if ( IncludeHaircut37()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,343,m_haircut37);
            }
            if ( IncludeLastActivity()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 346, m_last_activity);
            }
            if ( IncludeTimestamp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 349, m_timestamp);
            }
        }
        ...
        const void Decode(const uint8_t*& pos, const uint8_t* max) {
            ...
            while (pos < max && (tag = SRProtobufCPP::TagCodec::Decode(pos, max)) != 0) {
                ...
                switch (fieldNumber) {
                    ...
                    case 187: {
                        if (tagType == SRProtobufCPP::FloatCodec::TagType)  {
                            m_st_pnl_mid = SRProtobufCPP::FieldCodec::DecodeFloat(pos,max);
                        }
                        break;
                    }
                    case 190: {
                        if (tagType == SRProtobufCPP::FloatCodec::TagType)  {
                            m_st_pnl_clr = SRProtobufCPP::FieldCodec::DecodeFloat(pos,max);
                        }
                        break;
                    }
                    case 193: {
    ...
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::_meta>() const { return IndustryRiskRecordV5::_meta{ m__meta}; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pkey>() const { return IndustryRiskRecordV5::pkey{ m_pkey}; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::vega_long>() const { return m_vega_long; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::vega_short>() const { return m_vega_short; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::w_vega_long>() const { return m_w_vega_long; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::w_vega_short>() const { return m_w_vega_short; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_vega_long>() const { return m_wt_vega_long; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_vega_short>() const { return m_wt_vega_short; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::theta_long>() const { return m_theta_long; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::theta_short>() const { return m_theta_short; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::rho_long>() const { return m_rho_long; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::rho_short>() const { return m_rho_short; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::ivol_ln>() const { return m_ivol_ln; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::ivol_sh>() const { return m_ivol_sh; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_dd>() const { return m_wt_ve_dd; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_dn>() const { return m_wt_ve_dn; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_at>() const { return m_wt_ve_at; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_up>() const { return m_wt_ve_up; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_du>() const { return m_wt_ve_du; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_m1>() const { return m_wt_ve_m1; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_m2>() const { return m_wt_ve_m2; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_m3>() const { return m_wt_ve_m3; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_m4>() const { return m_wt_ve_m4; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::wt_ve_m5>() const { return m_wt_ve_m5; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::ddelta>() const { return m_ddelta; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::num_symbols>() const { return m_num_symbols; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::abs_cur_sh>() const { return m_abs_cur_sh; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::abs_cur_cn>() const { return m_abs_cur_cn; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::prem_ov_par>() const { return m_prem_ov_par; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::st_pnl_mid>() const { return m_st_pnl_mid; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::st_pnl_clr>() const { return m_st_pnl_clr; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_pnl_vol>() const { return m_op_pnl_vol; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_pnl_mid>() const { return m_op_pnl_mid; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_pnl_clr>() const { return m_op_pnl_clr; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_day_vega>() const { return m_op_day_vega; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_day_wvega>() const { return m_op_day_wvega; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_day_tvega>() const { return m_op_day_tvega; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_day_wt_vega>() const { return m_op_day_wt_vega; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_day_theta>() const { return m_op_day_theta; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_edge_opened>() const { return m_op_edge_opened; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::op_edge_closed>() const { return m_op_edge_closed; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_dn>() const { return m_pnl_dn; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_de>() const { return m_pnl_de; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_sl>() const { return m_pnl_sl; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_ga>() const { return m_pnl_ga; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_th>() const { return m_pnl_th; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_ve>() const { return m_pnl_ve; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_vo>() const { return m_pnl_vo; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_va>() const { return m_pnl_va; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_ddiv>() const { return m_pnl_ddiv; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_sdiv>() const { return m_pnl_sdiv; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_rate>() const { return m_pnl_rate; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_err>() const { return m_pnl_err; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_te>() const { return m_pnl_te; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_ln>() const { return m_pnl_ln; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pnl_sh>() const { return m_pnl_sh; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::t_edge>() const { return m_t_edge; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::t_edge_mult>() const { return m_t_edge_mult; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::t_edge_pr>() const { return m_t_edge_pr; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::t_edge_mult_pr>() const { return m_t_edge_mult_pr; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::pos_tedge_pnl>() const { return m_pos_tedge_pnl; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::neg_tedge_pnl>() const { return m_neg_tedge_pnl; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::bad_tedge_pnl>() const { return m_bad_tedge_pnl; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsu90>() const { return m_va_rsu90; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsd90>() const { return m_va_rsd90; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsu50>() const { return m_va_rsu50; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsd50>() const { return m_va_rsd50; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsu15>() const { return m_va_rsu15; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsd15>() const { return m_va_rsd15; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsu10>() const { return m_va_rsu10; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsd10>() const { return m_va_rsd10; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsu05>() const { return m_va_rsu05; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsd05>() const { return m_va_rsd05; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsu1e>() const { return m_va_rsu1e; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsd1e>() const { return m_va_rsd1e; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsu2e>() const { return m_va_rsu2e; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rsd2e>() const { return m_va_rsd2e; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rearn>() const { return m_va_rearn; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::va_rcash>() const { return m_va_rcash; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::hc_cnt>() const { return m_hc_cnt; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::haircut25>() const { return m_haircut25; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::haircut37>() const { return m_haircut37; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::last_activity>() const { return m_last_activity; }
    template<> inline const auto IndustryRiskRecordV5::get<IndustryRiskRecordV5::timestamp>() const { return m_timestamp; }
    template<> inline const auto IndustryRiskRecordV5_PKey::get<IndustryRiskRecordV5_PKey::accnt>() const { return m_accnt; }
    template<> inline const auto IndustryRiskRecordV5_PKey::get<IndustryRiskRecordV5_PKey::currency>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::Currency>(m_currency));}
    template<> inline const auto IndustryRiskRecordV5_PKey::get<IndustryRiskRecordV5_PKey::code>() const { return m_code; }
    template<> inline const auto IndustryRiskRecordV5_PKey::get<IndustryRiskRecordV5_PKey::client_firm>() const { return m_client_firm; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const IndustryRiskRecordV5_PKey& m) {
        o << "\"accnt\":\"" << m.get<IndustryRiskRecordV5_PKey::accnt>() << "\"";
        o << ",\"currency\":" << (int64_t)m.get<IndustryRiskRecordV5_PKey::currency>();
        o << ",\"code\":\"" << m.get<IndustryRiskRecordV5_PKey::code>() << "\"";
        o << ",\"client_firm\":\"" << m.get<IndustryRiskRecordV5_PKey::client_firm>() << "\"";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const IndustryRiskRecordV5& m) {
        o << "\"_meta\":{" << m.get<IndustryRiskRecordV5::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<IndustryRiskRecordV5::pkey>() << "}";
        o << ",\"vega_long\":" << m.get<IndustryRiskRecordV5::vega_long>();
        o << ",\"vega_short\":" << m.get<IndustryRiskRecordV5::vega_short>();
        o << ",\"w_vega_long\":" << m.get<IndustryRiskRecordV5::w_vega_long>();
        o << ",\"w_vega_short\":" << m.get<IndustryRiskRecordV5::w_vega_short>();
        o << ",\"wt_vega_long\":" << m.get<IndustryRiskRecordV5::wt_vega_long>();
        o << ",\"wt_vega_short\":" << m.get<IndustryRiskRecordV5::wt_vega_short>();
        o << ",\"theta_long\":" << m.get<IndustryRiskRecordV5::theta_long>();
        o << ",\"theta_short\":" << m.get<IndustryRiskRecordV5::theta_short>();
        o << ",\"rho_long\":" << m.get<IndustryRiskRecordV5::rho_long>();
        o << ",\"rho_short\":" << m.get<IndustryRiskRecordV5::rho_short>();
        o << ",\"ivol_ln\":" << m.get<IndustryRiskRecordV5::ivol_ln>();
        o << ",\"ivol_sh\":" << m.get<IndustryRiskRecordV5::ivol_sh>();
        o << ",\"wt_ve_dd\":" << m.get<IndustryRiskRecordV5::wt_ve_dd>();
        o << ",\"wt_ve_dn\":" << m.get<IndustryRiskRecordV5::wt_ve_dn>();
        o << ",\"wt_ve_at\":" << m.get<IndustryRiskRecordV5::wt_ve_at>();
        o << ",\"wt_ve_up\":" << m.get<IndustryRiskRecordV5::wt_ve_up>();
        o << ",\"wt_ve_du\":" << m.get<IndustryRiskRecordV5::wt_ve_du>();
        o << ",\"wt_ve_m1\":" << m.get<IndustryRiskRecordV5::wt_ve_m1>();
        o << ",\"wt_ve_m2\":" << m.get<IndustryRiskRecordV5::wt_ve_m2>();
        o << ",\"wt_ve_m3\":" << m.get<IndustryRiskRecordV5::wt_ve_m3>();
        o << ",\"wt_ve_m4\":" << m.get<IndustryRiskRecordV5::wt_ve_m4>();
        o << ",\"wt_ve_m5\":" << m.get<IndustryRiskRecordV5::wt_ve_m5>();
        o << ",\"ddelta\":" << m.get<IndustryRiskRecordV5::ddelta>();
        o << ",\"num_symbols\":" << m.get<IndustryRiskRecordV5::num_symbols>();
        o << ",\"abs_cur_sh\":" << m.get<IndustryRiskRecordV5::abs_cur_sh>();
        o << ",\"abs_cur_cn\":" << m.get<IndustryRiskRecordV5::abs_cur_cn>();
        o << ",\"prem_ov_par\":" << m.get<IndustryRiskRecordV5::prem_ov_par>();
        o << ",\"st_pnl_mid\":" << m.get<IndustryRiskRecordV5::st_pnl_mid>();
        o << ",\"st_pnl_clr\":" << m.get<IndustryRiskRecordV5::st_pnl_clr>();
        o << ",\"op_pnl_vol\":" << m.get<IndustryRiskRecordV5::op_pnl_vol>();
        o << ",\"op_pnl_mid\":" << m.get<IndustryRiskRecordV5::op_pnl_mid>();
        o << ",\"op_pnl_clr\":" << m.get<IndustryRiskRecordV5::op_pnl_clr>();
        o << ",\"op_day_vega\":" << m.get<IndustryRiskRecordV5::op_day_vega>();
        o << ",\"op_day_wvega\":" << m.get<IndustryRiskRecordV5::op_day_wvega>();
        o << ",\"op_day_tvega\":" << m.get<IndustryRiskRecordV5::op_day_tvega>();
        o << ",\"op_day_wt_vega\":" << m.get<IndustryRiskRecordV5::op_day_wt_vega>();
        o << ",\"op_day_theta\":" << m.get<IndustryRiskRecordV5::op_day_theta>();
        o << ",\"op_edge_opened\":" << m.get<IndustryRiskRecordV5::op_edge_opened>();
        o << ",\"op_edge_closed\":" << m.get<IndustryRiskRecordV5::op_edge_closed>();
        o << ",\"pnl_dn\":" << m.get<IndustryRiskRecordV5::pnl_dn>();
        o << ",\"pnl_de\":" << m.get<IndustryRiskRecordV5::pnl_de>();
        o << ",\"pnl_sl\":" << m.get<IndustryRiskRecordV5::pnl_sl>();
        o << ",\"pnl_ga\":" << m.get<IndustryRiskRecordV5::pnl_ga>();
        o << ",\"pnl_th\":" << m.get<IndustryRiskRecordV5::pnl_th>();
        o << ",\"pnl_ve\":" << m.get<IndustryRiskRecordV5::pnl_ve>();
        o << ",\"pnl_vo\":" << m.get<IndustryRiskRecordV5::pnl_vo>();
        o << ",\"pnl_va\":" << m.get<IndustryRiskRecordV5::pnl_va>();
        o << ",\"pnl_ddiv\":" << m.get<IndustryRiskRecordV5::pnl_ddiv>();
        o << ",\"pnl_sdiv\":" << m.get<IndustryRiskRecordV5::pnl_sdiv>();
        o << ",\"pnl_rate\":" << m.get<IndustryRiskRecordV5::pnl_rate>();
        o << ",\"pnl_err\":" << m.get<IndustryRiskRecordV5::pnl_err>();
        o << ",\"pnl_te\":" << m.get<IndustryRiskRecordV5::pnl_te>();
        o << ",\"pnl_ln\":" << m.get<IndustryRiskRecordV5::pnl_ln>();
        o << ",\"pnl_sh\":" << m.get<IndustryRiskRecordV5::pnl_sh>();
        o << ",\"t_edge\":" << m.get<IndustryRiskRecordV5::t_edge>();
        o << ",\"t_edge_mult\":" << m.get<IndustryRiskRecordV5::t_edge_mult>();
        o << ",\"t_edge_pr\":" << m.get<IndustryRiskRecordV5::t_edge_pr>();
        o << ",\"t_edge_mult_pr\":" << m.get<IndustryRiskRecordV5::t_edge_mult_pr>();
        o << ",\"pos_tedge_pnl\":" << m.get<IndustryRiskRecordV5::pos_tedge_pnl>();
        o << ",\"neg_tedge_pnl\":" << m.get<IndustryRiskRecordV5::neg_tedge_pnl>();
        o << ",\"bad_tedge_pnl\":" << m.get<IndustryRiskRecordV5::bad_tedge_pnl>();
        o << ",\"va_rsu90\":" << m.get<IndustryRiskRecordV5::va_rsu90>();
        o << ",\"va_rsd90\":" << m.get<IndustryRiskRecordV5::va_rsd90>();
        o << ",\"va_rsu50\":" << m.get<IndustryRiskRecordV5::va_rsu50>();
        o << ",\"va_rsd50\":" << m.get<IndustryRiskRecordV5::va_rsd50>();
        o << ",\"va_rsu15\":" << m.get<IndustryRiskRecordV5::va_rsu15>();
        o << ",\"va_rsd15\":" << m.get<IndustryRiskRecordV5::va_rsd15>();
        o << ",\"va_rsu10\":" << m.get<IndustryRiskRecordV5::va_rsu10>();
        o << ",\"va_rsd10\":" << m.get<IndustryRiskRecordV5::va_rsd10>();
        o << ",\"va_rsu05\":" << m.get<IndustryRiskRecordV5::va_rsu05>();
        o << ",\"va_rsd05\":" << m.get<IndustryRiskRecordV5::va_rsd05>();
        o << ",\"va_rsu1e\":" << m.get<IndustryRiskRecordV5::va_rsu1e>();
        o << ",\"va_rsd1e\":" << m.get<IndustryRiskRecordV5::va_rsd1e>();
        o << ",\"va_rsu2e\":" << m.get<IndustryRiskRecordV5::va_rsu2e>();
        o << ",\"va_rsd2e\":" << m.get<IndustryRiskRecordV5::va_rsd2e>();
        o << ",\"va_rearn\":" << m.get<IndustryRiskRecordV5::va_rearn>();
        o << ",\"va_rcash\":" << m.get<IndustryRiskRecordV5::va_rcash>();
        o << ",\"hc_cnt\":" << m.get<IndustryRiskRecordV5::hc_cnt>();
        o << ",\"haircut25\":" << m.get<IndustryRiskRecordV5::haircut25>();
        o << ",\"haircut37\":" << m.get<IndustryRiskRecordV5::haircut37>();
        {
            std::time_t tt = m.get<IndustryRiskRecordV5::last_activity>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
            o << ",\"last_activity\":\"" << std::put_time(&tm1, "%a %b %e %T %Y") << "\"";
        }
        {
            std::time_t tt = m.get<IndustryRiskRecordV5::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
