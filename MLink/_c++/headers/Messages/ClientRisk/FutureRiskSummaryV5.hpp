...
namespace api {
    ...
    class FutureRiskSummaryV5_PKey {
        public:
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureRiskSummaryV5_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureRiskSummaryV5_PKey::set()"); }  // specializations for valid types are listed below
        ...
        FutureRiskSummaryV5_PKey() {}

        virtual ~FutureRiskSummaryV5_PKey() {
        }
    ...
    class FutureRiskSummaryV5 {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::FutureRiskSummaryV5_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FutureRiskSummaryV5::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const FutureRiskSummaryV5 & value) {
            set(value.m__meta);
            set(value.m_pkey);
            set(value.m_ticker);
            set(value.m_u_prc);
        ...
        FutureRiskSummaryV5() {
            m__meta.set_message_type("FutureRiskSummaryV5");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludeUPrc()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(109,m_u_prc);
            }
            if ( IncludeUMark()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(112,m_u_mark);
            }
            if ( IncludeUOpnMark()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(115,m_u_opn_mark);
            }
            if ( IncludeBeta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(118,m_beta);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(121,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BetaSource>(m_beta_source)));
            if ( IncludeLnDdelta()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(124,m_ln_ddelta);
            }
            if ( IncludeShDdelta()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(127,m_sh_ddelta);
            }
            if ( IncludeFutMktValueMid()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(130,m_fut_mkt_value_mid);
            }
            if ( IncludeOptMktValueMid()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(133,m_opt_mkt_value_mid);
            }
            if ( IncludeOptMktValueVol()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(136,m_opt_mkt_value_vol);
            }
            if ( IncludeFcAbsCurPos()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(139,m_fc_abs_cur_pos);
            }
            if ( IncludeFcAbsOpnClr()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(142,m_fc_abs_opn_clr);
            }
            if ( IncludeFcAbsOpnPrv()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(145,m_fc_abs_opn_prv);
            }
            if ( IncludeFcAbsOpnPos()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(148,m_fc_abs_opn_pos);
            }
            if ( IncludeFcAbsOpnBrk()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(151,m_fc_abs_opn_brk);
            }
            if ( IncludeFcNetCurPos()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(154,m_fc_net_cur_pos);
            }
            if ( IncludeFcBot()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(157,m_fc_bot);
            }
            if ( IncludeFcSld()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(160,m_fc_sld);
            }
            if ( IncludeFcBotHdg()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(163,m_fc_bot_hdg);
            }
            if ( IncludeFcSldHdg()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(166,m_fc_sld_hdg);
            }
            if ( IncludeFcBotTrh()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(169,m_fc_bot_trh);
            }
            if ( IncludeFcSldTrh()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(172,m_fc_sld_trh);
            }
            if ( IncludeFcBotOpn()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(175,m_fc_bot_opn);
            }
            if ( IncludeFcSldOpn()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(178,m_fc_sld_opn);
            }
            if ( IncludeFcBotTrd()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(181,m_fc_bot_trd);
            }
            if ( IncludeFcSldTrd()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(184,m_fc_sld_trd);
            }
            if ( IncludeFcMnyBot()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(187,m_fc_mny_bot);
            }
            if ( IncludeFcMnySld()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(190,m_fc_mny_sld);
            }
            if ( IncludeMaxFutDttm()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(193, m_max_fut_dttm);
            }
            if ( IncludeFcPnlMid()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(196,m_fc_pnl_mid);
            }
            if ( IncludeFcPnlClr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(199,m_fc_pnl_clr);
            }
            if ( IncludeFcPnlDay()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(202,m_fc_pnl_day);
            }
            if ( IncludeOpCnAbsCurPos()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(205,m_op_cn_abs_cur_pos);
            }
            if ( IncludeOpCnAbsOpnClr()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(208,m_op_cn_abs_opn_clr);
            }
            if ( IncludeOpCnAbsOpnPrv()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(211,m_op_cn_abs_opn_prv);
            }
            if ( IncludeOpCnAbsOpnPos()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(214,m_op_cn_abs_opn_pos);
            }
            if ( IncludeOpCnAbsOpnBrk()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(217,m_op_cn_abs_opn_brk);
            }
            if ( IncludeOpCnPosCall()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(220,m_op_cn_pos_call);
            }
            if ( IncludeOpCnPosPut()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(223,m_op_cn_pos_put);
            }
            if ( IncludeOpCnAbsPair()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(226,m_op_cn_abs_pair);
            }
            if ( IncludeOpCnAbsAtmEquiv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(229,m_op_cn_abs_atm_equiv);
            }
            if ( IncludeOpCnBot()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(232,m_op_cn_bot);
            }
            if ( IncludeOpCnSld()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(235,m_op_cn_sld);
            }
            if ( IncludeOpMnyBot()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(238,m_op_mny_bot);
            }
            if ( IncludeOpMnySld()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(241,m_op_mny_sld);
            }
            if ( IncludeOpPremBot()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(244,m_op_prem_bot);
            }
            if ( IncludeOpPremSld()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(247,m_op_prem_sld);
            }
            if ( IncludeMaxOptDttm()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(250, m_max_opt_dttm);
            }
            if ( IncludeOpPnlVol()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(253,m_op_pnl_vol);
            }
            if ( IncludeOpPnlMid()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(256,m_op_pnl_mid);
            }
            if ( IncludeOpPnlClr()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(259,m_op_pnl_clr);
            }
            if ( IncludeOpPnlBrk()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(262,m_op_pnl_brk);
            }
            if ( IncludeOpPnlDay()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(265,m_op_pnl_day);
            }
            if ( IncludeOpDnPnlDay()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(268,m_op_dn_pnl_day);
            }
            if ( IncludeOpDayVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(271,m_op_day_vega);
            }
            if ( IncludeOpDayWvega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(274,m_op_day_wvega);
            }
            if ( IncludeOpDayTvega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(277,m_op_day_tvega);
            }
            if ( IncludeOpDayWtVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(280,m_op_day_wt_vega);
            }
            if ( IncludeOpDayTheta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(283,m_op_day_theta);
            }
            if ( IncludeOpDayDelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(286,m_op_day_delta);
            }
            if ( IncludeOpTrdDelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(289,m_op_trd_delta);
            }
            if ( IncludeOpnDelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(292,m_opn_delta);
            }
            if ( IncludeOpnDdelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(620,m_opn_ddelta);
            }
            if ( IncludeContHedgePnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(295,m_cont_hedge_pnl);
            }
            if ( IncludeContHedgePnl1()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(298,m_cont_hedge_pnl1);
            }
            if ( IncludeOpEdgeOpened()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(301,m_op_edge_opened);
            }
            if ( IncludeOpEdgeClosed()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(304,m_op_edge_closed);
            }
            if ( IncludePnlDn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(307,m_pnl_dn);
            }
            if ( IncludePnlDe()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(310,m_pnl_de);
            }
            if ( IncludePnlSl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(313,m_pnl_sl);
            }
            if ( IncludePnlGa()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(316,m_pnl_ga);
            }
            if ( IncludePnlTh()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(319,m_pnl_th);
            }
            if ( IncludePnlVe()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(322,m_pnl_ve);
            }
            if ( IncludePnlVo()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(325,m_pnl_vo);
            }
            if ( IncludePnlVa()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(328,m_pnl_va);
            }
            if ( IncludePnlErr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(331,m_pnl_err);
            }
            if ( IncludePnlRate()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(334,m_pnl_rate);
            }
            if ( IncludePnlSdiv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(337,m_pnl_sdiv);
            }
            if ( IncludePnlDdiv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(340,m_pnl_ddiv);
            }
            if ( IncludePnlTe()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(343,m_pnl_te);
            }
            if ( IncludePctIvChange()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(346,m_pct_iv_change);
            }
            if ( IncludePctIvVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(349,m_pct_iv_vega);
            }
            if ( IncludePctTvChange()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(352,m_pct_tv_change);
            }
            if ( IncludePctTvVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(355,m_pct_tv_vega);
            }
            if ( IncludeFutWidthMny()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(358,m_fut_width_mny);
            }
            if ( IncludeOptWidthMny()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(361,m_opt_width_mny);
            }
            if ( IncludeDayDdelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(364,m_day_ddelta);
            }
            if ( IncludeDelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(367,m_delta);
            }
            if ( IncludeDdelta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(370,m_ddelta);
            }
            if ( IncludeDeDecay()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(373,m_de_decay);
            }
            if ( IncludeDdDecay()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(376,m_dd_decay);
            }
            if ( IncludeGamma()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(379,m_gamma);
            }
            if ( IncludeDGamma()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(382,m_d_gamma);
            }
            if ( IncludeTheta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(385,m_theta);
            }
            if ( IncludeRho()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(388,m_rho);
            }
            if ( IncludeVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(391,m_vega);
            }
            if ( IncludeTVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(394,m_t_vega);
            }
            if ( IncludeWVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(397,m_w_vega);
            }
            if ( IncludeWtVega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(400,m_wt_vega);
            }
            if ( IncludeIvolVe()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(403,m_ivol_ve);
            }
            if ( IncludeVolga()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(406,m_volga);
            }
            if ( IncludeVanna()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(409,m_vanna);
            }
            if ( IncludeSlope()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(412,m_slope);
            }
            if ( IncludeAvega()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(415,m_avega);
            }
            if ( IncludeAtheta()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(418,m_atheta);
            }
            if ( IncludeHedgeGamma()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(421,m_hedge_gamma);
            }
            if ( IncludeHedgeDgamma()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(424,m_hedge_dgamma);
            }
            if ( IncludePremOvPar()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(427,m_prem_ov_par);
            }
            if ( IncludeWtVeDd()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(430,m_wt_ve_dd);
            }
            if ( IncludeWtVeDn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(433,m_wt_ve_dn);
            }
            if ( IncludeWtVeAt()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(436,m_wt_ve_at);
            }
            if ( IncludeWtVeUp()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(439,m_wt_ve_up);
            }
            if ( IncludeWtVeDu()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(442,m_wt_ve_du);
            }
            if ( IncludeWtVeM1()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(445,m_wt_ve_m1);
            }
            if ( IncludeWtVeM2()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(448,m_wt_ve_m2);
            }
            if ( IncludeWtVeM3()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(451,m_wt_ve_m3);
            }
            if ( IncludeWtVeM4()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(454,m_wt_ve_m4);
            }
            if ( IncludeWtVeM5()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(457,m_wt_ve_m5);
            }
            if ( IncludePinXx()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(460,m_pin_xx);
            }
            if ( IncludeOpnDeBelow()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(463,m_opn_de_below);
            }
            if ( IncludeOpnDeAbove()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(466,m_opn_de_above);
            }
            if ( IncludeOpnDdeBelow()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(469,m_opn_dde_below);
            }
            if ( IncludeOpnDdeAbove()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(472,m_opn_dde_above);
            }
            if ( IncludePosDeBelow()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(475,m_pos_de_below);
            }
            if ( IncludePosDeAbove()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(478,m_pos_de_above);
            }
            if ( IncludePosDdeBelow()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(481,m_pos_dde_below);
            }
            if ( IncludePosDdeAbove()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(484,m_pos_dde_above);
            }
            if ( IncludePosHedgeDeltaEx()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(487,m_pos_hedge_delta_ex);
            }
            if ( IncludePosHedgeDdeltaEx()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(490,m_pos_hedge_ddelta_ex);
            }
            if ( IncludeTEdge()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(493,m_t_edge);
            }
            if ( IncludeTEdgeMult()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(496,m_t_edge_mult);
            }
            if ( IncludeTEdgePr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(499,m_t_edge_pr);
            }
            if ( IncludeTEdgeMultPr()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(502,m_t_edge_mult_pr);
            }
            if ( IncludeNumTvolErrors()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(505,m_num_tvol_errors);
            }
            if ( IncludePairPnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(508,m_pair_pnl);
            }
            if ( IncludePosTedgeWv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(511,m_pos_tedge_wv);
            }
            if ( IncludeNegTedgeWv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(514,m_neg_tedge_wv);
            }
            if ( IncludeBadTedgeWv()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(517,m_bad_tedge_wv);
            }
            if ( IncludePosTedgePnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(520,m_pos_tedge_pnl);
            }
            if ( IncludeNegTedgePnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(523,m_neg_tedge_pnl);
            }
            if ( IncludeBadTedgePnl()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(526,m_bad_tedge_pnl);
            }
            if ( IncludeSpan01()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(529,m_span01);
            }
            if ( IncludeSpan02()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(532,m_span02);
            }
            if ( IncludeSpan03()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(535,m_span03);
            }
            if ( IncludeSpan04()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(538,m_span04);
            }
            if ( IncludeSpan05()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(541,m_span05);
            }
            if ( IncludeSpan06()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(544,m_span06);
            }
            if ( IncludeSpan07()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(547,m_span07);
            }
            if ( IncludeSpan08()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(550,m_span08);
            }
            if ( IncludeSpan09()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(553,m_span09);
            }
            if ( IncludeSpan10()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(556,m_span10);
            }
            if ( IncludeSpan11()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(559,m_span11);
            }
            if ( IncludeSpan12()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(562,m_span12);
            }
            if ( IncludeSpan13()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(565,m_span13);
            }
            if ( IncludeSpan14()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(568,m_span14);
            }
            if ( IncludeSpan15()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(571,m_span15);
            }
            if ( IncludeSpan16()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(574,m_span16);
            }
            if ( IncludeFutLiqRisk()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(577,m_fut_liq_risk);
            }
            if ( IncludeOptLiqRisk()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(580,m_opt_liq_risk);
            }
            if ( IncludeFcBotC0()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(583,m_fc_bot_c0);
            }
            if ( IncludeFcSldC0()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(586,m_fc_sld_c0);
            }
            if ( IncludeFcMnyC0()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(589,m_fc_mny_c0);
            }
            if ( IncludeFcBotC1()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(592,m_fc_bot_c1);
            }
            if ( IncludeFcSldC1()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(595,m_fc_sld_c1);
            }
            if ( IncludeFcMnyC1()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(598,m_fc_mny_c1);
            }
            if ( IncludeFutMargin()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(601,m_fut_margin);
            }
            if ( IncludeMarginUdnVdn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(621,m_margin_udn_vdn);
            }
            if ( IncludeMarginUdnVup()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(622,m_margin_udn_vup);
            }
            if ( IncludeMarginUupVdn()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(623,m_margin_uup_vdn);
            }
            if ( IncludeMarginUupVup()) {
                totalSize += SRProtobufCPP::FieldCodec::FloatFieldSize(624,m_margin_uup_vup);
            }
            if ( IncludeNumFutErrors()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(604,m_num_fut_errors);
            }
            if ( IncludeNumOptErrors()) {
                totalSize += SRProtobufCPP::FieldCodec::IntFieldSize(607,m_num_opt_errors);
            }
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(610,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::R5Source>(m_update_source)));
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(613,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::MktErrFlag>(m_fut_mark_flag)));
            totalSize += SRProtobufCPP::FieldCodec::EnumFieldSize(616,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::MktErrFlag>(m_opt_mark_flag)));
            if ( IncludeTimestamp()) {
                totalSize += SRProtobufCPP::FieldCodec::DateTimeFieldSize(619, m_timestamp);
            }
            return totalSize;
        }
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludeUPrc()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,109,m_u_prc);
            }
            if ( IncludeUMark()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,112,m_u_mark);
            }
            if ( IncludeUOpnMark()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,115,m_u_opn_mark);
            }
            if ( IncludeBeta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,118,m_beta);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,121,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BetaSource>(m_beta_source)));
            if ( IncludeLnDdelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,124,m_ln_ddelta);
            }
            if ( IncludeShDdelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,127,m_sh_ddelta);
            }
            if ( IncludeFutMktValueMid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,130,m_fut_mkt_value_mid);
            }
            if ( IncludeOptMktValueMid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,133,m_opt_mkt_value_mid);
            }
            if ( IncludeOptMktValueVol()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,136,m_opt_mkt_value_vol);
            }
            if ( IncludeFcAbsCurPos()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,139,m_fc_abs_cur_pos);
            }
            if ( IncludeFcAbsOpnClr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,142,m_fc_abs_opn_clr);
            }
            if ( IncludeFcAbsOpnPrv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,145,m_fc_abs_opn_prv);
            }
            if ( IncludeFcAbsOpnPos()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,148,m_fc_abs_opn_pos);
            }
            if ( IncludeFcAbsOpnBrk()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,151,m_fc_abs_opn_brk);
            }
            if ( IncludeFcNetCurPos()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,154,m_fc_net_cur_pos);
            }
            if ( IncludeFcBot()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,157,m_fc_bot);
            }
            if ( IncludeFcSld()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,160,m_fc_sld);
            }
            if ( IncludeFcBotHdg()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,163,m_fc_bot_hdg);
            }
            if ( IncludeFcSldHdg()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,166,m_fc_sld_hdg);
            }
            if ( IncludeFcBotTrh()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,169,m_fc_bot_trh);
            }
            if ( IncludeFcSldTrh()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,172,m_fc_sld_trh);
            }
            if ( IncludeFcBotOpn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,175,m_fc_bot_opn);
            }
            if ( IncludeFcSldOpn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,178,m_fc_sld_opn);
            }
            if ( IncludeFcBotTrd()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,181,m_fc_bot_trd);
            }
            if ( IncludeFcSldTrd()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,184,m_fc_sld_trd);
            }
            if ( IncludeFcMnyBot()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,187,m_fc_mny_bot);
            }
            if ( IncludeFcMnySld()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,190,m_fc_mny_sld);
            }
            if ( IncludeMaxFutDttm()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 193, m_max_fut_dttm);
            }
            if ( IncludeFcPnlMid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,196,m_fc_pnl_mid);
            }
            if ( IncludeFcPnlClr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,199,m_fc_pnl_clr);
            }
            if ( IncludeFcPnlDay()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,202,m_fc_pnl_day);
            }
            if ( IncludeOpCnAbsCurPos()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,205,m_op_cn_abs_cur_pos);
            }
            if ( IncludeOpCnAbsOpnClr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,208,m_op_cn_abs_opn_clr);
            }
            if ( IncludeOpCnAbsOpnPrv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,211,m_op_cn_abs_opn_prv);
            }
            if ( IncludeOpCnAbsOpnPos()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,214,m_op_cn_abs_opn_pos);
            }
            if ( IncludeOpCnAbsOpnBrk()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,217,m_op_cn_abs_opn_brk);
            }
            if ( IncludeOpCnPosCall()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,220,m_op_cn_pos_call);
            }
            if ( IncludeOpCnPosPut()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,223,m_op_cn_pos_put);
            }
            if ( IncludeOpCnAbsPair()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,226,m_op_cn_abs_pair);
            }
            if ( IncludeOpCnAbsAtmEquiv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,229,m_op_cn_abs_atm_equiv);
            }
            if ( IncludeOpCnBot()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,232,m_op_cn_bot);
            }
            if ( IncludeOpCnSld()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,235,m_op_cn_sld);
            }
            if ( IncludeOpMnyBot()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,238,m_op_mny_bot);
            }
            if ( IncludeOpMnySld()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,241,m_op_mny_sld);
            }
            if ( IncludeOpPremBot()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,244,m_op_prem_bot);
            }
            if ( IncludeOpPremSld()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,247,m_op_prem_sld);
            }
            if ( IncludeMaxOptDttm()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 250, m_max_opt_dttm);
            }
            if ( IncludeOpPnlVol()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,253,m_op_pnl_vol);
            }
            if ( IncludeOpPnlMid()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,256,m_op_pnl_mid);
            }
            if ( IncludeOpPnlClr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,259,m_op_pnl_clr);
            }
            if ( IncludeOpPnlBrk()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,262,m_op_pnl_brk);
            }
            if ( IncludeOpPnlDay()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,265,m_op_pnl_day);
            }
            if ( IncludeOpDnPnlDay()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,268,m_op_dn_pnl_day);
            }
            if ( IncludeOpDayVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,271,m_op_day_vega);
            }
            if ( IncludeOpDayWvega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,274,m_op_day_wvega);
            }
            if ( IncludeOpDayTvega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,277,m_op_day_tvega);
            }
            if ( IncludeOpDayWtVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,280,m_op_day_wt_vega);
            }
            if ( IncludeOpDayTheta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,283,m_op_day_theta);
            }
            if ( IncludeOpDayDelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,286,m_op_day_delta);
            }
            if ( IncludeOpTrdDelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,289,m_op_trd_delta);
            }
            if ( IncludeOpnDelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,292,m_opn_delta);
            }
            if ( IncludeOpnDdelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,620,m_opn_ddelta);
            }
            if ( IncludeContHedgePnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,295,m_cont_hedge_pnl);
            }
            if ( IncludeContHedgePnl1()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,298,m_cont_hedge_pnl1);
            }
            if ( IncludeOpEdgeOpened()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,301,m_op_edge_opened);
            }
            if ( IncludeOpEdgeClosed()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,304,m_op_edge_closed);
            }
            if ( IncludePnlDn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,307,m_pnl_dn);
            }
            if ( IncludePnlDe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,310,m_pnl_de);
            }
            if ( IncludePnlSl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,313,m_pnl_sl);
            }
            if ( IncludePnlGa()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,316,m_pnl_ga);
            }
            if ( IncludePnlTh()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,319,m_pnl_th);
            }
            if ( IncludePnlVe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,322,m_pnl_ve);
            }
            if ( IncludePnlVo()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,325,m_pnl_vo);
            }
            if ( IncludePnlVa()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,328,m_pnl_va);
            }
            if ( IncludePnlErr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,331,m_pnl_err);
            }
            if ( IncludePnlRate()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,334,m_pnl_rate);
            }
            if ( IncludePnlSdiv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,337,m_pnl_sdiv);
            }
            if ( IncludePnlDdiv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,340,m_pnl_ddiv);
            }
            if ( IncludePnlTe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,343,m_pnl_te);
            }
            if ( IncludePctIvChange()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,346,m_pct_iv_change);
            }
            if ( IncludePctIvVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,349,m_pct_iv_vega);
            }
            if ( IncludePctTvChange()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,352,m_pct_tv_change);
            }
            if ( IncludePctTvVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,355,m_pct_tv_vega);
            }
            if ( IncludeFutWidthMny()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,358,m_fut_width_mny);
            }
            if ( IncludeOptWidthMny()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,361,m_opt_width_mny);
            }
            if ( IncludeDayDdelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,364,m_day_ddelta);
            }
            if ( IncludeDelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,367,m_delta);
            }
            if ( IncludeDdelta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,370,m_ddelta);
            }
            if ( IncludeDeDecay()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,373,m_de_decay);
            }
            if ( IncludeDdDecay()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,376,m_dd_decay);
            }
            if ( IncludeGamma()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,379,m_gamma);
            }
            if ( IncludeDGamma()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,382,m_d_gamma);
            }
            if ( IncludeTheta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,385,m_theta);
            }
            if ( IncludeRho()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,388,m_rho);
            }
            if ( IncludeVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,391,m_vega);
            }
            if ( IncludeTVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,394,m_t_vega);
            }
            if ( IncludeWVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,397,m_w_vega);
            }
            if ( IncludeWtVega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,400,m_wt_vega);
            }
            if ( IncludeIvolVe()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,403,m_ivol_ve);
            }
            if ( IncludeVolga()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,406,m_volga);
            }
            if ( IncludeVanna()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,409,m_vanna);
            }
            if ( IncludeSlope()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,412,m_slope);
            }
            if ( IncludeAvega()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,415,m_avega);
            }
            if ( IncludeAtheta()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,418,m_atheta);
            }
            if ( IncludeHedgeGamma()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,421,m_hedge_gamma);
            }
            if ( IncludeHedgeDgamma()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,424,m_hedge_dgamma);
            }
            if ( IncludePremOvPar()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,427,m_prem_ov_par);
            }
            if ( IncludeWtVeDd()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,430,m_wt_ve_dd);
            }
            if ( IncludeWtVeDn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,433,m_wt_ve_dn);
            }
            if ( IncludeWtVeAt()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,436,m_wt_ve_at);
            }
            if ( IncludeWtVeUp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,439,m_wt_ve_up);
            }
            if ( IncludeWtVeDu()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,442,m_wt_ve_du);
            }
            if ( IncludeWtVeM1()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,445,m_wt_ve_m1);
            }
            if ( IncludeWtVeM2()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,448,m_wt_ve_m2);
            }
            if ( IncludeWtVeM3()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,451,m_wt_ve_m3);
            }
            if ( IncludeWtVeM4()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,454,m_wt_ve_m4);
            }
            if ( IncludeWtVeM5()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,457,m_wt_ve_m5);
            }
            if ( IncludePinXx()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,460,m_pin_xx);
            }
            if ( IncludeOpnDeBelow()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,463,m_opn_de_below);
            }
            if ( IncludeOpnDeAbove()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,466,m_opn_de_above);
            }
            if ( IncludeOpnDdeBelow()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,469,m_opn_dde_below);
            }
            if ( IncludeOpnDdeAbove()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,472,m_opn_dde_above);
            }
            if ( IncludePosDeBelow()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,475,m_pos_de_below);
            }
            if ( IncludePosDeAbove()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,478,m_pos_de_above);
            }
            if ( IncludePosDdeBelow()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,481,m_pos_dde_below);
            }
            if ( IncludePosDdeAbove()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,484,m_pos_dde_above);
            }
            if ( IncludePosHedgeDeltaEx()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,487,m_pos_hedge_delta_ex);
            }
            if ( IncludePosHedgeDdeltaEx()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,490,m_pos_hedge_ddelta_ex);
            }
            if ( IncludeTEdge()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,493,m_t_edge);
            }
            if ( IncludeTEdgeMult()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,496,m_t_edge_mult);
            }
            if ( IncludeTEdgePr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,499,m_t_edge_pr);
            }
            if ( IncludeTEdgeMultPr()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,502,m_t_edge_mult_pr);
            }
            if ( IncludeNumTvolErrors()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,505,m_num_tvol_errors);
            }
            if ( IncludePairPnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,508,m_pair_pnl);
            }
            if ( IncludePosTedgeWv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,511,m_pos_tedge_wv);
            }
            if ( IncludeNegTedgeWv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,514,m_neg_tedge_wv);
            }
            if ( IncludeBadTedgeWv()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,517,m_bad_tedge_wv);
            }
            if ( IncludePosTedgePnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,520,m_pos_tedge_pnl);
            }
            if ( IncludeNegTedgePnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,523,m_neg_tedge_pnl);
            }
            if ( IncludeBadTedgePnl()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,526,m_bad_tedge_pnl);
            }
            if ( IncludeSpan01()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,529,m_span01);
            }
            if ( IncludeSpan02()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,532,m_span02);
            }
            if ( IncludeSpan03()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,535,m_span03);
            }
            if ( IncludeSpan04()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,538,m_span04);
            }
            if ( IncludeSpan05()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,541,m_span05);
            }
            if ( IncludeSpan06()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,544,m_span06);
            }
            if ( IncludeSpan07()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,547,m_span07);
            }
            if ( IncludeSpan08()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,550,m_span08);
            }
            if ( IncludeSpan09()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,553,m_span09);
            }
            if ( IncludeSpan10()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,556,m_span10);
            }
            if ( IncludeSpan11()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,559,m_span11);
            }
            if ( IncludeSpan12()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,562,m_span12);
            }
            if ( IncludeSpan13()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,565,m_span13);
            }
            if ( IncludeSpan14()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,568,m_span14);
            }
            if ( IncludeSpan15()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,571,m_span15);
            }
            if ( IncludeSpan16()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,574,m_span16);
            }
            if ( IncludeFutLiqRisk()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,577,m_fut_liq_risk);
            }
            if ( IncludeOptLiqRisk()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,580,m_opt_liq_risk);
            }
            if ( IncludeFcBotC0()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,583,m_fc_bot_c0);
            }
            if ( IncludeFcSldC0()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,586,m_fc_sld_c0);
            }
            if ( IncludeFcMnyC0()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,589,m_fc_mny_c0);
            }
            if ( IncludeFcBotC1()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,592,m_fc_bot_c1);
            }
            if ( IncludeFcSldC1()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,595,m_fc_sld_c1);
            }
            if ( IncludeFcMnyC1()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,598,m_fc_mny_c1);
            }
            if ( IncludeFutMargin()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,601,m_fut_margin);
            }
            if ( IncludeMarginUdnVdn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,621,m_margin_udn_vdn);
            }
            if ( IncludeMarginUdnVup()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,622,m_margin_udn_vup);
            }
            if ( IncludeMarginUupVdn()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,623,m_margin_uup_vdn);
            }
            if ( IncludeMarginUupVup()) {
                dest = SRProtobufCPP::FieldCodec::EncodeFloat(dest,624,m_margin_uup_vup);
            }
            if ( IncludeNumFutErrors()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,604,m_num_fut_errors);
            }
            if ( IncludeNumOptErrors()) {
                dest = SRProtobufCPP::FieldCodec::EncodeInt(dest,607,m_num_opt_errors);
            }
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,610,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::R5Source>(m_update_source)));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,613,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::MktErrFlag>(m_fut_mark_flag)));
            dest = SRProtobufCPP::FieldCodec::EncodeEnum(dest,616,static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::MktErrFlag>(m_opt_mark_flag)));
            if ( IncludeTimestamp()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDateTime(dest, 619, m_timestamp);
            }
        }
    ...
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::_meta>() const { return FutureRiskSummaryV5::_meta{ m__meta}; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pkey>() const { return FutureRiskSummaryV5::pkey{ m_pkey}; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::ticker>() const { return FutureRiskSummaryV5::ticker{ m_ticker}; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::u_prc>() const { return m_u_prc; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::u_mark>() const { return m_u_mark; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::u_opn_mark>() const { return m_u_opn_mark; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::beta>() const { return m_beta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::beta_source>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BetaSource>( m_beta_source)); }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::ln_ddelta>() const { return m_ln_ddelta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::sh_ddelta>() const { return m_sh_ddelta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fut_mkt_value_mid>() const { return m_fut_mkt_value_mid; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opt_mkt_value_mid>() const { return m_opt_mkt_value_mid; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opt_mkt_value_vol>() const { return m_opt_mkt_value_vol; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_abs_cur_pos>() const { return m_fc_abs_cur_pos; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_abs_opn_clr>() const { return m_fc_abs_opn_clr; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_abs_opn_prv>() const { return m_fc_abs_opn_prv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_abs_opn_pos>() const { return m_fc_abs_opn_pos; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_abs_opn_brk>() const { return m_fc_abs_opn_brk; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_net_cur_pos>() const { return m_fc_net_cur_pos; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_bot>() const { return m_fc_bot; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_sld>() const { return m_fc_sld; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_bot_hdg>() const { return m_fc_bot_hdg; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_sld_hdg>() const { return m_fc_sld_hdg; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_bot_trh>() const { return m_fc_bot_trh; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_sld_trh>() const { return m_fc_sld_trh; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_bot_opn>() const { return m_fc_bot_opn; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_sld_opn>() const { return m_fc_sld_opn; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_bot_trd>() const { return m_fc_bot_trd; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_sld_trd>() const { return m_fc_sld_trd; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_mny_bot>() const { return m_fc_mny_bot; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_mny_sld>() const { return m_fc_mny_sld; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::max_fut_dttm>() const { return m_max_fut_dttm; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_pnl_mid>() const { return m_fc_pnl_mid; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_pnl_clr>() const { return m_fc_pnl_clr; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_pnl_day>() const { return m_fc_pnl_day; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_abs_cur_pos>() const { return m_op_cn_abs_cur_pos; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_abs_opn_clr>() const { return m_op_cn_abs_opn_clr; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_abs_opn_prv>() const { return m_op_cn_abs_opn_prv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_abs_opn_pos>() const { return m_op_cn_abs_opn_pos; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_abs_opn_brk>() const { return m_op_cn_abs_opn_brk; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_pos_call>() const { return m_op_cn_pos_call; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_pos_put>() const { return m_op_cn_pos_put; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_abs_pair>() const { return m_op_cn_abs_pair; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_abs_atm_equiv>() const { return m_op_cn_abs_atm_equiv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_bot>() const { return m_op_cn_bot; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_cn_sld>() const { return m_op_cn_sld; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_mny_bot>() const { return m_op_mny_bot; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_mny_sld>() const { return m_op_mny_sld; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_prem_bot>() const { return m_op_prem_bot; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_prem_sld>() const { return m_op_prem_sld; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::max_opt_dttm>() const { return m_max_opt_dttm; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_pnl_vol>() const { return m_op_pnl_vol; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_pnl_mid>() const { return m_op_pnl_mid; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_pnl_clr>() const { return m_op_pnl_clr; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_pnl_brk>() const { return m_op_pnl_brk; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_pnl_day>() const { return m_op_pnl_day; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_dn_pnl_day>() const { return m_op_dn_pnl_day; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_day_vega>() const { return m_op_day_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_day_wvega>() const { return m_op_day_wvega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_day_tvega>() const { return m_op_day_tvega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_day_wt_vega>() const { return m_op_day_wt_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_day_theta>() const { return m_op_day_theta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_day_delta>() const { return m_op_day_delta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_trd_delta>() const { return m_op_trd_delta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opn_delta>() const { return m_opn_delta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opn_ddelta>() const { return m_opn_ddelta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::cont_hedge_pnl>() const { return m_cont_hedge_pnl; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::cont_hedge_pnl1>() const { return m_cont_hedge_pnl1; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_edge_opened>() const { return m_op_edge_opened; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::op_edge_closed>() const { return m_op_edge_closed; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_dn>() const { return m_pnl_dn; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_de>() const { return m_pnl_de; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_sl>() const { return m_pnl_sl; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_ga>() const { return m_pnl_ga; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_th>() const { return m_pnl_th; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_ve>() const { return m_pnl_ve; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_vo>() const { return m_pnl_vo; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_va>() const { return m_pnl_va; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_err>() const { return m_pnl_err; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_rate>() const { return m_pnl_rate; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_sdiv>() const { return m_pnl_sdiv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_ddiv>() const { return m_pnl_ddiv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pnl_te>() const { return m_pnl_te; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pct_iv_change>() const { return m_pct_iv_change; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pct_iv_vega>() const { return m_pct_iv_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pct_tv_change>() const { return m_pct_tv_change; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pct_tv_vega>() const { return m_pct_tv_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fut_width_mny>() const { return m_fut_width_mny; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opt_width_mny>() const { return m_opt_width_mny; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::day_ddelta>() const { return m_day_ddelta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::delta>() const { return m_delta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::ddelta>() const { return m_ddelta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::de_decay>() const { return m_de_decay; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::dd_decay>() const { return m_dd_decay; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::gamma>() const { return m_gamma; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::d_gamma>() const { return m_d_gamma; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::theta>() const { return m_theta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::rho>() const { return m_rho; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::vega>() const { return m_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::t_vega>() const { return m_t_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::w_vega>() const { return m_w_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_vega>() const { return m_wt_vega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::ivol_ve>() const { return m_ivol_ve; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::volga>() const { return m_volga; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::vanna>() const { return m_vanna; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::slope>() const { return m_slope; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::avega>() const { return m_avega; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::atheta>() const { return m_atheta; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::hedge_gamma>() const { return m_hedge_gamma; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::hedge_dgamma>() const { return m_hedge_dgamma; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::prem_ov_par>() const { return m_prem_ov_par; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_dd>() const { return m_wt_ve_dd; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_dn>() const { return m_wt_ve_dn; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_at>() const { return m_wt_ve_at; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_up>() const { return m_wt_ve_up; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_du>() const { return m_wt_ve_du; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_m1>() const { return m_wt_ve_m1; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_m2>() const { return m_wt_ve_m2; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_m3>() const { return m_wt_ve_m3; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_m4>() const { return m_wt_ve_m4; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::wt_ve_m5>() const { return m_wt_ve_m5; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pin_xx>() const { return m_pin_xx; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opn_de_below>() const { return m_opn_de_below; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opn_de_above>() const { return m_opn_de_above; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opn_dde_below>() const { return m_opn_dde_below; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opn_dde_above>() const { return m_opn_dde_above; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_de_below>() const { return m_pos_de_below; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_de_above>() const { return m_pos_de_above; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_dde_below>() const { return m_pos_dde_below; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_dde_above>() const { return m_pos_dde_above; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_hedge_delta_ex>() const { return m_pos_hedge_delta_ex; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_hedge_ddelta_ex>() const { return m_pos_hedge_ddelta_ex; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::t_edge>() const { return m_t_edge; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::t_edge_mult>() const { return m_t_edge_mult; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::t_edge_pr>() const { return m_t_edge_pr; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::t_edge_mult_pr>() const { return m_t_edge_mult_pr; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::num_tvol_errors>() const { return m_num_tvol_errors; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pair_pnl>() const { return m_pair_pnl; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_tedge_wv>() const { return m_pos_tedge_wv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::neg_tedge_wv>() const { return m_neg_tedge_wv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::bad_tedge_wv>() const { return m_bad_tedge_wv; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::pos_tedge_pnl>() const { return m_pos_tedge_pnl; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::neg_tedge_pnl>() const { return m_neg_tedge_pnl; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::bad_tedge_pnl>() const { return m_bad_tedge_pnl; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span01>() const { return m_span01; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span02>() const { return m_span02; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span03>() const { return m_span03; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span04>() const { return m_span04; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span05>() const { return m_span05; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span06>() const { return m_span06; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span07>() const { return m_span07; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span08>() const { return m_span08; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span09>() const { return m_span09; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span10>() const { return m_span10; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span11>() const { return m_span11; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span12>() const { return m_span12; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span13>() const { return m_span13; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span14>() const { return m_span14; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span15>() const { return m_span15; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::span16>() const { return m_span16; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fut_liq_risk>() const { return m_fut_liq_risk; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opt_liq_risk>() const { return m_opt_liq_risk; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_bot_c0>() const { return m_fc_bot_c0; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_sld_c0>() const { return m_fc_sld_c0; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_mny_c0>() const { return m_fc_mny_c0; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_bot_c1>() const { return m_fc_bot_c1; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_sld_c1>() const { return m_fc_sld_c1; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fc_mny_c1>() const { return m_fc_mny_c1; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fut_margin>() const { return m_fut_margin; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::margin_udn_vdn>() const { return m_margin_udn_vdn; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::margin_udn_vup>() const { return m_margin_udn_vup; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::margin_uup_vdn>() const { return m_margin_uup_vdn; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::margin_uup_vup>() const { return m_margin_uup_vup; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::num_fut_errors>() const { return m_num_fut_errors; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::num_opt_errors>() const { return m_num_opt_errors; }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::update_source>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::R5Source>( m_update_source)); }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::fut_mark_flag>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::MktErrFlag>( m_fut_mark_flag)); }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::opt_mark_flag>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::MktErrFlag>( m_opt_mark_flag)); }
    template<> inline const auto FutureRiskSummaryV5::get<FutureRiskSummaryV5::timestamp>() const { return m_timestamp; }
    template<> inline const auto FutureRiskSummaryV5_PKey::get<FutureRiskSummaryV5_PKey::fkey>() const { return FutureRiskSummaryV5_PKey::fkey{m_fkey}; }
    template<> inline const auto FutureRiskSummaryV5_PKey::get<FutureRiskSummaryV5_PKey::accnt>() const { return m_accnt; }
    template<> inline const auto FutureRiskSummaryV5_PKey::get<FutureRiskSummaryV5_PKey::trade_date>() const { return FutureRiskSummaryV5_PKey::trade_date{m_trade_date}; }
    template<> inline const auto FutureRiskSummaryV5_PKey::get<FutureRiskSummaryV5_PKey::risk_session>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::RiskSession>(m_risk_session));}
    template<> inline const auto FutureRiskSummaryV5_PKey::get<FutureRiskSummaryV5_PKey::client_firm>() const { return m_client_firm; }
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const FutureRiskSummaryV5_PKey& m) {
        o << "\"fkey\":{" << m.get<FutureRiskSummaryV5_PKey::fkey>() << "}";
        o << ",\"accnt\":\"" << m.get<FutureRiskSummaryV5_PKey::accnt>() << "\"";
        o << ",\"trade_date\":{" << m.get<FutureRiskSummaryV5_PKey::trade_date>() << "}";
        o << ",\"risk_session\":" << (int64_t)m.get<FutureRiskSummaryV5_PKey::risk_session>();
        o << ",\"client_firm\":\"" << m.get<FutureRiskSummaryV5_PKey::client_firm>() << "\"";
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const FutureRiskSummaryV5& m) {
        o << "\"_meta\":{" << m.get<FutureRiskSummaryV5::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<FutureRiskSummaryV5::pkey>() << "}";
        o << ",\"ticker\":{" << m.get<FutureRiskSummaryV5::ticker>() << "}";
        o << ",\"u_prc\":" << m.get<FutureRiskSummaryV5::u_prc>();
        o << ",\"u_mark\":" << m.get<FutureRiskSummaryV5::u_mark>();
        o << ",\"u_opn_mark\":" << m.get<FutureRiskSummaryV5::u_opn_mark>();
        o << ",\"beta\":" << m.get<FutureRiskSummaryV5::beta>();
        o << ",\"beta_source\":" << (int64_t)m.get<FutureRiskSummaryV5::beta_source>();
        o << ",\"ln_ddelta\":" << m.get<FutureRiskSummaryV5::ln_ddelta>();
        o << ",\"sh_ddelta\":" << m.get<FutureRiskSummaryV5::sh_ddelta>();
        o << ",\"fut_mkt_value_mid\":" << m.get<FutureRiskSummaryV5::fut_mkt_value_mid>();
        o << ",\"opt_mkt_value_mid\":" << m.get<FutureRiskSummaryV5::opt_mkt_value_mid>();
        o << ",\"opt_mkt_value_vol\":" << m.get<FutureRiskSummaryV5::opt_mkt_value_vol>();
        o << ",\"fc_abs_cur_pos\":" << m.get<FutureRiskSummaryV5::fc_abs_cur_pos>();
        o << ",\"fc_abs_opn_clr\":" << m.get<FutureRiskSummaryV5::fc_abs_opn_clr>();
        o << ",\"fc_abs_opn_prv\":" << m.get<FutureRiskSummaryV5::fc_abs_opn_prv>();
        o << ",\"fc_abs_opn_pos\":" << m.get<FutureRiskSummaryV5::fc_abs_opn_pos>();
        o << ",\"fc_abs_opn_brk\":" << m.get<FutureRiskSummaryV5::fc_abs_opn_brk>();
        o << ",\"fc_net_cur_pos\":" << m.get<FutureRiskSummaryV5::fc_net_cur_pos>();
        o << ",\"fc_bot\":" << m.get<FutureRiskSummaryV5::fc_bot>();
        o << ",\"fc_sld\":" << m.get<FutureRiskSummaryV5::fc_sld>();
        o << ",\"fc_bot_hdg\":" << m.get<FutureRiskSummaryV5::fc_bot_hdg>();
        o << ",\"fc_sld_hdg\":" << m.get<FutureRiskSummaryV5::fc_sld_hdg>();
        o << ",\"fc_bot_trh\":" << m.get<FutureRiskSummaryV5::fc_bot_trh>();
        o << ",\"fc_sld_trh\":" << m.get<FutureRiskSummaryV5::fc_sld_trh>();
        o << ",\"fc_bot_opn\":" << m.get<FutureRiskSummaryV5::fc_bot_opn>();
        o << ",\"fc_sld_opn\":" << m.get<FutureRiskSummaryV5::fc_sld_opn>();
        o << ",\"fc_bot_trd\":" << m.get<FutureRiskSummaryV5::fc_bot_trd>();
        o << ",\"fc_sld_trd\":" << m.get<FutureRiskSummaryV5::fc_sld_trd>();
        o << ",\"fc_mny_bot\":" << m.get<FutureRiskSummaryV5::fc_mny_bot>();
        o << ",\"fc_mny_sld\":" << m.get<FutureRiskSummaryV5::fc_mny_sld>();
        {
            std::time_t tt = m.get<FutureRiskSummaryV5::max_fut_dttm>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
            o << ",\"max_fut_dttm\":\"" << std::put_time(&tm1, "%a %b %e %T %Y") << "\"";
        }
        o << ",\"fc_pnl_mid\":" << m.get<FutureRiskSummaryV5::fc_pnl_mid>();
        o << ",\"fc_pnl_clr\":" << m.get<FutureRiskSummaryV5::fc_pnl_clr>();
        o << ",\"fc_pnl_day\":" << m.get<FutureRiskSummaryV5::fc_pnl_day>();
        o << ",\"op_cn_abs_cur_pos\":" << m.get<FutureRiskSummaryV5::op_cn_abs_cur_pos>();
        o << ",\"op_cn_abs_opn_clr\":" << m.get<FutureRiskSummaryV5::op_cn_abs_opn_clr>();
        o << ",\"op_cn_abs_opn_prv\":" << m.get<FutureRiskSummaryV5::op_cn_abs_opn_prv>();
        o << ",\"op_cn_abs_opn_pos\":" << m.get<FutureRiskSummaryV5::op_cn_abs_opn_pos>();
        o << ",\"op_cn_abs_opn_brk\":" << m.get<FutureRiskSummaryV5::op_cn_abs_opn_brk>();
        o << ",\"op_cn_pos_call\":" << m.get<FutureRiskSummaryV5::op_cn_pos_call>();
        o << ",\"op_cn_pos_put\":" << m.get<FutureRiskSummaryV5::op_cn_pos_put>();
        o << ",\"op_cn_abs_pair\":" << m.get<FutureRiskSummaryV5::op_cn_abs_pair>();
        o << ",\"op_cn_abs_atm_equiv\":" << m.get<FutureRiskSummaryV5::op_cn_abs_atm_equiv>();
        o << ",\"op_cn_bot\":" << m.get<FutureRiskSummaryV5::op_cn_bot>();
        o << ",\"op_cn_sld\":" << m.get<FutureRiskSummaryV5::op_cn_sld>();
        o << ",\"op_mny_bot\":" << m.get<FutureRiskSummaryV5::op_mny_bot>();
        o << ",\"op_mny_sld\":" << m.get<FutureRiskSummaryV5::op_mny_sld>();
        o << ",\"op_prem_bot\":" << m.get<FutureRiskSummaryV5::op_prem_bot>();
        o << ",\"op_prem_sld\":" << m.get<FutureRiskSummaryV5::op_prem_sld>();
        {
            std::time_t tt = m.get<FutureRiskSummaryV5::max_opt_dttm>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
            o << ",\"max_opt_dttm\":\"" << std::put_time(&tm1, "%a %b %e %T %Y") << "\"";
        }
        o << ",\"op_pnl_vol\":" << m.get<FutureRiskSummaryV5::op_pnl_vol>();
        o << ",\"op_pnl_mid\":" << m.get<FutureRiskSummaryV5::op_pnl_mid>();
        o << ",\"op_pnl_clr\":" << m.get<FutureRiskSummaryV5::op_pnl_clr>();
        o << ",\"op_pnl_brk\":" << m.get<FutureRiskSummaryV5::op_pnl_brk>();
        o << ",\"op_pnl_day\":" << m.get<FutureRiskSummaryV5::op_pnl_day>();
        o << ",\"op_dn_pnl_day\":" << m.get<FutureRiskSummaryV5::op_dn_pnl_day>();
        o << ",\"op_day_vega\":" << m.get<FutureRiskSummaryV5::op_day_vega>();
        o << ",\"op_day_wvega\":" << m.get<FutureRiskSummaryV5::op_day_wvega>();
        o << ",\"op_day_tvega\":" << m.get<FutureRiskSummaryV5::op_day_tvega>();
        o << ",\"op_day_wt_vega\":" << m.get<FutureRiskSummaryV5::op_day_wt_vega>();
        o << ",\"op_day_theta\":" << m.get<FutureRiskSummaryV5::op_day_theta>();
        o << ",\"op_day_delta\":" << m.get<FutureRiskSummaryV5::op_day_delta>();
        o << ",\"op_trd_delta\":" << m.get<FutureRiskSummaryV5::op_trd_delta>();
        o << ",\"opn_delta\":" << m.get<FutureRiskSummaryV5::opn_delta>();
        o << ",\"opn_ddelta\":" << m.get<FutureRiskSummaryV5::opn_ddelta>();
        o << ",\"cont_hedge_pnl\":" << m.get<FutureRiskSummaryV5::cont_hedge_pnl>();
        o << ",\"cont_hedge_pnl1\":" << m.get<FutureRiskSummaryV5::cont_hedge_pnl1>();
        o << ",\"op_edge_opened\":" << m.get<FutureRiskSummaryV5::op_edge_opened>();
        o << ",\"op_edge_closed\":" << m.get<FutureRiskSummaryV5::op_edge_closed>();
        o << ",\"pnl_dn\":" << m.get<FutureRiskSummaryV5::pnl_dn>();
        o << ",\"pnl_de\":" << m.get<FutureRiskSummaryV5::pnl_de>();
        o << ",\"pnl_sl\":" << m.get<FutureRiskSummaryV5::pnl_sl>();
        o << ",\"pnl_ga\":" << m.get<FutureRiskSummaryV5::pnl_ga>();
        o << ",\"pnl_th\":" << m.get<FutureRiskSummaryV5::pnl_th>();
        o << ",\"pnl_ve\":" << m.get<FutureRiskSummaryV5::pnl_ve>();
        o << ",\"pnl_vo\":" << m.get<FutureRiskSummaryV5::pnl_vo>();
        o << ",\"pnl_va\":" << m.get<FutureRiskSummaryV5::pnl_va>();
        o << ",\"pnl_err\":" << m.get<FutureRiskSummaryV5::pnl_err>();
        o << ",\"pnl_rate\":" << m.get<FutureRiskSummaryV5::pnl_rate>();
        o << ",\"pnl_sdiv\":" << m.get<FutureRiskSummaryV5::pnl_sdiv>();
        o << ",\"pnl_ddiv\":" << m.get<FutureRiskSummaryV5::pnl_ddiv>();
        o << ",\"pnl_te\":" << m.get<FutureRiskSummaryV5::pnl_te>();
        o << ",\"pct_iv_change\":" << m.get<FutureRiskSummaryV5::pct_iv_change>();
        o << ",\"pct_iv_vega\":" << m.get<FutureRiskSummaryV5::pct_iv_vega>();
        o << ",\"pct_tv_change\":" << m.get<FutureRiskSummaryV5::pct_tv_change>();
        o << ",\"pct_tv_vega\":" << m.get<FutureRiskSummaryV5::pct_tv_vega>();
        o << ",\"fut_width_mny\":" << m.get<FutureRiskSummaryV5::fut_width_mny>();
        o << ",\"opt_width_mny\":" << m.get<FutureRiskSummaryV5::opt_width_mny>();
        o << ",\"day_ddelta\":" << m.get<FutureRiskSummaryV5::day_ddelta>();
        o << ",\"delta\":" << m.get<FutureRiskSummaryV5::delta>();
        o << ",\"ddelta\":" << m.get<FutureRiskSummaryV5::ddelta>();
        o << ",\"de_decay\":" << m.get<FutureRiskSummaryV5::de_decay>();
        o << ",\"dd_decay\":" << m.get<FutureRiskSummaryV5::dd_decay>();
        o << ",\"gamma\":" << m.get<FutureRiskSummaryV5::gamma>();
        o << ",\"d_gamma\":" << m.get<FutureRiskSummaryV5::d_gamma>();
        o << ",\"theta\":" << m.get<FutureRiskSummaryV5::theta>();
        o << ",\"rho\":" << m.get<FutureRiskSummaryV5::rho>();
        o << ",\"vega\":" << m.get<FutureRiskSummaryV5::vega>();
        o << ",\"t_vega\":" << m.get<FutureRiskSummaryV5::t_vega>();
        o << ",\"w_vega\":" << m.get<FutureRiskSummaryV5::w_vega>();
        o << ",\"wt_vega\":" << m.get<FutureRiskSummaryV5::wt_vega>();
        o << ",\"ivol_ve\":" << m.get<FutureRiskSummaryV5::ivol_ve>();
        o << ",\"volga\":" << m.get<FutureRiskSummaryV5::volga>();
        o << ",\"vanna\":" << m.get<FutureRiskSummaryV5::vanna>();
        o << ",\"slope\":" << m.get<FutureRiskSummaryV5::slope>();
        o << ",\"avega\":" << m.get<FutureRiskSummaryV5::avega>();
        o << ",\"atheta\":" << m.get<FutureRiskSummaryV5::atheta>();
        o << ",\"hedge_gamma\":" << m.get<FutureRiskSummaryV5::hedge_gamma>();
        o << ",\"hedge_dgamma\":" << m.get<FutureRiskSummaryV5::hedge_dgamma>();
        o << ",\"prem_ov_par\":" << m.get<FutureRiskSummaryV5::prem_ov_par>();
        o << ",\"wt_ve_dd\":" << m.get<FutureRiskSummaryV5::wt_ve_dd>();
        o << ",\"wt_ve_dn\":" << m.get<FutureRiskSummaryV5::wt_ve_dn>();
        o << ",\"wt_ve_at\":" << m.get<FutureRiskSummaryV5::wt_ve_at>();
        o << ",\"wt_ve_up\":" << m.get<FutureRiskSummaryV5::wt_ve_up>();
        o << ",\"wt_ve_du\":" << m.get<FutureRiskSummaryV5::wt_ve_du>();
        o << ",\"wt_ve_m1\":" << m.get<FutureRiskSummaryV5::wt_ve_m1>();
        o << ",\"wt_ve_m2\":" << m.get<FutureRiskSummaryV5::wt_ve_m2>();
        o << ",\"wt_ve_m3\":" << m.get<FutureRiskSummaryV5::wt_ve_m3>();
        o << ",\"wt_ve_m4\":" << m.get<FutureRiskSummaryV5::wt_ve_m4>();
        o << ",\"wt_ve_m5\":" << m.get<FutureRiskSummaryV5::wt_ve_m5>();
        o << ",\"pin_xx\":" << m.get<FutureRiskSummaryV5::pin_xx>();
        o << ",\"opn_de_below\":" << m.get<FutureRiskSummaryV5::opn_de_below>();
        o << ",\"opn_de_above\":" << m.get<FutureRiskSummaryV5::opn_de_above>();
        o << ",\"opn_dde_below\":" << m.get<FutureRiskSummaryV5::opn_dde_below>();
        o << ",\"opn_dde_above\":" << m.get<FutureRiskSummaryV5::opn_dde_above>();
        o << ",\"pos_de_below\":" << m.get<FutureRiskSummaryV5::pos_de_below>();
        o << ",\"pos_de_above\":" << m.get<FutureRiskSummaryV5::pos_de_above>();
        o << ",\"pos_dde_below\":" << m.get<FutureRiskSummaryV5::pos_dde_below>();
        o << ",\"pos_dde_above\":" << m.get<FutureRiskSummaryV5::pos_dde_above>();
        o << ",\"pos_hedge_delta_ex\":" << m.get<FutureRiskSummaryV5::pos_hedge_delta_ex>();
        o << ",\"pos_hedge_ddelta_ex\":" << m.get<FutureRiskSummaryV5::pos_hedge_ddelta_ex>();
        o << ",\"t_edge\":" << m.get<FutureRiskSummaryV5::t_edge>();
        o << ",\"t_edge_mult\":" << m.get<FutureRiskSummaryV5::t_edge_mult>();
        o << ",\"t_edge_pr\":" << m.get<FutureRiskSummaryV5::t_edge_pr>();
        o << ",\"t_edge_mult_pr\":" << m.get<FutureRiskSummaryV5::t_edge_mult_pr>();
        o << ",\"num_tvol_errors\":" << m.get<FutureRiskSummaryV5::num_tvol_errors>();
        o << ",\"pair_pnl\":" << m.get<FutureRiskSummaryV5::pair_pnl>();
        o << ",\"pos_tedge_wv\":" << m.get<FutureRiskSummaryV5::pos_tedge_wv>();
        o << ",\"neg_tedge_wv\":" << m.get<FutureRiskSummaryV5::neg_tedge_wv>();
        o << ",\"bad_tedge_wv\":" << m.get<FutureRiskSummaryV5::bad_tedge_wv>();
        o << ",\"pos_tedge_pnl\":" << m.get<FutureRiskSummaryV5::pos_tedge_pnl>();
        o << ",\"neg_tedge_pnl\":" << m.get<FutureRiskSummaryV5::neg_tedge_pnl>();
        o << ",\"bad_tedge_pnl\":" << m.get<FutureRiskSummaryV5::bad_tedge_pnl>();
        o << ",\"span01\":" << m.get<FutureRiskSummaryV5::span01>();
        o << ",\"span02\":" << m.get<FutureRiskSummaryV5::span02>();
        o << ",\"span03\":" << m.get<FutureRiskSummaryV5::span03>();
        o << ",\"span04\":" << m.get<FutureRiskSummaryV5::span04>();
        o << ",\"span05\":" << m.get<FutureRiskSummaryV5::span05>();
        o << ",\"span06\":" << m.get<FutureRiskSummaryV5::span06>();
        o << ",\"span07\":" << m.get<FutureRiskSummaryV5::span07>();
        o << ",\"span08\":" << m.get<FutureRiskSummaryV5::span08>();
        o << ",\"span09\":" << m.get<FutureRiskSummaryV5::span09>();
        o << ",\"span10\":" << m.get<FutureRiskSummaryV5::span10>();
        o << ",\"span11\":" << m.get<FutureRiskSummaryV5::span11>();
        o << ",\"span12\":" << m.get<FutureRiskSummaryV5::span12>();
        o << ",\"span13\":" << m.get<FutureRiskSummaryV5::span13>();
        o << ",\"span14\":" << m.get<FutureRiskSummaryV5::span14>();
        o << ",\"span15\":" << m.get<FutureRiskSummaryV5::span15>();
        o << ",\"span16\":" << m.get<FutureRiskSummaryV5::span16>();
        o << ",\"fut_liq_risk\":" << m.get<FutureRiskSummaryV5::fut_liq_risk>();
        o << ",\"opt_liq_risk\":" << m.get<FutureRiskSummaryV5::opt_liq_risk>();
        o << ",\"fc_bot_c0\":" << m.get<FutureRiskSummaryV5::fc_bot_c0>();
        o << ",\"fc_sld_c0\":" << m.get<FutureRiskSummaryV5::fc_sld_c0>();
        o << ",\"fc_mny_c0\":" << m.get<FutureRiskSummaryV5::fc_mny_c0>();
        o << ",\"fc_bot_c1\":" << m.get<FutureRiskSummaryV5::fc_bot_c1>();
        o << ",\"fc_sld_c1\":" << m.get<FutureRiskSummaryV5::fc_sld_c1>();
        o << ",\"fc_mny_c1\":" << m.get<FutureRiskSummaryV5::fc_mny_c1>();
        o << ",\"fut_margin\":" << m.get<FutureRiskSummaryV5::fut_margin>();
        o << ",\"margin_udn_vdn\":" << m.get<FutureRiskSummaryV5::margin_udn_vdn>();
        o << ",\"margin_udn_vup\":" << m.get<FutureRiskSummaryV5::margin_udn_vup>();
        o << ",\"margin_uup_vdn\":" << m.get<FutureRiskSummaryV5::margin_uup_vdn>();
        o << ",\"margin_uup_vup\":" << m.get<FutureRiskSummaryV5::margin_uup_vup>();
        o << ",\"num_fut_errors\":" << m.get<FutureRiskSummaryV5::num_fut_errors>();
        o << ",\"num_opt_errors\":" << m.get<FutureRiskSummaryV5::num_opt_errors>();
        o << ",\"update_source\":" << (int64_t)m.get<FutureRiskSummaryV5::update_source>();
        o << ",\"fut_mark_flag\":" << (int64_t)m.get<FutureRiskSummaryV5::fut_mark_flag>();
        o << ",\"opt_mark_flag\":" << (int64_t)m.get<FutureRiskSummaryV5::opt_mark_flag>();
        {
            std::time_t tt = m.get<FutureRiskSummaryV5::timestamp>().time_since_epoch().count() / 1'000'000'000;
			struct tm tm1{};
			localtime_s(&tm1, &tt);
