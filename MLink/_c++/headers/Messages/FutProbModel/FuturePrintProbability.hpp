...
namespace api {
    ...
    class FuturePrintProbability_PKey {
        public:
        ...
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FuturePrintProbability_PKey::get()"); return T{}; }  // specializations for valid types are listed below the outer class definition
        template <typename T, size_t S = sizeof(T)>
        void set(const T& value) { static_assert(sizeof(T) == -1, "Unexpected type in call to FuturePrintProbability_PKey::set()"); }  // specializations for valid types are listed below
        ...
        FuturePrintProbability_PKey() {}

        virtual ~FuturePrintProbability_PKey() {
        }
    ...
    class FuturePrintProbability {
        public:
        //using statements for all types used in this class
    
        using _meta = spiderrock::protobuf::api::_meta;
        using pkey = spiderrock::protobuf::api::FuturePrintProbability_PKey;
        ...
        template <typename T, size_t S = sizeof(T)>
        const auto get() const { static_assert(sizeof(T) == -1, "Unexpected type in call to FuturePrintProbability::get()"); return T{}; }  // specializations for valid types are listed below the class definition
        ...
        void set(const FuturePrintProbability & value) {
            set(value.m__meta);
            set(value.m_pkey);
        ...
        FuturePrintProbability() {
            m__meta.set_message_type("FuturePrintProbability");
        }
        ...
        size_t ByteSizeLong() const {
            ...
            if ( IncludePrtPrice()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(100,m_prt_price);
            }
            if ( IncludePrtSize()) {
            ...
            if ( IncludeBidPrice()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(112,m_bid_price);
            }
            if ( IncludeAskPrice()) {
                totalSize += SRProtobufCPP::FieldCodec::DoubleFieldSize(115,m_ask_price);
            }
            if ( IncludeBidSize()) {
        ...
        void Encode(uint8_t*& dest, uint8_t* max) const {
            ...
            if ( IncludePrtPrice()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,100,m_prt_price);
            }
            if ( IncludePrtSize()) {
            ...
            if ( IncludeBidPrice()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,112,m_bid_price);
            }
            if ( IncludeAskPrice()) {
                dest = SRProtobufCPP::FieldCodec::EncodeDouble(dest,115,m_ask_price);
            }
            if ( IncludeBidSize()) {
    ...
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::_meta>() const { return FuturePrintProbability::_meta{ m__meta}; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::pkey>() const { return FuturePrintProbability::pkey{ m_pkey}; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::prt_price>() const { return m_prt_price; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::prt_size>() const { return m_prt_size; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::prt_prob>() const { return m_prt_prob; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::prt_side>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::BuySell>( m_prt_side)); }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::bid_price>() const { return m_bid_price; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::ask_price>() const { return m_ask_price; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::bid_size>() const { return m_bid_size; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::ask_size>() const { return m_ask_size; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::avg_blink1m>() const { return m_avg_blink1m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::mae_blink1m>() const { return m_mae_blink1m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::avg_slink1m>() const { return m_avg_slink1m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::mae_slink1m>() const { return m_mae_slink1m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::avg_blink10m>() const { return m_avg_blink10m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::mae_blink10m>() const { return m_mae_blink10m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::avg_slink10m>() const { return m_avg_slink10m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::mae_slink10m>() const { return m_mae_slink10m; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::b_counter>() const { return m_b_counter; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::s_counter>() const { return m_s_counter; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::prt_timestamp>() const { return m_prt_timestamp; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::net_timestamp>() const { return m_net_timestamp; }
    template<> inline const auto FuturePrintProbability::get<FuturePrintProbability::sms_timestamp>() const { return m_sms_timestamp; }
    template<> inline const auto FuturePrintProbability_PKey::get<FuturePrintProbability_PKey::fkey>() const { return FuturePrintProbability_PKey::fkey{m_fkey}; }
    template<> inline const auto FuturePrintProbability_PKey::get<FuturePrintProbability_PKey::state_model>() const { return static_cast<uint8_t>(static_cast<spiderrock::protobuf::api::StateModel>(m_state_model));}
    
    // ostream operators for all classes above, output should adhere to a JSON format

    inline std::ostream& operator<<(std::ostream &o, const FuturePrintProbability_PKey& m) {
        o << "\"fkey\":{" << m.get<FuturePrintProbability_PKey::fkey>() << "}";
        o << ",\"state_model\":" << (int64_t)m.get<FuturePrintProbability_PKey::state_model>();
        return o;
    }

    inline std::ostream& operator<<(std::ostream &o, const FuturePrintProbability& m) {
        o << "\"_meta\":{" << m.get<FuturePrintProbability::_meta>() << "}";
        o << ",\"pkey\":{" << m.get<FuturePrintProbability::pkey>() << "}";
        o << ",\"prt_price\":" << m.get<FuturePrintProbability::prt_price>();
        o << ",\"prt_size\":" << m.get<FuturePrintProbability::prt_size>();
        o << ",\"prt_prob\":" << m.get<FuturePrintProbability::prt_prob>();
        o << ",\"prt_side\":" << (int64_t)m.get<FuturePrintProbability::prt_side>();
        o << ",\"bid_price\":" << m.get<FuturePrintProbability::bid_price>();
        o << ",\"ask_price\":" << m.get<FuturePrintProbability::ask_price>();
        o << ",\"bid_size\":" << m.get<FuturePrintProbability::bid_size>();
        o << ",\"ask_size\":" << m.get<FuturePrintProbability::ask_size>();
        o << ",\"avg_blink1m\":" << m.get<FuturePrintProbability::avg_blink1m>();
        o << ",\"mae_blink1m\":" << m.get<FuturePrintProbability::mae_blink1m>();
        o << ",\"avg_slink1m\":" << m.get<FuturePrintProbability::avg_slink1m>();
        o << ",\"mae_slink1m\":" << m.get<FuturePrintProbability::mae_slink1m>();
        o << ",\"avg_blink10m\":" << m.get<FuturePrintProbability::avg_blink10m>();
        o << ",\"mae_blink10m\":" << m.get<FuturePrintProbability::mae_blink10m>();
        o << ",\"avg_slink10m\":" << m.get<FuturePrintProbability::avg_slink10m>();
        o << ",\"mae_slink10m\":" << m.get<FuturePrintProbability::mae_slink10m>();
        o << ",\"b_counter\":" << m.get<FuturePrintProbability::b_counter>();
        o << ",\"s_counter\":" << m.get<FuturePrintProbability::s_counter>();
        o << ",\"prt_timestamp\":" << m.get<FuturePrintProbability::prt_timestamp>();
        o << ",\"net_timestamp\":" << m.get<FuturePrintProbability::net_timestamp>();
        o << ",\"sms_timestamp\":" << m.get<FuturePrintProbability::sms_timestamp>();
        return o;
    }
